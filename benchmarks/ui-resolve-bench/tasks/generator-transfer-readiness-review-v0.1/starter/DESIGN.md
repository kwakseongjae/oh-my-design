# Generator transfer review design contract

- Canvas: `#F1F0EB`; surface: `#FFFDF7`; ink: `#1D2528`; verified muted text: `#737671`; border: `#A5A79F`.
- Primary action: `#173E52`; signal accent: `#A45D3A`. Signal accent is a non-text cue unless its exact foreground pair passes 4.5:1.
...
- The feeder map, generator-window strip, and transfer handoff are separate semantic carriers. Preserve each carrier's identity, cardinality, visible facts, and relationships.
