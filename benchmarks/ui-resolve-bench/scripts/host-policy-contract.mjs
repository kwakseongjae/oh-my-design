...
const POLICY_MATCHER = "Bash|apply_patch|Edit|Write|mcp__node_repl__js|node_repl|mcp__agent-browser__browser_.*|mcp__browser-harness__browser_.*|mcp__browser__browser_.*";
