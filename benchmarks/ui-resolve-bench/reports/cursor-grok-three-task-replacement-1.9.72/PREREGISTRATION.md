# Cursor/Grok three-task replacement — 1.9.72
...
- product version `1.9.72`;
- locked matrix SHA-256
  `1ea074033dfca8220e6a11172daef0b58d062f73d5a7a62cf110908abb516db5`;
- fresh root `/tmp/u1972`;
...
- monotonic elapsed is the 120–125-second duration authority; wall chronology
  must stay within the frozen 5,000 ms disagreement bound;
...
1.9.66, 1.9.68, 1.9.69, or the infrastructure-invalid 1.9.70 enters this
denominator.

The only orchestration delta from 1.9.70 is the accepted provider-free 1.9.71
clock-source repair. Task, condition, skill, evaluator, score, model, order,
timeout, requested delay, retry, and fallback remain unchanged.
