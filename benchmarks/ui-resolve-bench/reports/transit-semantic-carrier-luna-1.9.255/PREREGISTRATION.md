# Transit semantic-carrier transfer — 1.9.255

This experiment compares the exact close-latch baseline `1d204afe…` with the exact semantic-carrier candidate `ba8fb546…` on the fresh `transit-stop-timetable-review-v0.1` holdout. Task, prompt, starter product, DESIGN.md, activation, Codex/Luna/high runtime, 900-second timeout, shared installed proof policy, balanced order, and 120-second pacing are held equal. The sole intended treatment difference is the installed skill source.
