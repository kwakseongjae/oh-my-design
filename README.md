...
2. In your project, type your first prompt — copy this exactly:
   ...
   Your agent runs **`omd:init`**: it recommends a reference from the 286 real-company catalog, asks you to confirm, and writes **`DESIGN.md`** to your project root. (`omd:sync` then wires up the `CLAUDE.md` / `AGENTS.md` / Cursor shims so every agent reads it automatically.)
