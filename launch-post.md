...
- 64개 기업 디자인 시스템 (Stripe, Vercel, Notion, Linear, Figma, Apple...)
...
- 64 company design systems (Stripe, Vercel, Notion, Linear, Figma, Apple...)
...
1. Pick a reference (64 companies)
...
oh-my-design -- 64개 대기업 디자인 시스템 중 골라서, A/B 위자드로 취향 맞추고, DESIGN.md 바로 export.
...
oh-my-design -- Pick from 64 real company design systems, customize with an A/B wizard, export DESIGN.md instantly.
