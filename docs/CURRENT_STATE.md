...
- exact task bytes source commit과 별도 task-lock/admission 고정은 완료됐다. 다음은 exact OmD current/Luna-high 9셀을 serial·720s·pacing30s·no-retry/no-replacement/no-fallback/Cursor0으로 실행한다.
