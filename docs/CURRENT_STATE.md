...
- 기준 커밋: `66aab29` (`codex/ui-skills-benchmark-v0`) on `ce6636c` (`main`) + npm release tag `v1.9.0`; rollback tag `checkpoint/cli-v1.9-pre-conversion-20260721`
- 갱신: 2026-07-30 · 1.9.92 task-family human gallery awaiting practitioner calibration
...
- 현재 `http://127.0.0.1:4777/`에서 practitioner calibration이 필요하다. 세 페이지 export JSON을 받은 뒤 automated-vs-human calibration과 patch 결론을 닫는다.
