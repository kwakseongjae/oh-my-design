...
- 다음은 이 구조 후보를 commit/pin하고 provider-free diagnostic을 거친 뒤, 새로운 unseen topology를 generation 전에 잠가 exact previous canonical vs packet candidate 2×3 transfer를 수행하는 것이다.
