...
- 갱신: 2026-08-25 · T2-1 웨이브 17 sol 최종 확인 3차 = **전체 PASS, PASS 4/4**. 정본 `docs/reviews/t2-1-wave17-2026-08-25-sol-final3.md`. 2차 잔여 지목만 재대조해 composio·cookpad·corca·cuboai 모두 stale SHA의 명시적 superseded 표시와 `wave17 ledger sync` Revision의 actual current SHA 선언을 충족했고, 선언 SHA는 실제 `DESIGN.md` SHA와 4/4 일치했다. 새 기준·새 F3·새 기계검사 없음. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2-1 웨이브 17 sol 최종 확인 2차 = **전체 FAIL, PASS 1/5**. 정본 `docs/reviews/t2-1-wave17-2026-08-25-sol-final2.md`. coinone만 audit current-class/SHA 원장 동기화를 충족했다. composio·cookpad·cuboai는 actual SHA와 `wave17 ledger sync` 항목이 없고 일부 stale SHA/포인터가 남았으며, corca는 actual SHA와 audit superseded는 반영됐지만 `migration-log.md:104` stale SHA의 명시적 superseded 표시가 없다. cookpad observed 표현은 정정됐다. 5개 DESIGN SHA는 recheck 기준과 같아 본문 무변경. 새 기준·새 F3·새 기계검사 없음. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2-1 웨이브 17 sol 최종 확인 = **전체 FAIL, PASS 0/5**. 정본 `docs/reviews/t2-1-wave17-2026-08-25-sol-final.md`. `sol-recheck.md`의 브랜드별 잔여 조건만 재대조했으며 coinone은 audit current-class/SHA, composio는 audit/F1/F2/pointer/SHA, cookpad는 observed-state 서술 + audit/F1/F2/pointer/SHA, corca는 audit/F2/pointer/SHA, cuboai는 audit/F2/pointer/SHA가 여전히 미동기화다. 새 기준·새 F3·새 기계검사 없음. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2-1 웨이브 17 동일 sol 고정목록 집중 재심 = **전체 FAIL, PASS 0/5, 선행 재제출 조건 21/28 PASS**. 정본 `docs/reviews/t2-1-wave17-2026-08-25-sol-recheck.md`. coinone 2/3(audit current-class 미동기화), composio 7/8(audit/F1/F2/pointer/current SHA), cookpad 4/6(observed-state 잔존 + current-class/F1/F2/SHA), corca 3/4(current-class/F2/SHA), cuboai 5/7(current-class/F2/SHA). Actual SHA는 coinone `8e753d...`, composio `2a2951...`, cookpad `31a151...`, corca `eed43b...`, cuboai `fa2a1c...`; 5/5 `--gate-only` PASS/problems `[]`, Core `portable_core:true`. 새 기준·새 F3 실행/요구 없음. 동일 sol 잔여 목록만 재제출; 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2-1 웨이브 17 sol 첫 전수 판정 = **FAIL 5/5, PASS 0/5**. 정본 `docs/reviews/t2-1-wave17-2026-08-25-sol-full.md`. coinone은 source 밖 product-microcopy coverage negative, composio는 evidence-kind/§9·§11·§8/primitive·Proof tuple/state/negative/lineage·E2, cookpad는 §11·§9 child binding/inferred-state 승격/asset ownership·B2a/locale negative, corca는 narrative·designation·§9 child tuple, cuboai는 footer metadata/sidecar false absence/§11·motion/per-surface 승격/state/E2가 차단. 5/5 gate PASS/problems `[]`, Core `portable_core:true`, fresh F3 실행·current SHA 일치, E3 회피 없음. 고정 목록-only 동일 sol 재심; affected F1/F2/current-class·SHA·gates 재동기화. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 corca F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/corca/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope 13 atmosphere follow-on 재조준, Distinctive 36 YAML rounded/17/30 과잉 한정 축소, Do’s 58 brand-spine, Avoid 71 causal tails, Semantic 87 Proof-nav-leaf, Shape 117 source-body `9999px`, Motion 159 signature extras, Font 169 bake-weight, Family 182 wfont-name, Assets 205 retarget, Capture 216 §14 표 앞 한정 / 232 중복 축소, Layout 386/398, Content 403/419에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#046cb8`/`#fff3b7`/`#777cdc`/`#605070` 허위 13/36 목적지 없음, YAML rounded 115/117/122/125, Forbidden register 419 not 418, `#1a2352` Proof notes 152/159/211. `AUDIT_DONE fixes=20`. Post-F3 SHA-256 `4483983caf1e1c85411820eadb24d653cfb9026beefbd0cc537aef09d8c160e2`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 composio F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/composio/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope 17 refusal-as-narrative, Primary tasks named jobs, Audience do-not-substitute, Distinctive likely-hover, Principles CLI extra, Do/Avoid causal tails, Semantic Signal-Blue-not-focus-visible, Elevation 152 YAML-brutalist-form / 162 extras, Type body-only/16px-unmerged, Cyan/Card §9 recipes, Layout 464 extras, Content 484 aggressive-on-most-brands / 499 forbidden-register에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. Ghost L/E/S 373–375, Phantom 396–398, canvas vs fg split, footer live +133/140/198/228, white-fill +44/537, Signal +96, B3 dual 185+545, BOOK A CALL 173/185/212/215. `AUDIT_DONE fixes=20`. Post-F3 SHA-256 `a3f575ab8febc740e3c20e47afcb2d2bbe8346efc12ff7bad04d3c02fa23d06c`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.

- 갱신: 2026-08-25 · T2 cookpad F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/cookpad/audit-log.md`. 토큰·표·applicability·구조 미변경. Audience 32 group-level extras, Principles 56 UI tails, Avoid 71 causal tails, Shape 112 8px-signature, Elevation 116 cream-depth extras, Motion 140 signature characterizations / 151 omitted-curves, Type 185 after-table unmerge / 187 convention extras, Capture 221 Core C1/C2 과잉 한정 축소, Primary 249 / Secondary 274 / Text 295 / Category 313 / Search 372 C2 application, Layout 391/408 extras, Content 417/431 extras에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#FFFFFF` 231 허위 목적지 없음, `#E9B83F` 348 허위 목적지 없음, durations 124–127 not 122–126, YAML spacing +400, `prefers-reduced-motion` 149 only, `1px solid` 261 only. `AUDIT_DONE fixes=23`. Post-F3 SHA-256 `e7ee909e96ed6a9713967acb54ea1afdc8eb2d376ed4301aeb61bd503559dec1`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 coinone F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/coinone/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope 11 third-distinct / Roboto chrome, Scope 17 official-writing-not-tokens, Primary tasks named three jobs, Audience source-grounded-groups, Principles four stems, Spacing small-and-local, Family do-not-replace-outside-route, Type 139 scales/no-trading-tab-lineHeight, Capture 167 Core-policy retarget, Sign-in 185/194, Compact 220, Layout 276/280, Content 285/289/297에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. homepage +153, `#0B59D5` +116, home/trading slash +29/83, `ds.url` URL not 50, YAML `1.38`/rounded dests, B3 Motion 111. `AUDIT_DONE fixes=20`. Post-F3 SHA-256 `4f8056f56fce47320d858c232eca4e458a6904da6e73d77a45a0c654d9393735`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 워커 `composio` 수동 이관 = **본문 반영, F3 완료**. 워커 grok-4.6. 규칙집 v8. 산출물 `docs/design-md-weight/migrated/composio/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight `0.87`/`1.00`/`1.20`/`1.50`/`1.63` 비율 보존, button×3+card×2 컴포넌트별 보존, Phantom/Nav YAML type 없음·발명 없음, `tokens.source: prose-derived` dual Scope+Motion+Capture+provenance, GitHub slug `composiohq` dual provenance+Assets identity-boundary, catalog `primary_color` `#6366f1` vs YAML Cobalt `#0007cd` 비합침, YAML white-fill radius 4/`8px 24px`/16px vs footer live 0px/6×8/33px/14px·400 비합침, Proof `39px`/`10×16`/`rgb(0, 0, 0)` provenance-only, Signal Blue `#0089ff` named Focus를 focus-visible로 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 없음·duration 0/100/1500/250ms + easing 역할/`prefers-reduced-motion` + B3 다섯 증거 종류 본문 유지, Card/Code Block kind/map 생략(C4), White-fill/Footer live/Cyan L/E/S 생략(C2), Ghost/Phantom/Nav L/E/S 역할별 not-applicable, §14 11행 보존, canvas `#0f0f0f` vs button fg `#0f0f0f` 비합침, surface `#000000` vs live header fill 비합침, YAML lg 37 vs card 4px vs live 0px vs full 9999 비합침. F1·F2 수행. `--gate-only` PASS/problems `[]`; Core `portable_core: true`. SHA-256 `c57c9cc2f9c4bc9c4b06fa609169cc4d5689459d856c51ba5bfe76136c641613`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 워커 `coinone` 수동 이관 = **본문 반영, F3 완료**. 워커 grok-4.6. 규칙집 v8. 산출물 `docs/design-md-weight/migrated/coinone/{DESIGN.md,provenance.md,migration-log.md,audit-log.md}`. YAML unitless lineHeight `1.38` 비율 보존, button×2+tab×2 컴포넌트별 보존, `tokens.source: reconciled` provenance-only, `ds.type: brand` dual Scope+provenance, Google s2 favicon URL provenance-only + Assets URL-free identity-boundary, static focus/pressed snapshots를 focus-visible로 비승격, §13 source-grounded groups만 Audience·sidecar biography 없음, 무출처 커브 없음·B3 다섯 증거 종류 본문 유지, Home sign-in/compact L/E/S 생략(C2), chart/side tab L/E/S 역할별 not-applicable, §14 본문 보존, `#006BD6` vs `#0B59D5` 비합침, `#FFFFFF` canvas vs compact fill 비합침, `#17181B` vs `#040505`/`#18191C`/`#79818F`/`#9E9E9E` 비합침, 3px vs 6px vs 26px 비합침, sidecar `.verification.md` exists-not-adopted·Proof 미수입. F1·F2 수행 후 F3 감사 완료. Post-F3 SHA-256 `4f8056f56fce47320d858c232eca4e458a6904da6e73d77a45a0c654d9393735`. `--gate-only` PASS/problems `[]`, `portable_core: true`. 워커 SHA `c984483f9abbd28f9e591088f763554ac7831d3f8e5d1c2065e623d032241c76` superseded. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 cuboai F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/cuboai/audit-log.md`. 토큰·표·applicability·구조 미변경. Do’s 57 brand’s-voice/single-action-color, Semantic 87 single-action-color, Elevation 134 shadow-unmerge, Family 177 sharp-headline, Type 193 compact-add, Capture 210 §14 table intro, Layout 416 Image Behavior, Content 421 table extras / 431 sample parentheticals에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. parent company Scope 9 not 15, About URL Scope 9 not 15/433–435, source prose Scope 13 not Distinctive 13, `#ffffff` +309, YAML `1.20` not 41. `AUDIT_DONE fixes=13`. Post-F3 SHA-256 `c2760aefd46d6e8d4ebf9b1e9894a69d3c73f7d6fa81995aee8986e1e0bc643e`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 워커 `cuboai` 수동 이관 = **본문 반영, F3 완료**. 워커 grok-4.6. 규칙집 v8. 산출물 `docs/design-md-weight/migrated/cuboai/{DESIGN.md,provenance.md,migration-log.md,audit-log.md}`. YAML unitless lineHeight `1.20`/`1.50` 비율 보존, button×2+input+badge+card×2+tab+listItem 컴포넌트별 보존, `tokens.source: live-extract` dual Scope+provenance, Google s2 favicon URL provenance-only + Assets URL-free identity-boundary, named active `#24cdb9`와 duration-use `focus`를 focus-visible로 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개 provenance omission ledger·duration 120/220/320ms + easing 역할/`prefers-reduced-motion` + B3 다섯 증거 종류 본문 유지, Feature pill/Grey card/White card/Region row kind/map 생략(C4), Primary/Compact Add L/E/S 생략(C2), Pill Input error applicable·loading/success 생략, Nav L/E/S 역할별 not-applicable, §14 9행 보존, `#5be3d3` vs `#24cdb9` 비합침, canvas `#ffffff` vs feature-pill on-fill `#ffffff` 비합침, YAML shadow trailing `0px` vs compact-add `0px 4px 6px` 비합침, YAML xl 25 vs type-size 24px 비합침. F1·F2 수행 후 F3 감사 완료. Post-F3 SHA-256 `c2760aefd46d6e8d4ebf9b1e9894a69d3c73f7d6fa81995aee8986e1e0bc643e`. `--gate-only` PASS/problems `[]`, `portable_core: true`. 워커 SHA `2af12aa1be02bc83a037144c5369afbc65172ff2abbc98ba31f9bbcbd73a06b6` superseded. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 워커 `cookpad` 수동 이관 = **본문 반영, F3 대기**. 워커 grok-4.6. 규칙집 v8. 산출물 `docs/design-md-weight/migrated/cookpad/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight `1.3`/`1.4`/`1.5` 비율 보존, button×5+card×2+input+badge 컴포넌트별 보존, `tokens.source: prose-derived` provenance-only, Google s2 favicon URL provenance-only + Assets URL-free identity-boundary, named Focus `#FF9933` search ring을 focus-visible로 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 4개 provenance omission ledger·duration 0/150/250/300ms + easing 이름/`prefers-reduced-motion` + B3 다섯 증거 종류 본문 유지, Recipe/Promoted card kind/map 생략(C4), Primary error/success 생략(C2), Secondary/Text L/E/S 생략, Search error applicable·loading/success 생략, Category L/E/S 역할별 not-applicable, Badge Kind: non-interactive, §14 10행 보존, `#FF9933` vs `#FF7F33` 비합침, canvas `#F8F6F2` vs card/on-primary `#FFFFFF` 비합침, YAML 8 vs full 9999 비합침. F1·F2 수행. `--gate-only` PASS/problems `[]`; Core `portable_core: true`. SHA-256 `259f93d4fe046f9badeb4830111188cd691a83a87b897ac2b4269a05cf40a0e6`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 워커 `corca` 수동 이관 = **본문 반영, F3 완료**. 워커 grok-4.6. 규칙집 v8. 산출물 `docs/design-md-weight/migrated/corca/{DESIGN.md,provenance.md,migration-log.md,audit-log.md}`. YAML lineHeight 없음·발명 없음, button×3+card×2+tab+badge 컴포넌트별 보존, `tokens.source: live-extract` dual Scope+provenance, Google s2 favicon URL provenance-only + Assets URL-free identity-boundary, YAML `button-cta` `fg` `#1a2352` inferred·focus-visible 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개 생략·duration 120/220/340ms + easing 역할 + reduced-motion + B3 다섯 증거 종류 본문 유지, Card kind/map 생략(C4), Primary CTA L/E/S 생략(C2), Learn-More/Outline/Nav L/E/S 역할별 not-applicable, Badge Kind: non-interactive, §14 9행 보존, `#1a2352` vs `#000000`/`#181818`/`#324158` 비합침, canvas `#ffffff` vs CTA fill `#ffffff` 비합침, YAML 50 vs outline 999px vs YAML 9999 vs source-body `9999px` 비합침. Canonical Proof `web/references/corca/.verification.md` SHA `44eb660181a6e1bd6ba39250ae70530250b2a41ad3734a302933cbb7af1fd693` 채택, Proof fractional px provenance-only. F1·F2 수행 후 F3 감사 완료. Post-F3 SHA-256 `4483983caf1e1c85411820eadb24d653cfb9026beefbd0cc537aef09d8c160e2`. `--gate-only` PASS/problems `[]`, `portable_core: true`. 워커 SHA `79580b2d981a83e916ad9e2ef1be4c0c766c64e22224700244903d69c3676f4f` superseded. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2-1 웨이브 16 clickhouse sol 최종 확인 = **PASS**. 정본 `docs/reviews/t2-1-wave16-2026-08-25-sol-final.md`(한 줄 판정). 선행 recheck의 잔여 조건 1·4만 재확인: canonical `.verification.md:25`와 provenance 193의 expanded-select tuple이 문자 단위로 동일하고, Proof disposition의 provenance 90/193/211·migration final revision/F2·audit current-class 포인터가 실제와 일치한다. 새 기준·새 F3 없음. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2-1 웨이브 16 clickhouse grok-4.6 final resubmit = **조건 1·4 개정, 의미 재심 대기**. 워커 grok-4.6. 규칙집 v8. 정본 `docs/reviews/t2-1-wave16-2026-08-25-sol-recheck.md`. DESIGN.md 미변경. canonical `.verification.md:25` expanded-select selector-bound raw tuple을 provenance Proof notes 193에 byte-exact 복원(`:21` 185 … `:25` 193 … `:27` 197). §11 dual Scope 19 + Content 405/407 유지, Proof disposition을 provenance 90 / `:67` 211 / migration `Revision 2026-08-25 (wave16 final resubmit)` / audit current-class에 재동기화. SHA 불변 `60cb67aa2497bf9243ea21ad9ff25c567e208263ad709cbff03f228dfa6d1c57`. `--gate-only` PASS/problems `[]`, Core `portable_core: true`. 새 F3 없음. 동일 sol 목록-only 재심 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2-1 웨이브 16 동일 sol 목록-only 집중 재심 = **전체 FAIL, 대상 4/5 PASS, 선행 재제출 조건 30/32 PASS**. 정본 `docs/reviews/t2-1-wave16-2026-08-25-sol-recheck.md`. clickhouse FAIL(3/5): canonical `.verification.md:25` expanded-select selector/raw tuple이 `provenance.md:185-195`에서 누락(`:24`→`:26`)됐고 `migration-log.md:96`·`audit-log.md:115`는 `:21-27`/Proof raw 전체 보존으로 과대 기록하여 조건 1·4 FAIL. cloudflare 6/6, codeit 7/7, cohere 6/6, coinbase 8/8 PASS. codeit·coinbase는 E3 자연 prose의 `focus-visible`+hex 동일 물리행 원복, incident/exact repro, row-aware gate와 positive/negative 양방향 동작 확인. 5/5 `--gate-only` PASS/problems `[]`, Core `portable_core:true`, current SHA 일치. 새 기준·새 F3 실행/요구 없음. 다음은 clickhouse `.verification.md:25` exact tuple provenance 복원 + affected current-class 원장/SHA/gates 재동기화 후 동일 sol 재심. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2-1 웨이브 16 grok-4.6 sol 재제출 = **본문+원장 개정 5/5, 의미 재심 대기**. 워커 grok-4.6. 규칙집 v8. 정본 `docs/reviews/t2-1-wave16-2026-08-25-sol-full.md`. `docs/design-md-weight/migrated/{clickhouse,cloudflare,codeit,cohere,coinbase}/` DESIGN + provenance + migration-log(`Revision 2026-08-25 (wave16 sol resubmit)`) + audit current-class. clickhouse: Proof raw/lineage provenance-only (`44px`/`24px 0px`/`rgb`/`lab` 비합침), imagery/locale negative 삭제, Select Menu·Cookie Dialog kind/map 생략, §11 dual Scope+Content. SHA `60cb67aa2497bf9243ea21ad9ff25c567e208263ad709cbff03f228dfa6d1c57`. cloudflare: `Type`/`Kind: omitted` 삭제, Feature Card·Pagination interactive 복원, Primary/Destructive error/success applicable, Ghost/Dark CTA·Text/Mono/Select L/E/S 생략, native-app/exclusive/mark/locale negative 삭제, asset B2a, card×6. SHA `7993d30533db894c224c32192771f7ace4adbf9961e4a1d557f5948955eb842b`. codeit: E3 문장 원복(`#760dde`+`focus-visible` 한 줄), `-1px`/`8px–10px`/right-aligned chip/Course Card flat, `at all sizes`, engineering-blog class, font/mark/locale negative 삭제, Tier-2 `getdesign.md/codeit`. SHA `c64a9f0258b6db622480a2116af5eb1d6e9ff9d9c367c24f86640390f6538286`. cohere: `Type: anchor`×3, Home media Kind+map, footer lineage=sidecar `:5`, support/legal·exclusive-font 삭제. SHA `cd7e0cbcac1b55926fd881939eb64e55fa83026b2e3026d7c7c93521ac15ffde`. coinbase: CDS open-sourced·spans·XAxis/YAxis/Scrubber·% overlay 복원, §11 수치/인과, Font class 강등, sidecar exists-not-adopted, Banner success 생략, List Cell kind/map 생략, E3 문장 원복. SHA `1a11310828b0a579a9a596c6aaba42a427a9e7d2a0f344cfdaf05cd171318e4f`. 5/5 `--gate-only` PASS/problems `[]`, Core `portable_core: true`. 새 F3 없음. 동일 sol 목록-only 재심 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2-1 웨이브 16 sol 첫 전수 판정 = **FAIL 5/5, PASS 0/5**. 정본 `docs/reviews/t2-1-wave16-2026-08-25-sol-full.md`. clickhouse는 채택 Proof raw/lineage 손실·imagery/locale negative·surface kind/map·§11 이중 목적지, cloudflare는 C4 omitted-field/interaction 손실·C1/C2·negative·B2a·card count, codeit은 source form/§9·asset/evidence-kind·negative/Tier2 literal과 **E3**, cohere는 Proof anchor primitive·media interactive kind·false footer lineage·negative, coinbase는 §8/§11 손실·evidence/task 승격·sidecar false absence·font/locale negative·Banner/ListCell과 **E3**가 차단. 5/5 gate PASS/problems `[]`, Core `portable_core:true`, fresh F3 실행·current SHA 일치이나 의미 결함 미치유. Codeit/Coinbase worker-log가 `focus-visible`+hex 오탐을 줄 분리로 통과시켰다고 자인. 고정 목록-only 동일 sol 재심; affected F1/F2/current-class·SHA·gates 재동기화, 새 F3 불필요. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 codeit F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/codeit/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope 9 live-extract / 17 official-history-not-tokens, Primary tasks 25 named jobs, Audience 35 offerings-not-segments, Principles 52 thesis extras, Avoid 73 causal tails, Motion 158 omitted-curves, Font 170 extras, Family 186 68px-hero, Type 203 do-not-replace, Capture 238 Core-policy retarget, Hero 264 / Neutral 377 / Search 403 / Nav 482, Content 514 table labels에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. homepage +115, `#9933ff` +22/+52, YAML spacing 497, sprint 575, Nav 490–492, curves 136–138 not 132, B3 Named gaps 578. `AUDIT_DONE fixes=20`. Post-F3 SHA-256 `f1979590ce4497919385d860d856c45981b624530115f716b287e08c122b5cda`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 clickhouse F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/clickhouse/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope 17 official-brand-writing-not-interface-tokens / 19 narrative-context-not-interface-tokens, Primary tasks 25 three jobs, Distinctive 38 Inter-Basier / none-is-universal / evidence-are-separate, Principles 48 five stems, Spacing 99 compact-rhythm-not-complete-grid, Capture 188 list-item/YAML-type trim, Content 432 unobserved-locale에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#faff69` +15/17/230/278/352, three-URL +Primary tasks 27/28/29, `data-omd-capture="4"` +176/181/250, `1.50` Distinctive 38 허위 목적지 없음, forest-green/4px-8px card provenance-only. `AUDIT_DONE fixes=20`. Post-F3 SHA-256 `5f370bd76b23af69c60a525b178b836c8deeda52765ce2c741c1c272f77e6ba9`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 cloudflare F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/cloudflare/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope 13 keep-orange-led / 15 must-not-collapse / 17 public-facts-not-tokens, Distinctive 40, capture-bound named Do’s, Avoid list-head, Semantic after-list 124/126, Spacing 130, Shape 140 precede, Motion 189/200, Primary 318, Compact/Icon omitted L/E/S, Dark CTA YAML-type 446, C4/local unmerges, Content 798 extras에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. kumo URL Scope 9 not 13, Simple Icons 262, `#F6821F` Foundations 96 not 92, B3 208/849. `AUDIT_DONE fixes=39`. Post-F3 SHA-256 `411c17c271d94896f2482763931fe6ef39f1ec5aa1eb9e0d588008a5f53256a4`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 cohere F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/cohere/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope 11 this-contract-covers / 15 large-editorial-headlines / 17 public-surface-reference, Primary tasks named jobs, Audience behavioral-metrics, Distinctive no-universal-card-recipe, capture-bound dark-CTA recipe, Semantic not-complete-action-scale, Spacing treat-route-specific, Shape disabled-4px-icon, Assets 168 limiter-front, Capture 175/181, Layout 295 bullet readings, Content 306 table guidances에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#17171c` not atmosphere 15, `#ffffff` not 15/188, YAML use 263/286, Careers 48/52–53, Home marketing 285–287. `AUDIT_DONE fixes=18`. Post-F3 SHA-256 `b92f263ec9f289e831f8e138928ee5a989fae6121c6515c2a48c6ebece0fefa1`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 워커 `codeit` 수동 이관 = **본문 반영, F3 대기**. 워커 grok-4.6. 규칙집 v8. 산출물 `docs/design-md-weight/migrated/codeit/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight `1.21`/`1.29`/`1.38`/`1.43`/`1.67`/`1.50` 비율 보존, button×5+card×3+tab+input+badge 컴포넌트별 보존, `tokens.source: live-extract` dual Scope+provenance, Google s2 favicon URL provenance-only + Assets URL-free identity-boundary, `#760dde` active/pressed 색 역할을 focus-visible로 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개 생략·duration 120/220/320ms + easing 역할 + reduced-motion + B3 다섯 증거 종류 본문 유지, Card kind/map 생략(C4), Hero L/E/S 생략(C2), Chip/Pill/Ghost/Tab L/E/S 역할별 not-applicable, Neutral loading/error applicable·success 생략, Search error applicable·loading/success 생략, Badge Kind: non-interactive, §14 9행 보존, `#9933ff` vs `#8f00ff`/`#760dde`/`#b363fd` 비합침, canvas `#ffffff` vs on-primary `#ffffff` 비합침, YAML pill 9999 vs 22px vs 21px 비합침, YAML button 16px/500 vs hero CTA 18px/700 비합침. F1·F2 수행. `--gate-only` PASS/problems `[]`; Core `portable_core: true`. SHA-256 `3e7835a9a1284b6709d23c9dca3457357f3123f3ff9cfabbdecd2689489dac7e`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 워커 `clickhouse` 수동 이관 = **본문 반영, F3 완료**. 워커 grok-4.6. 규칙집 v8. 산출물 `docs/design-md-weight/migrated/clickhouse/{DESIGN.md,provenance.md,migration-log.md,audit-log.md}`. YAML unitless lineHeight `1.25`/`1.50`/`1.43` 비율 보존, `Type: listItem` 컴포넌트별 보존, Primary/Secondary/Nav/Number Field/Select/Toggle/Cookie Dialog YAML type 없음·발명 없음, `tokens.source: reconciled` provenance-only, `ds.type: system` dual Scope+provenance, Simple Icons slug `clickhouse` dual provenance+Assets identity-boundary, nav focus/hover/pressed를 focus-visible로 비승격, §13 FILL IN·가상 persona 삭제·sidecar 없음, 무출처 커브 없음·B3 다섯 증거 종류 본문 유지, Public List Item kind/map 생략(C4), Primary/Secondary/Cookie Dialog L/E/S 생략(C2), Number Field/Select Trigger error applicable·loading·success 생략, Nav/Select Menu/Toggle L/E/S 역할별 not-applicable, §14 7행 보존, `#faff69` vs `#166534` 비합침, `#131312` vs `#282828` vs `#141414` vs `#1f1f1c` 비합침, `#151515` vs `#ffffff` 비합침, `#414141` vs `#4f5101` vs `#393939` 비합침, home `10px 16px` vs pricing `12px 24px` 비합침, YAML 4 vs list-item 0 vs select-menu `0px 0px 6px 6px` 비합침. F1·F2 수행 후 F3 감사 완료. Post-F3 SHA-256 `5f370bd76b23af69c60a525b178b836c8deeda52765ce2c741c1c272f77e6ba9`. `--gate-only` PASS/problems `[]`, `portable_core: true`. 워커 SHA `eb9b8ee40beb12623e241146bb30c8c643a4a7da83800a26b911cb0c30df6533` superseded. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 워커 `cloudflare` 수동 이관 = **본문 반영, F3 완료**. 워커 grok-4.6. 규칙집 v8. 산출물 `docs/design-md-weight/migrated/cloudflare/{DESIGN.md,provenance.md,migration-log.md,audit-log.md}`. YAML unitless lineHeight 1.1/1.15/1.2/1.3/1.4/1.45/1.6/1.55/1.5 비율 보존, button×6+tab+card×5 컴포넌트별 보존, Dark CTA YAML type 없음·발명 없음, `tokens.source: design-system` dual Scope+provenance, Simple Icons slug `cloudflare` dual provenance+Assets identity-boundary, named Focus `rgba(246,130,31,0.2)`를 focus-visible로 비승격(kumo `focus-visible:ring-kumo-brand`는 blue), §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 4개(ease-enter/exit/standard 템플릿 일치)는 provenance omission ledger·duration 0/120/200/300/350ms + dialog 150ms/easing 이름/`prefers-reduced-motion` 보존, Card/badge/dialog/toast/table kind/map 생략(C4), Primary loading applicable·field error applicable·Secondary/Ghost/Tabs/Switch L/E/S 역할별 not-applicable(C2), Compact/Icon L/E/S 생략, §14 14행 보존, `#F6821F` vs kumo blue vs `#E2700B`/`#D9700F` 비합침, `#2FB344` vs `#9BCA3E` 비합침, YAML 36px/8px vs §4 40px vs §9 6px/`0 20px` 비합침. F1·F2 수행 후 F3 감사 완료. Post-F3 SHA-256 `411c17c271d94896f2482763931fe6ef39f1ec5aa1eb9e0d588008a5f53256a4`. `--gate-only` PASS/problems `[]`, `portable_core: true`. 워커 SHA `84e513c07bf5ccfaa2fac3730e9a696bea1c4b9ffe62895855ce8a8a400a9e99` superseded. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 워커 `cohere` 수동 이관 = **본문 반영, F3 완료**. 워커 grok-4.6. 규칙집 v8. 산출물 `docs/design-md-weight/migrated/cohere/{DESIGN.md,provenance.md,migration-log.md,audit-log.md}`. YAML unitless lineHeight `1`/`1.2`/`1.5`/`1.4` 비율 보존, tab×1+card×1 컴포넌트별 보존, Dark/Inverse/Outlined YAML type 없음·발명 없음, `tokens.source: reconciled` provenance-only, GitHub slug `cohere-ai` dual provenance+Assets identity-boundary, generic Focus 없음/`focus-visible` 비승격, §13 official groups만 Audience·sidecar biography 없음, 무출처 커브 없음·B3 다섯 증거 종류 본문 유지, Home marketing media kind/map 생략(C4), Dark/Inverse/Outlined L/E/S 생략(C2), Selected tab L/E/S 역할별 not-applicable, §14 본문 보존, `#17171c` vs `#000000` vs `#212121` 비합침, `#ffffff` canvas vs `#fafafa` inverse text vs dark-CTA on-fill 비합침, 9999px vs 22px vs 8px vs 4px vs 0px 비합침. F1·F2 수행 후 F3 감사 완료. Post-F3 SHA-256 `b92f263ec9f289e831f8e138928ee5a989fae6121c6515c2a48c6ebece0fefa1`. `--gate-only` PASS/problems `[]`, `portable_core: true`. 워커 SHA `3ff9a9e4…fd17` superseded. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 coinbase F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/coinbase/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope 9 catalog-homepage-as-identity / 11 this-contract-covers, Primary tasks named three jobs, Spacing YAML-without-px / yaml-section-64, Shape limiter-precedes, Elevation modal-scrim, Motion omitted-cubic-bezier-language, Font trailing do-not-substitute, Type caption-600-unmerged, CDS siblings Type-not-invented, §9 named tuples, Layout spacing-record / component-local, Content table guidances에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. live hosts Tier 1 71 not 66, github 57/67, C4 639/650/662, breakpoint 707–716, modal scrim 122, §14 203–213. `AUDIT_DONE fixes=17`. Post-F3 SHA-256 `0749f48768b46679048e8e514c8945eb63584284243c973d6a5dda496b37b390`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 워커 `coinbase` 수동 이관 = **본문 반영, F3 완료**. 워커 grok-4.6. 규칙집 v8. 산출물 `docs/design-md-weight/migrated/coinbase/{DESIGN.md,provenance.md,migration-log.md,audit-log.md}`. YAML unitless lineHeight `1.00`/`1.11`/`1.13`/`1.33`/`1.50`/`1.25`/`1.56`/`1.20`/`1.23` 비율 보존, button×8+tab×2+card×7+badge+input×2+toggle×2+listItem+dialog+toast 컴포넌트별 보존, `tokens.source: design-system` provenance-only, simpleicons slug `coinbase` dual provenance+Assets identity-boundary, generic Focus `2px solid black`을 focus-visible로 비승격, §13 fictional archetypes 삭제·sidecar 없음, `standard cubic-bezier` 생략·B3 다섯 증거 종류 본문 유지, Card/Data Table/Tooltip/Progress/Sparkline/Dark Section kind/map 생략(C4), Primary loading applicable / 다수 CTA L/E/S 생략(C2) / chip·tab·toggle L/E/S 역할별 not-applicable, §14 11행 보존, `#0052ff` vs `#578bfa` vs `#0667d0` 비합침, YAML `100000px` vs §4 `56px` 비합침, YAML spacing vs §5 px scale 비합침. F1·F2 수행 후 F3 감사 완료. Post-F3 SHA-256 `0749f48768b46679048e8e514c8945eb63584284243c973d6a5dda496b37b390`. `--gate-only` PASS/problems `[]`, `portable_core: true`. 워커 SHA `690294c0708ecd7576c19cda431a77df5c10ab8f4ffbe672a7c249692c2c81ad` superseded. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2-1 웨이브 15 동일 sol 목록-only 집중 재심 = **전체 PASS, 대상 4/4, 선행 재제출 조건 23/23 PASS**. 정본 `docs/reviews/t2-1-wave15-2026-08-25-sol-recheck.md`. 새 기준·새 F3 실행/요구 없음. class101 4/4: first-party mark-file 부재/ownership-unclaimed 삭제, favicon lookup/non-promotion만 유지, 원장/SHA/검사 동기화. classting 8/8: Proof/prose-derived 분리, CT parent-corporate, Orange primitive 미발명, §1/§9/§11 관계, linked Proof metadata, favicon 경계, empty/HK/두 padding source-row, 원장/SHA/검사 동기화. classum 5/5: Large CTA L/E/S 생략·capture absence 분리, font/logo negative 삭제, freshness/current 원장/SHA/검사 동기화. claude 6/6: `#faf9f5` provenance-only, §11 관계, Audience 발명 삭제, homepage exact role, schema/raw lineage, 원장/SHA/검사 동기화. 4/4 `--gate-only` PASS/problems `[]`, Core `portable_core:true`, current SHA 일치. 선행 clay PASS 포함 웨이브 5/5. 카탈로그 채택 주장은 아님.
- 갱신: 2026-08-25 · T2-1 웨이브 15 grok-4.6 sol 재제출 = **본문+원장 개정 4/4, 의미 재심 대기**. 워커 grok-4.6. 규칙집 v7. 고정 목록만 반영, 새 F3 없음. 정본 `docs/reviews/t2-1-wave15-2026-08-25-sol-full.md`. clay 미변경. `docs/design-md-weight/migrated/{class101,classting,classum,claude}/` DESIGN + provenance + migration-log(`Revision 2026-08-25 (wave15 sol resubmit)`) + audit current-class. class101: first-party mark-file 부재/ownership-unclaimed 삭제, Google favicon lookup/non-promotion 유지. SHA `f62a7e23c1a3d7baa33ed730f311e4456065412ad787091bebc7c75297a555ac`. classting: Proof vs prose-derived 분리, Orange Type: button 삭제, CT parent-corporate, §1/§9/§11 관계 복원, Proof gradient·naver hash provenance-only, empty-label/HK/20px 24px 원장 분리. SHA `c93c25b8c6171e6b7e42713009e95b8a641f5818f554dec225e3a384b8c90f7e`. classum: Large CTA L/E/S 생략, exclusive-family/first-party-mark 부정 삭제, freshness 35/36/39/40. SHA `25616be02cf9cf05bb041d3c15acf193b5439f783f55dbc36d597aeeba637d16`. claude: `# faf9f5` provenance-only, §11 product/category Scope 17, Audience product-brief 삭제, homepage Scope 9, schema 20/121/176. SHA `37a5dbc275c0ad90741b1799b3dd175c7463e1f06abffb9f456dbe9fae31836b`. 4/4 `--gate-only` PASS/problems `[]`, Core `portable_core: true`. 세 원장 줄번호 전수 grep 재검증. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2-1 웨이브 15 sol 전수 검토 = **전체 FAIL, PASS 1/5**. 정본 docs/reviews/t2-1-wave15-2026-08-25-sol-full.md. class101은 Google favicon→first-party mark-file 부재 확장, classting은 prose-derived→home evidence 승격·Orange primitive 발명·§9/§1/§11·linked Proof 손실·원장 불일치, classum은 Large CTA C2·font/logo negative·freshness pointer, claude는 linked Proof #faf9f5·§11 관계·Audience negative·원장 불일치. clay PASS. 5/5 gate/Core/fresh F3 실행·SHA 결속 PASS이나 의미 결함은 미치유. 고정 목록-only 동일 sol 재심; 새 F3 요구 없음. 카탈로그 채택 아님.
- 갱신: 2026-08-25 · T2 classum F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/classum/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope 9 this-contract-covers / 13 stay-unpromoted / 19 confined-to-first-party, Primary tasks named jobs, Audience 40, Distinctive 44 extras, Principles UI tails, capture-bound named Do’s, Avoid last-bullet, Semantic 86/96, Spacing 30px-gutter, Elevation gradient-11, Motion 118 absence, Font no-auth-font, Family 144, Capture 165 graph-not-adopted, Layout 323/325, Content 330/338에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#ff4438` +62/64, home URL +27, `verification_v2.schema: 2` 21/91/148, B3 Motion 120 not 118. `AUDIT_DONE fixes=26`. Post-F3 SHA-256 `471ef0c848d0a76d962093cc75dcc35bade4766b3cb38766e4868a501871c6e4`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 clay F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/clay/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope 11 this-contract-covers / 13 historical-facts / 15 bounded-scope, Audience not-a-substitute, Spacing 91, Elevation 110, Capture 169/171/198/225/251, Layout 303 public-pages-may-be-responsive에 인접 완전 B2a. Distinctive Rube Goldberg / Font Arial / Semantic chrome-unnamed / Layout 297 extras / Content wording-samples 과잉 한정 축소. provenance derived 범위를 본문 실제에 맞춤. homepage no-slash Scope 9 not 11, Rube Goldberg 13+156. `AUDIT_DONE fixes=22`. Post-F3 SHA-256 `a21f84fb00cb45e01bb7a5570ca64d02f476ceead0f72ea164ecf7fe21c8082f`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 claude F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/claude/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope 15 that-practical-role / 17 narrative-context, Semantic parchment-canvas-not-chat, Font live-evidence-basis, Capture 177 unspecified/no-generic-modal, Capture 181/183, Layout preserve-route-local, Content official-writing/tone-table에 인접 완전 B2a. Distinctive/Principles/Spacing/Shape/Family/Type 과잉 한정 축소. provenance derived 범위를 본문 실제에 맞춤. `simpleicons` provenance-only, §11 unique dest Scope 17, featured 42/72/81/115/259/355 not 13. `AUDIT_DONE fixes=20`. Post-F3 SHA-256 `18d981af51a29cb5571dbb598e03bc55c7c357a81910ecf41dc9f14336cdf08f`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `classum` 수동 이관 = **본문 반영, F3 완료**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/classum/{DESIGN.md,provenance.md,migration-log.md,audit-log.md}`. YAML unitless lineHeight `1.43`/`1.40`/`1.50` 비율 보존, button×4+card 컴포넌트별 보존, `tokens.source: reconciled` provenance-only, Google favicon URL provenance-only + Assets URL-free identity-boundary, generic Focus 없음/`focus-visible` 비승격, §13 source-bound audience roles만 Audience·sidecar biography 없음, 무출처 커브 없음·B3 다섯 증거 종류 본문 유지, University-LMS grid card kind/map 생략(C4), 네 CTA loading·error·success 역할별 not-applicable(C2), §14 10행 보존, `#ff4438` vs in-app destructive 비합침, `#f6f6f9` canvas vs card fill 비합침, `#ffffff` surface vs on-primary 비합침, ink `#232334` vs body `#333333` vs muted `#666b80` 비합침, YAML 8/12/30 vs harvested `8px`/`30px` 비합침. F1·F2 수행 후 F3 감사 완료. Post-F3 SHA-256 `471ef0c848d0a76d962093cc75dcc35bade4766b3cb38766e4868a501871c6e4`. `--gate-only` PASS/problems `[]`, `portable_core: true`. 워커 SHA `fe7db5ba…5fdf` superseded. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `clay` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/clay/{DESIGN.md,provenance.md,migration-log.md}`. YAML compact-action lineHeight `20.88` 숫자 보존(비율 비변환), `Type: card` 컴포넌트별 보존, header action/tab/select YAML type 없음·발명 없음, `tokens.source: live-extract` provenance-only, GitHub slug `clay-run` dual provenance+Assets identity-boundary, customer-logo ownership unclaimed, Focus `rgb(2, 2, 2)`/`rgb(242, 241, 236)`를 focus-visible로 비승격, §13 가상 biography 없음·sidecar 없음, 무출처 커브 없음·B3 다섯 증거 종류 본문 유지, Customer-logo card kind/map 생략(C4), Dark/Oat loading·error·success 생략(C2), Pricing select error applicable/loading·success 생략, Marketing tab L/E/S 역할별 not-applicable, §14 본문 보존, `#000000` vs `#1b1a18` 비합침, `#fefdfb` vs `#ffffff` 비합침, `#f3f2ed` vs `#f4f3f0` 비합침, YAML 12 vs `18px` vs `8px` 비합침. F1·F2 수행. `--gate-only` PASS/problems `[]`; Core `portable_core: true`. SHA-256 `d18b6b1f56b124dab0c0eec4ce6dc396e0e9530658984998189234a7948b8efc`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 class101 F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/class101/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope 15 legal-chrome split, Principles 49 implication tails, Semantic 85 omission-causal, Elevation 105 overlay omitted, Family 129 system-face, Type 137 `normal` tracking, Assets 151 ownership, Capture 164 `#202020` removal, Legal tab 256 chrome-not-nav, Layout 292 after-paragraph, Content 297 tone-table labels에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#FF5D00` +45, `#FFFFFF` +146, CLASS101+ URL Scope 11 not 13, `verification_v2.schema: 2` not 136, YAML lineHeight +147/45, `6,121px` 290 only. `AUDIT_DONE fixes=15`. Post-F3 SHA-256 `5278e4dd2d32f166d5c0af9b850a1e151a95e0436999097acf3a4608fce854e2`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 classting F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/classting/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope 13/17 follow-on names, Audience 32 lede-groups, Distinctive 36 extras, Semantic 85 hover-green, Shape 126 trailing, Motion 146/159, Type-rule 199 display-lg, Capture 229 after-list, Black CTA 274 yaml-no-padding/font, Outline 324 both-hexes, Orange tag 382/385, Layout 390/396에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#00C896` Freshness 허위 목적지 없음, `#FFFFFF` +249, Hero 56px→36px Layout 394 허위 목적지 없음, Proof `20px 24px` dual 132+320. `AUDIT_DONE fixes=20`. Post-F3 SHA-256 `f8d9c84d959b6d5960378a2b84aa8f61146a877c32a4d4734554a38b4869cf65`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `classting` 수동 이관 = **본문 반영, F3 완료**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/classting/{DESIGN.md,provenance.md,migration-log.md,audit-log.md}`. YAML unitless lineHeight `1.5`/`1.0`/`1.29`/`1.21` 비율 보존, button×4+card×2+badge 컴포넌트별 보존, Orange tag YAML type 없음·발명 없음, `tokens.source: prose-derived` provenance-only, Google favicon URL provenance-only + Assets URL-free identity-boundary, named Focus `hsl(165,100%,39%)`를 focus-visible로 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 커브 없음·B3 다섯 증거 종류 본문 유지, Card/badge kind/map 생략(C4), 네 CTA loading·error·success 생략(C2), §14 8행 보존, `#00C896` vs `#17A27E`/`#EFFFFA` 비합침, `#ED872D` vs `#ED872C` vs `#ED8936` 비합침, `#FAFAFB` vs `#FFFFFF` 비합침, YAML 9999 vs 6/8/16/24 비합침, Proof sidecar samples provenance-only. F1·F2 수행 후 F3 감사 완료. Post-F3 SHA-256 `f8d9c84d959b6d5960378a2b84aa8f61146a877c32a4d4734554a38b4869cf65`. `--gate-only` PASS/problems `[]`, `portable_core: true`. 워커 SHA `caf36542…6d4d` superseded. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `class101` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/class101/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight `1.25`/`1.29`/`1.38`/`1.67`/`1` 비율 보존, legal-list-item `type: listItem` 컴포넌트별 보존, home nav/outlined YAML type 없음·발명 없음, `tokens.source: live-extract` dual Scope+provenance, Google s2 favicon URL provenance-only + Assets URL-free identity-boundary / ownership unclaimed, generic Focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 커브 없음·B3 다섯 증거 종류 본문 유지, Home navigation/outlined loading·error·success 생략(C2), Home/legal tabs 역할별 not-applicable, list item kind/map 생략(C4), §14 source 문장 보존, `#FF5D00` vs orange CTA 비합침, `#0C0C0C` vs `#000000` 비합침, `#FFFFFF` vs `rgba(255,255,255,0.298)` 비합침. F1·F2 수행. `--gate-only` PASS/problems `[]`; Core `portable_core: true`. SHA-256 `ab304f713eaef002c9b06d28fe3f1fdebb59b7a4bb0c25362290c7cf2ad6d950`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `claude` 수동 이관 = **본문 반영, F3 완료**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/claude/{DESIGN.md,provenance.md,migration-log.md,audit-log.md}`. H1 `Claude (Anthropic) Design System`. YAML unitless lineHeight 1.10/1.20/1.60 비율 보존, tab×1+card×3 컴포넌트별 보존, Appearance Toggle YAML type 없음·kind/map 생략(C4), `tokens.source: reconciled` provenance-only, Simple Icons slug `anthropic` dual provenance+Assets identity-boundary, generic Focus 없음/`focus-visible` 비승격, §13 official groups만 Audience·sidecar biography 없음, 무출처 커브 없음·B3 다섯 증거 종류 본문 유지, Overview Tab loading·error·success 역할별 not-applicable(C2), `#c96442` vs `#141413` 비합침, `#f5f4ed` vs `#ffffff` vs `#f0eee6` vs `#e8e6dc` 비합침, `#5e5d59` vs `#5d5c58` vs `#4d4c48` 비합침, 6 vs 8 vs 12 vs 16 vs 24 vs 32 비합침. F1·F2 수행 후 F3 감사 완료. Post-F3 SHA-256 `18d981af51a29cb5571dbb598e03bc55c7c357a81910ecf41dc9f14336cdf08f`. `--gate-only` PASS/problems `[]`, `portable_core: true`. 워커 SHA `062b0756…db56` superseded. sol 의미 레인 대기. 카탈로그 채택 아님.

- 갱신: 2026-08-24 · T2-1 웨이브 14 sol 최종 확인 = **전체 PASS, 잔여 2/2, 선행 재제출 조건 20/20**. 정본 `docs/reviews/t2-1-wave14-2026-08-24-sol-final.md`. `sol-recheck.md`의 chunghwa·cjonstyle current 원장 동기화 조건만 대조했고 새 기준·새 F3 없음. chunghwa Motion limiter/duration/easing/B3/Font/Family/Type-role/Capture, cjonstyle Scope/Primary tasks/Audience/component-state/Utility/Carousel/Layout current 목적지가 실제 DESIGN과 일치하며 과거 stale current 기록은 supersede. SHA 두 건 불변. 카탈로그 채택 주장은 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 14 grok-4.6 pointer sync = **원장만 개정 2/2, 의미 재심 대기**. 워커 grok-4.6. 정본 `docs/reviews/t2-1-wave14-2026-08-24-sol-recheck.md` chunghwa·cjonstyle 조건 5. DESIGN.md 미변경. 각 `migration-log.md`에 `Revision 2026-08-24 (wave14 pointer sync)`. chunghwa: signature limiter 163, B3 171, Motion 145, Font 179, Family 192, Type-role 196, Capture 221, duration 149–151 / easing 157–159; provenance inventory B2a 전수 일치. SHA 불변 `4f7e86db6b88651f60654f90feb355d87472e8e674883e16b942c94f1fa4c488`. cjonstyle: Scope 19/21/23/25, Primary tasks 31, Audience 40, Utility/Carousel 446/475, field note 447/476, Layout after-table 559/561/563, Type/C2/L/E/S/C4 current dests; provenance inventory B2a 전수 일치. SHA 불변 `0f39717dbc6a5997d9bf9a0b5ff5591d65af064ad4e5a030da6f58fd6c19826d`. 새 F3 없음. 본문 조건 1–4 미재개. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 14 동일 sol 목록-only 집중 재심 = **전체 FAIL, PASS 3/5, 선행 재제출 조건 18/20 PASS**. 정본 `docs/reviews/t2-1-wave14-2026-08-24-sol-recheck.md`. 새 기준·새 F3 실행/요구 없음. cgv 4/4 PASS: ownership 경계와 elevation/toast negative 삭제 및 원장/SHA/검사 완료. channeltalk 3/3 PASS: marketing imagery ownership unclaimed, Scope 15 + Assets 170 다중 목적지, audit/F2/SHA/검사 완료. china-airlines 3/3 PASS: schema 2와 selector-bound Proof/lineage/interaction breakdown 복원, historical F3 absence supersede, SHA/검사 완료. chunghwa 4/5 FAIL: 본문 motion/§11/Proof/live-extract·F3 조건은 PASS이나 provenance current inventory와 migration/audit의 Motion/B3 목적지가 개정 전 위치를 유지. cjonstyle 4/5 FAIL: Proof/Carousel/§11/hairline은 PASS이나 provenance current inventory가 Scope 19/21/23 및 후속 목적지를 개정 전 위치로 기록하고 audit current-grep도 stale. 5/5 `--gate-only` PASS/problems `[]`, Core `portable_core:true`, current SHA 일치. 잔여 고정 조건은 chunghwa/cjonstyle current 원장 동기화뿐. 5/5 PASS 전 웨이브 완료·카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 14 grok-4.6 sol 재제출 = **본문+원장 개정 5/5, 의미 재심 대기**. 워커 grok-4.6. 규칙집 v7. 고정 목록만 반영, 새 F3 없음. 정본 `docs/reviews/t2-1-wave14-2026-08-24-sol-full.md`. `docs/design-md-weight/migrated/{cgv,channeltalk,china-airlines,chunghwa,cjonstyle}/` DESIGN + provenance + migration-log(`Revision 2026-08-24 (wave14 sol resubmit)`) + audit current-class. cgv: first-party catalog 삭제, elevation/toast negative 삭제, ownership unclaimed. SHA `9f9ca84aaf5b0941945ca0b205851b777b8fa8e2f806d60281e4a63a55897792`. channeltalk: first-party marketing 삭제, §1 사진 dual Scope 15 + Assets 170. SHA `a9e42f8dc69f0e98c60b81da2753a7918073a04e6626c78f9c7a03e0fbdcb1bf`. china-airlines: `verification_v2.schema: 2` provenance 복원; Proof tuple/`dialog-2-1`/lineage/interaction breakdown provenance-only. SHA 불변 `8fb4175f0f87db792a2438ecb4bba6db47e751e79b62965be288a1b8ba245d8f`. chunghwa: carousel slide/cadence/easing 분리; §11 사실·관계 Scope 17/19/21/23; Proof 6 px/69 px/13.33 px/`20px`×86/`50px`×26; live-extract provenance-only; `F3 was not run` supersede. SHA `4f7e86db6b88651f60654f90feb355d87472e8e674883e16b942c94f1fa4c488`. cjonstyle: Proof raw provenance; Carousel 비대칭/`rgb(209,209,209)` 분리; §11 17/19/21/23/25; hairline §4 → Component 430 / provenance 96·claim row. SHA `0f39717dbc6a5997d9bf9a0b5ff5591d65af064ad4e5a030da6f58fd6c19826d`. 5/5 `--gate-only` PASS/problems `[]`, Core `portable_core: true`. 원장 dest 전수 재grep. 동일 sol 목록-only 재심 대기. 5/5 PASS 전 웨이브 완료·카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 14 sol 전수 검토 = **전체 FAIL, PASS 0/5**. 정본 `docs/reviews/t2-1-wave14-2026-08-24-sol-full.md`. cgv/channeltalk asset ownership 승격(cgv는 새 elevation·toast negative 추가), china-airlines metadata·linked Proof tuple/lineage 손실, chunghwa carousel motion 결합·§11/Proof 손실·원장 불일치, cjonstyle linked Proof/Carousel·§11·hairline source-row 불일치. 5/5 `--gate-only` PASS, Core `portable_core:true`, 기존 fresh F3 실행·current SHA 결속 PASS이나 의미 결함은 미치유. 고정 재제출 조건만 동일 sol 재심; 새 F3 요구 없음. 5/5 PASS 전 웨이브 완료·카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 cjonstyle F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/cjonstyle/audit-log.md`. 토큰·표·applicability·구조 미변경. Elevation 131 limiter-local extras, Utility/Carousel YAML-row-absent 440/464, Layout 538 extras + after-table 548/550/552, Content 559 em-dash role labels에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#640faf` Capture 225, `#ec0040` complete dests, homepage/homeTab/PDP/medium dests, YAML lineHeight 196/198/206/209. `AUDIT_DONE fixes=12`. Post-F3 SHA-256 `e89aeaeedd04b0b18e4a64bd5b9e25b44bfbddbd698002fcd32ec19af9e2358d`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 china-airlines F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/china-airlines/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope this-contract-covers / atmosphere keep-high-density, capture-bound not-reproduce-assets, Family do-not-name-or-substitute, Assets invented-decoration, Capture selector-backed / states-summaries, Search Kind omitted causal, Content tone-table directions / English-pages-not-locale에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. catalog homepage Scope 9 not 11, `verification_v2.schema: 2` provenance 허위 목적지 없음, `#d81159` 203 not 202, YAML `pill` 40 extra dests, body px 265–267, Roboto/Noto URLs provenance-only, field-note B2a not 229, selectors 153/212. `AUDIT_DONE fixes=14`. Post-F3 SHA-256 `8fb4175f0f87db792a2438ecb4bba6db47e751e79b62965be288a1b8ba245d8f`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 cgv F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/cgv/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope 11/13 this-contract-covers·token-note-defaults / square-list-rows·current-capture-only, Primary tasks 21 harvested-home-not-destination-routes, Audience 30 unique-relationship extras, Motion 120 source-stated-absence, Font 130 evidence-class extras, Assets 163 discovery-context·unclaimed, Capture 170 philosophy-layer, Capture 184 selector-backed-static / zero-interaction, Menu 270 kind-from-Use, Layout 289 preserve-where-appropriate, Content 304 corporate-framing voice-context에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#121212` Scope 13, Semantic 86 not 87, Named gaps layout 359 not 360, claim ledger 85–101. `AUDIT_DONE fixes=20`. Post-F3 SHA-256 `efcbe5cc3f7564dbfbb1d8899e144dfc0291926e201bf03651ad15c53e279939`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 channeltalk F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/channeltalk/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope 15/17/19, Distinctive 44, Semantic 85, Family 151, Type 155, Capture 177, Tab 265, Docs icon 292, Layout 309/316, Content 323에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `reconciled` provenance-only, `#242428` dest 247, YAML `9999` Distinctive/field notes, 30–45px Layout 316. `AUDIT_DONE fixes=17`. Post-F3 SHA-256 `8b903d73774fa1607ad5196dc63195856038ed6da2fdb338a89880db3eb9c931`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 chunghwa F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/chunghwa/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope atmosphere extras, Semantic named-hover-pressed, Motion carousel-two-way-token, Family same-system-stack, Primary CTA named-hover-hex / session-expired-page-row 265, Primary Tab named-active, Search 13px-Small-Label, local recipes sub-nav/Small-Label에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#209cff` +407, `#ff874d` 457 not 71/460, `#0083ec` not 233, `#000000` 71/78 only. `AUDIT_DONE fixes=14`. Post-F3 SHA-256 `046e292c241960a6a9930e9d2cb5a2d375f9cdde930b8d661d85252b3424adcd`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `chunghwa` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/chunghwa/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.40/1.42/1.38/1.60/1.44/1.50 비율 보존, button×2+tab×2+card+input+badge×2 컴포넌트별 보존, Blue Tint Card YAML type 없음·발명 없음, `tokens.source: live-extract` provenance, first-party HiNet favicon URL dual provenance+Assets identity-boundary, named Hover `#0083ec`를 focus-visible로 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개(ease-exit 템플릿 일치)는 provenance omission ledger·duration 100/200/300ms/easing 이름/`prefers-reduced-motion` 보존, White Service Card/Blue Tint Card/badges kind/map 생략(C4), Primary CTA/Find More loading·error·success 생략(C2), Search Input error applicable/loading·success 생략, Nav 역할별 not-applicable, §14 9행 보존+philosophy-layer 분류, B3 다섯 증거 종류 본문 유지, `#209cff` vs `#0083ec`/`#ff874d` 비합침, `#cbcbcb` vs `#eaeaea` 비합침, YAML 50px/`100px` vs live 54px/`30px` 비합침. F1·F2 수행. `--gate-only` PASS/problems `[]`; Core `portable_core: true`. SHA-256 `70e4858c3d183ef19f742330c44ed3a953a361718f5cfd508187d60aaf60612e`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.

- 갱신: 2026-08-24 · T2 워커 `china-airlines` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/china-airlines/{DESIGN.md,provenance.md,migration-log.md}`. H1 `中華航空 Design System`. YAML lineHeight 28/56 숫자 보존·비율 비변환, button×2+dialog 컴포넌트별 보존, Search dialog C4 kind/map 생략, `tokens.source: live-extract` provenance+Scope+Font, Google favicon dual provenance+Assets, generic Focus 없음/`focus-visible` 비승격, §13 공식 그룹만 Audience·sidecar biography 없음, 무출처 커브 없음·B3 다섯 증거 종류 본문 유지, Primary blue L/E/S 생략(C2), Selected menu option L/E/S 역할별 not-applicable, `#23569d` vs `#1d6dcd` vs `#d81159` 비합침, ink `#17181c` vs dialog `#000000` 비합침, 8px vs 20px vs YAML pill 40 비합침. Canonical Proof `web/references/china-airlines/.verification.md` SHA `cfc216dd…e2ab`. F1·F2 수행. `--gate-only` PASS/problems `[]`; Core `portable_core: true`. SHA-256 `15c0a5514b9e2e4ca4490db2f5ed551fc0cc316b008e56752aad27e4ee825379`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `channeltalk` 수동 이관 = **본문 반영, F3 완료**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/channeltalk/{DESIGN.md,provenance.md,migration-log.md,audit-log.md}`. YAML unitless lineHeight `1.41`/`1.56`/`1.59` 비율 보존, button×3+card+tab 컴포넌트별 보존, Marketing information card C4 kind/map 생략, `tokens.source: reconciled` provenance-only, `ds.type: system` dual Scope+provenance, GitHub slug `channel-io` dual provenance+Assets, named Focus 없음·focus-visible 비승격, §13 task contexts만 Audience·sidecar biography 없음, 무출처 커브 없음, B3 전문 Motion 125, Primary/outline/docs-icon loading·error·success 생략(C2), Tab L/E/S 역할별 not-applicable, selected/pressed는 추가 관측 상태, `#242428` vs `#000000` vs `#3a3530` 비합침, canvas `#ffffff` vs on-primary 비합침, Pretendard vs Inter vs NotoSansJP 비합침, 6 vs 8 vs 35 vs 9999 비합침. F1·F2 수행 후 F3 감사 완료. Post-F3 SHA-256 `8b903d73774fa1607ad5196dc63195856038ed6da2fdb338a89880db3eb9c931`. `--gate-only` PASS/problems `[]`, `portable_core: true`. 워커 SHA `2f201346…4f09` superseded. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `cgv` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/cgv/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight `1.4`/`1` 비율 보존, button×2+badge+listItem 컴포넌트별 보존, Screen Format Badge C4 kind/map 생략, `tokens.source: live-extract` provenance+Scope, Google s2 favicon dual provenance+Assets, named Focus 없음·focus-visible 비승격, §13 이해관계자 그룹만 Audience·sidecar 없음, 무출처 커브 없음, B3 전문 Motion 122. SHA-256 `b6b28c4ba25f2cf1c5d92713bf9c1971460c1a02f6646e5e26b1c2a0440a0ec0`. `--gate-only` PASS/problems `[]`, `portable_core: true`. F3 감사·카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `cjonstyle` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/cjonstyle/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight `1.4`/`1.5` 비율 보존, button×3+tab×2+card+input+badge 컴포넌트별 보존, Utility/Carousel YAML type 없음·발명 없음, `tokens.source: live-extract` provenance, Google favicon URL provenance-only + Assets URL-free identity-boundary, generic Focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개(ease-exit 템플릿 일치)는 provenance omission ledger·duration 120/200/400ms/easing 이름/`prefers-reduced-motion` 보존, Product Card/Sale kind/map 생략(C4), Buy/Inquiry/Wishlist/Search loading·error·success 생략(C2), GNB/PDP Tab/Utility/Carousel 역할별 not-applicable, §14 10행 보존+philosophy-layer 분류, B3 다섯 증거 종류 본문 유지, `#640faf` vs `#ec0040`/`#d53225`/`#f26d00` 비합침, 0px vs 2px vs 4px vs 11px vs 18px vs 9999 vs 50% 비합침, §9 네 local recipe 복원. F1·F2 수행. `--gate-only` PASS/problems `[]`; Core `portable_core: true`. SHA-256 `9927327569741ed58b8b16cf7607c8421d813ea68ac673bf4729ff47d38733d7`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 13 sol 최종 확인 = **전체 PASS, 대상 5/5, 선행 목록 24/24**. 정본 `docs/reviews/t2-1-wave13-2026-08-24-sol-final.md`. `sol-recheck.md`의 잔여 조건만 대조했고 새 기준·새 F3 없음. cakeresume current dests, cal unsupported Font negative 삭제+current dests, cashapp Default Input/easing/§14 다중 목적지, catchtable Merchant/Careers/Named-gaps dests, cathay canonical `rgb(0, 0, 0) → #000000 — 45`+Type Notes/Named-gaps/Observed dests 모두 PASS. 카탈로그 채택 주장은 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 13 원장 동기화 (grok-4.6) = **본문 미변경, 원장만 개정 5/5, 동일 sol 목록-only 재제출 대기**. 워커 grok-4.6. 정본 잔여 `docs/reviews/t2-1-wave13-2026-08-24-sol-recheck.md`. 새 F3 없음. `migrated/{cakeresume,cal,cashapp,catchtable,cathay}/` provenance current dests + each `migration-log.md` `Revision 2026-08-24 (wave13 ledger sync)`. DESIGN.md 미변경, SHA 불변: cakeresume `5b44da49…de5035`, cal `3e6be0da…df4a3`, cashapp `3871ca7f…59ca4`, catchtable `facafe53…a4dc1`, cathay `cafa1223…0d583`. cakeresume: Brand green 84 / capture 162–163 / Primary 183 / Secondary 210 / Assets 153 / Named gaps 324 / Font 126 / B3 118. cal: Font negatives `no-authored-type-token-document` / `naming-not-FontFace` / `distribution-not-load` current inventory에서 삭제; dests Capture 230 / Font 155/159 / Type-rule 199 / Default Badge 468/474 / Layout 561/563. cashapp: provenance에 Default Input 329/238/616, easing 157–159/611, §14 612/614/615 다중 목적지 반영. catchtable: Merchant 263/270, Careers 287/294, Named gaps 368–379/378/379. cathay: Proof `rgb(0, 0, 0)` → `#000000` — 45; Type Notes 204–207 복원 기록; Named gaps 594–603/600; Observed 534–536. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 13 동일 sol 목록-only 집중 재심 = **전체 FAIL, PASS 0/5, 선행 재제출 조건 17/24 PASS**. 정본 `docs/reviews/t2-1-wave13-2026-08-24-sol-recheck.md`. 새 기준·새 F3 실행/요구 없음. cakeresume 4/5: 본문 조건 1–4 PASS, 조건 5 FAIL — `provenance.md:21,23,27,151,155` current 포인터 stale. cal 3/5: recipe/persona/task PASS, 조건 4–5 FAIL — `provenance.md:126` unsupported font negative current 유지 및 `:123-126` 포인터 stale. cashapp 3/4: §6/§11·Proof·audit/SHA PASS, 조건 3 FAIL — provenance에 Default Input `616`, easing `611`, §14 `612/614/615` 다중 목적지 미반영. catchtable 2/3: on-brand/merchant 분리·color-negative 삭제 PASS, 조건 3 FAIL — provenance가 삭제 전 Merchant/Careers/Named-gaps 포인터 유지. cathay 5/7: 조건 1–5 PASS, 조건 6–7 FAIL — canonical `#000000 — 45` 미복원(`rgb(...) — 45`만) 및 provenance Notes/Named-gaps/Observed current claim stale. 5/5 `--gate-only` PASS/problems `[]`, Core `portable_core:true`, current SHA 일치. 잔여 고정 조건만 교정 후 동일 sol 재제출; 5/5 PASS 전 웨이브 완료·카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 13 grok-4.6 sol 재제출 = **본문+원장 개정 5/5, 의미 재심 대기**. 워커 grok-4.6. 규칙집 v7. 고정 목록만 반영, 새 F3 없음. 정본 `docs/reviews/t2-1-wave13-2026-08-24-sol-full.md`. `docs/design-md-weight/migrated/{cakeresume,cal,cashapp,catchtable,cathay}/` DESIGN + provenance + migration-log(`Revision 2026-08-24 (wave13 sol resubmit)`) + audit-log. cakeresume: canonical `.verification.md` Proof 연결; Font live surface-use + YAML declaration; §7 다섯 Do와 `#378060` §2/§9 분리; persona literal generic deletion. SHA `5b44da4936ada1c813450aaea948216cfd6e9f1cc9d2c338546d0dbb28de5035`. cal: §9 다섯 local recipe 복원; D2 generic deletion; independently verified는 `"Get started"` only; font/logo/microcopy negatives 삭제. SHA `3e6be0da36e14543491dbcf4b912b13c6c248ee4c5c75c17679b1bf8b73df4a3`. cashapp: §6 anti-corporate 관계·§11 진화 복원; sidecar 14.8 px / Secondary typeface / 756-byte Proof; Default Input 329/238/616, easing 157–159/611. SHA `3871ca7f8067f32a2e0e8d376aa5f8e59f849ca25932872e7baa264f21659ca4`. catchtable: `on-brand` careers-only; merchant `#FFFFFF` component-local fg; color-negative domain 삭제. SHA `facafe53ba098fc836a330de7329d0cc011a19f57e1dc23405fb3be4650a4dc1`. cathay: Type Notes·Primary CTA 네 Use; Quiet Nav/Sign-in/Glass kind+map; ownership 삭제; Audience B2a 앞; 想轉就轉 derived-only; Proof `rgb(0,0,0)—45`; pointer 동기화. SHA `cafa12233729a0b3830fd37cb6481d348faa254f18b1206ddc4354dbf8b0d583`. 5/5 `--gate-only` PASS/problems `[]`, Core `portable_core: true`. 동일 sol 목록-only 재심 대기. 5/5 PASS 전 웨이브 완료·카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 13 sol 전수 검토 = **전체 FAIL, PASS 0/5**. 정본 `docs/reviews/t2-1-wave13-2026-08-24-sol-full.md`. cakeresume: canonical Proof false-absence, font class/negative, §7 허위 귀속, persona fragment 재수록. cal: §9 local recipe 5건 손실, persona segment/task 권위, font/logo/microcopy negative. cashapp: §6/§11 관계 손실, sidecar-only 14.8px·secondary typeface·favicon proof 손실, E2 pointer. catchtable: careers `on-brand`/merchant fg 결합, 새 color-negative domain. cathay: Type Notes·Primary CTA Use 손실, anchor kind/C4, asset ownership/B2a, Observed 승격, Proof/pointer. 5/5 `--gate-only` PASS, Core `portable_core:true`, 기존 fresh F3 실행·SHA 결속 PASS이나 의미 결함은 미치유. 고정 조건 목록-only 동일 sol 재제출; 새 F3 요구 없음. 5/5 PASS 전 웨이브 완료·카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 cathay F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/cathay/audit-log.md`. 토큰·표·applicability·구조 미변경. Primary tasks independently-verified-homepage-URL, Elevation overlay-scrim 130/141, Motion signature extras 163, Family do-not-replace 193, Capture philosophy-layer 219, YAML-row-absent-Type-not-invented 239/326/342, Primary CTA named-press 256, Form Input named-Focus 390에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#e87c07` Distinctive/Semantic/Capture/Input dest, YAML `9999` Distinctive/field notes, Notes Hero 203 only, C4 local recipes 437/452/464. `AUDIT_DONE fixes=20`. Post-F3 SHA-256 `3814808edcc122e389349cb282f37cbfc9ad55cac8928eb8da6501f57058ae88`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 cal F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/cal/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope reconstruction-coverage / catalog-commentary extras / evidence-domain extras / atmosphere extras / public-history / refusal extras, Primary tasks not-from-§13, Audience segment-labels-not-Audience, Distinctive limiter-precedes-list, Principles named stems, capture-bound extras, Avoid named Don’ts + last-bullet, Semantic limiter-precedes-list, Spacing 1px-2px-3px-6px, Shape named local-geometry, Elevation extras, Motion omitted-curves, Font extras, Type-role unitless/tracking, Assets Simple Icons, Capture graph-not-adopted, field-note unmerges, Layout recorded-span precede, Content voice extras에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. live-DOM 13.92px Foundations 허위 목적지 없음, `"Get started"` Primary tasks 27 not Scope, 16px gap Typography “not promoted” 허위 목적지 없음, B3 전문 Motion 147. `AUDIT_DONE fixes=38`. Post-F3 SHA-256 `2ec1adc92cc798f79fcedbd97518bc5bddc58d75f3f80bd0272c92d46f33e923`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 catchtable F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/catchtable/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope values-stay-attached, Motion intentionally-undocumented, Type-role 13px-labels, Family declared-only-fonts, Assets no-named-icon-library-unclaimed, Capture 179 default-only/surface-2, Capture 181 omitted-L-E-S-fields, Layout 312 extras, Merchant 281 surface-2-not-copied에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. consumer URL 58→57, merchant 59→58, careers +59, declared-only Family 153 only (Capture 183 허위 목적지 없음), `#002d4e` Claim 106 not 107, `#ff3d00` Freshness 43. `AUDIT_DONE fixes=13`. Post-F3 SHA-256 `3fe295155a4fbffa56f03f19b356b689e082bc76421efa236bb4ca30ef4e7485`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 cashapp F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/cashapp/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope typography-HTML-comment / atmosphere extras, Principles named UI implication tails, capture-bound omnipresent-but-strategic, Avoid extra Don’t tails, Semantic muted-soft-as-input-border, Spacing limiter-precedes YAML-without-px, Elevation emphasis-via-green-or-citron (phantom anti-corporate removed), Motion signature extras, Type-role button unmerges, Layout focal-action / whitespace-philosophy precede / collapsing extras, Content tone-table labels에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. Use 252 not 251, `country` 11, Narrative 103/105, canonical `.verification.md` 연결. `AUDIT_DONE fixes=18`. Post-F3 SHA-256 `99b0960afde126c010c27a48397eadf0bce37db1cbf33d744b98c7b445856d01`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 cakeresume F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/cakeresume/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope coverage / atmosphere extras / rename-growth extras, Primary tasks captured-controls-not-from-§13, Audience no-individual-personas, Distinctive one-filled-action, capture-bound named Do’s, Avoid named Don’ts, Semantic limiter-precedes-list extras, Spacing 4px-as-separate, Elevation extras, Motion crisp-engineered, Font/Family extras, Capture graph-not-adopted, Layout extras, Content voice extras에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#13AB67` Scope 13/Distinctive 45/capture-record 166 등 이중 목적지 교정, homepage 147 허위 portable dest 없음, Assets 156, B3 117 not Named gaps 324. `AUDIT_DONE fixes=22`. Post-F3 SHA-256 `c1e1778a655b55f53feac403c6aee369513263ea4c99eae080e08dbc04f90777`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `cathay` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/cathay/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight `1.50` 비율 보존, button×2+tab×2+card×2+input 컴포넌트별 보존, Quiet Nav/Utility Sign-in YAML type 없음·발명 없음, `tokens.source: live-extract` provenance, first-party apple-touch URL dual provenance+Assets, named Focus `#00512a`를 focus-visible로 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개(ease-exit 템플릿 일치)는 provenance omission ledger·duration 150/250/400ms/easing 이름/`prefers-reduced-motion` 보존, Standard Card/Glass Tile/Quiet Nav/Sign-in kind/map 생략(C4), Primary CTA/Outline loading·error·success 생략(C2), Form Input error applicable/loading·success 생략, Nav/Footer 역할별 not-applicable, §14 7행 보존+philosophy-layer 분류, B3 다섯 증거 종류 본문 유지, `#00512a` vs `#26a862` 비합침, `#fafafa` vs `#ffffff` 비합침, 5px vs 0px vs YAML 9999 비합침. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `d03d2255986ecefcb473146f76002965ef31b0fa34c45b5950025cf4f09a1950`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `catchtable` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/catchtable/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight `1.50`/`1.35` 비율 보존, input+button×4 컴포넌트별 보존, `tokens.source: reconciled` provenance, Google favicon URL dual provenance+Assets identity-boundary, generic Focus 없음/`focus-visible` 비승격, §13 official groups는 Audience만·sidecar biography 없음, 무출처 커브 없음·B3 다섯 증거 종류 본문 유지, Search/Merchant CTA/Careers orange loading·error·success 생략(C2), Filter/Discovery L/E/S 역할별 not-applicable, §14 default-only 보존, `#ff3d00` vs `#002d4e` 비합침, `#222222` vs `#000000` 비합침, `Pretendard Std Variable` vs `Pretendard` vs `NanumSquareRound` 비합침, YAML spacing xs 4에 px 접미사 비발명, 세 도메인 비합침. F1·F2 수행. `--gate-only` PASS/problems `[]`; Core `portable_core: true`. SHA-256 `01ee03fe3956eda6cf4047bb4bf69bfc47da5fd0453aedb4acecadd7d937c552`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `cashapp` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/cashapp/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.0/1.1/1.2/1.5 비율 보존, button×3+tab×2+card×2+badge+avatar 컴포넌트별 보존, Default Input YAML type 없음·발명 없음, `tokens.source: live-extract` provenance, Google favicon URL dual provenance+Assets identity-boundary, generic Focus 없음/`focus-visible` 비승격, Marketing Nav `#00e013` hover는 captured variant, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개(ease-exit 템플릿 일치)는 provenance omission ledger·duration 120/220/360ms/easing 이름/`prefers-reduced-motion` 보존, Light Feature Card/Dark Tile/Citron Chip kind/map 생략(C4), Sign Up/Log In/Sign Up on Dark loading·error·success 생략(C2), Default Input error applicable/loading·success 생략, Nav/Portal Nav/Account L/E/S 역할별 not-applicable, §14 9행 보존+philosophy-layer 분류, B3 다섯 증거 종류 본문 유지, `#00e013` vs `#d8ff14`/`#3860be` 비합침, 999px vs 9999px vs 50% vs 2px vs 20px 비합침, §9 White Hero/Feature Card/Dark Section/Marketing Top Nav 로컬 보존. F1·F2 수행. `--gate-only` PASS/problems 0; Core `portable_core: true`. SHA-256 `46efba83d5815a796297757bd55e6da54bc609f4439ccbec99c5cb7f3e41a7ef`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 cal F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/cal/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope reconstruction-coverage / catalog-commentary extras / evidence-domain extras / atmosphere extras / public-history / refusal extras, Primary tasks not-from-§13, Audience segment-labels-not-Audience, Distinctive limiter-precedes-list, Principles named stems, capture-bound extras, Avoid named Don’ts + last-bullet, Semantic limiter-precedes-list, Spacing 1px-2px-3px-6px, Shape named local-geometry, Elevation extras, Motion omitted-curves, Font extras, Type-role unitless/tracking, Assets Simple Icons, Capture graph-not-adopted, field-note unmerges, Layout recorded-span precede, Content voice extras에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. live-DOM 13.92px Foundations 허위 목적지 없음, `"Get started"` Primary tasks 27 not Scope, 16px gap Typography “not promoted” 허위 목적지 없음, B3 전문 Motion 147. `AUDIT_DONE fixes=38`. Post-F3 SHA-256 `2ec1adc92cc798f79fcedbd97518bc5bddc58d75f3f80bd0272c92d46f33e923`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `cal` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/cal/{DESIGN.md,provenance.md,migration-log.md}`. H1 `Cal.com Design System`. YAML unitless lineHeight 1.10/1.30/1.20/1.50/1.40/1.00/1.14 비율 보존, button×5+input×2+card×3+badge×2+tab 컴포넌트별 보존, Compact/Inset/Large/Prominent YAML 밖 본문 슬롯, `tokens.source: prose-derived` provenance, Simple Icons `caldotcom` dual provenance+Assets, catalog `#111827` vs Charcoal `#242424` 비합침, live-DOM `#000000`/`#f3f2ed`/13.92px 비합침, YAML `ring-soft` trailing `0px` vs Level 2 body 비합침, generic Focus/`#3b82f6`/`--framer-focus-outline`는 focus-visible 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 숫자 없음·B3 다섯 증거 종류 본문 유지, Card/Badge kind/map 생략(C4), harvested CTA/input/nav loading·error·success 생략(C2), §14 11행 보존, Default Badge inferred B2a. F1·F2 수행. `--gate-only` PASS/problems `[]`; Core `portable_core: true`. SHA-256 `2c5d4d0f05a93d8521d588a79ecae50e8ac8a5a831da44d7c0b38b285d30cf57`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `cakeresume` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/cakeresume/{DESIGN.md,provenance.md,migration-log.md}`. H1 `Cake Design System`. YAML type button×2+input+badge 컴포넌트별 보존, `tokens.source: prose-derived` provenance, Google favicon URL provenance-only + Assets URL-free identity-boundary, generic focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 커브 없음·B3 다섯 증거 종류 본문 유지, Chip kind/map 생략(C4), Log In loading·error·success 생략(C2), Sign Up loading applicable/error·success 생략, Language Selector 역할별 not-applicable, §14 4행 보존, `#13AB67` vs `#0C4129`/`#378060` 비합침, `#FFFFFF` canvas vs on-primary 비합침, `#0E0E0F` vs `#000000` 비합침, YAML `full` 9999 vs 4px/no-pill Don’t 충돌 보존. F1·F2 수행. `--gate-only` PASS/problems 0; Core `portable_core: true`. SHA-256 `c50ea4851304b222e5ce5aae4b4ba443a70ee5a08f3ba0b00321fc1dd11f7f37`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 cafe24 sol 최종 재확인 = **PASS**. 기존 `docs/reviews/t2-1-wave12-2026-08-24-sol-recheck.md` 조건 8만 대조함. current 원장이 Circular 컴포넌트 `436–458`, 상태표 `451–458`, L/E/S `456–458`, Login White Card 4px tuple `492` · 보강 `495`로 동기화됨. 새 기준 추가 없음. 판정 정본 `docs/reviews/t2-1-wave12-2026-08-24-sol-final.md` 1행 `PASS`.
- 갱신: 2026-08-24 · T2-1 웨이브 12 grok-4.6 cafe24 pointer sync = **원장만 개정 1/1, 의미 재심 대기**. 워커 grok-4.6. 정본 `docs/reviews/t2-1-wave12-2026-08-24-sol-recheck.md` cafe24 조건 8. DESIGN.md 미변경. Circular 상태표 `451–458`, L/E/S `456–458`, 컴포넌트 `436–458`로 `provenance.md:143,169`와 `migration-log.md:22,28,33,74` 정정. Login White Card 4px tuple `492` · 보강 `495`로 `migration-log.md:65` 정정(490은 Anatomy: surface). `Revision 2026-08-24 (wave12 pointer sync)`. SHA-256 `b050dd6577bd01f79c0ca97d0298e8c5e0fc6b8575e8ffc610bc3c52c37e9d69` 불변. `--gate-only` PASS/problems `[]`; Core `portable_core: true`. 새 F3 없음. 본문 조건 1–7 미재개. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 12 동일 sol 목록-only 집중 재심 = **전체 FAIL, PASS 4/5, 선행 재제출 조건 22/23**. 정본 `docs/reviews/t2-1-wave12-2026-08-24-sol-recheck.md`. 새 기준·새 F3 실행/요구 없음. bmw 5/5, brandi 3/3, bunjang 4/4, buzzvil 3/3 PASS. cafe24는 본문 조건 1–7(Proof, Circular Type/kind/map, Persona scan, §9 네 local recipe, Type Notes·§11/§15 관계, Font class, App Blue/4px 분리)은 PASS이나 조건 8 current 원장/F2가 FAIL: 실제 Circular 상태표 `451–458`, L/E/S `456–458`인데 `provenance.md:143,169`과 `migration-log.md:22,28,33,74`가 `436–456`/`451–456`/`454–456`으로 stale; Login White Card tuple 실제 `492,495`를 current F2가 `490,495`로 오기. 5/5 gate PASS/problems `[]`, Core `portable_core:true`, SHA 일치. cafe24 원장 포인터 교정만 동일 sol 재제출 대상; 새 F3 없음. 5/5 PASS 전 웨이브 완료·카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 12 grok-4.6 sol 재제출 = **본문+원장 개정 5/5, 의미 재심 대기**. 워커 grok-4.6. 규칙집 v7. 고정 목록만 반영, 새 F3 없음. 정본 `docs/reviews/t2-1-wave12-2026-08-24-sol-full.md`. `docs/design-md-weight/migrated/{bmw,brandi,bunjang,buzzvil,cafe24}/` DESIGN + provenance + migration-log(`Revision 2026-08-24 (wave12 sol resubmit)`) + audit-log. bmw: `verification_v2.schema: 2` provenance 복원; §13 세 그룹 고유 관계 Audience 복원; Font Official product-use 행 삭제; Named-gaps 다중 목적지 동기화. SHA `77492c4dae561d58c335a606c6ebd2e48e6375961544302b3ea511c17e5a8dec`. brandi: C4 `Type: omitted`/`Kind: omitted` 필드 삭제(`Type: badge` 유지); provenance 색·Named gaps dest 보강. SHA `6debdbbc8cd32af5ea9121a4f20beabfe74111a3a41873e40fefdbfec5dcf32f`. bunjang: 3 variants × 4 sizes 복원; Font live computed only; Scope lookup host 제거; provenance `--remote-allow-origins` 복원. SHA `1ad844e1e575ca33779d1e0644f05cc5584a9633aaae8f1cf338c0819c41f089`. buzzvil: 세 segment literal 전부 제거, generic deletion only. SHA `7315015474e081c4c7ff79202e847b4c133a7e87fc3d6214832cc1380aa1f98c`. cafe24: canonical Proof 교정; Circular Icon Type/kind/map 복원; Persona Open→scan; §9 네 local recipe; Type Notes·§11/§15 관계; Font class; App Blue submit/4px 분리. SHA `b050dd6577bd01f79c0ca97d0298e8c5e0fc6b8575e8ffc610bc3c52c37e9d69`. 5/5 `--gate-only` PASS/problems `[]`, Core `portable_core: true`. 동일 sol 목록-only 재심 대기. 5/5 PASS 전 웨이브 완료·카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 12 grok-4.6 bmw sol resubmit = **본문+원장 개정, 의미 재심 대기**. 워커 grok-4.6. 정본 `docs/reviews/t2-1-wave12-2026-08-24-sol-full.md` §1 bmw. provenance Identity 17 / Freshness 35에 `verification_v2.schema: 2`. Audience 30–32에 §13 세 그룹 source-backed 고유 관계. Font Official product-use 행 삭제(다섯 source class만). Named-gaps dual dest 동기화. `Revision 2026-08-24 (wave12 sol resubmit)`. SHA-256 `77492c4dae561d58c335a606c6ebd2e48e6375961544302b3ea511c17e5a8dec`. `--gate-only` PASS/problems `[]`; Core `portable_core: true`. 새 F3 없음. F1/F2/F3 closed 재주장 없음. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 12 grok-4.6 cafe24 sol resubmit = **본문+원장 개정, 의미 재심 대기**. 워커 grok-4.6. 정본 `docs/reviews/t2-1-wave12-2026-08-24-sol-full.md` §5 cafe24. Canonical Proof `web/references/cafe24/.verification.md` (derived mirror 동일 SHA `5812cc95…`). Circular Icon `Type: button`/kind/map 복원. Persona task는 scan/read. §9 네 local recipe 복원. Type Notes + §11/§15 관계 복원. Font Official-product-use/Declared-only 및 Official history 제거. `#3971ff` submit fill / 4px shared geometry 분리. `Revision 2026-08-24 (wave12 sol resubmit)`. SHA-256 `b050dd6577bd01f79c0ca97d0298e8c5e0fc6b8575e8ffc610bc3c52c37e9d69`. `--gate-only` PASS/problems `[]`; Core `portable_core: true`. 새 F3 없음. F1/F2/F3 closed 재주장 없음. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 12 grok-4.6 bunjang sol resubmit = **본문+원장 개정, 의미 재심 대기**. 워커 grok-4.6. 정본 `docs/reviews/t2-1-wave12-2026-08-24-sol-full.md` §3 bunjang. Capture 207 + Primary 229 + Secondary 256에 3 variants × 4 sizes `_variant-{normal|primary|…}` × `_size-{XS|M|XL}` × `_full` 복원(세 번째 이름 미발명). Font table Live computed only (164: Pretendard Variable · `sans-serif` · Bunjang CDN · 211/211). Official-distributed / exclusive-negative / exact-woff2 Named gap / Official-product-use-as-DS-lookup / Declared-only 삭제. Scope 17에서 개별 lookup host/status 제거. provenance 58 `--remote-allow-origins` 복원. `Revision 2026-08-24 (wave12 sol resubmit)`. SHA-256 `1ad844e1e575ca33779d1e0644f05cc5584a9633aaae8f1cf338c0819c41f089`. `--gate-only` PASS/problems `[]`; Core `portable_core: true`. 새 F3 없음. F1/F2/F3 closed 재주장 없음. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 12 grok-4.6 buzzvil sol resubmit = **원장+Audience 개정, 의미 재심 대기**. 워커 grok-4.6. 정본 `docs/reviews/t2-1-wave12-2026-08-24-sol-full.md` §4. D2: 세 segment literal을 portable/provenance/migration/audit current-class와 superseded 주석에서 제거. Generic deletion only: `fictional archetype material deleted; not re-hosted`. Audience B2a는 세그먼트 미기재. 새 F3 없음. SHA-256 `7315015474e081c4c7ff79202e847b4c133a7e87fc3d6214832cc1380aa1f98c`. `--gate-only` PASS, Core `portable_core: true`. `Revision 2026-08-24 (wave12 sol resubmit)`. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 12 grok-4.6 brandi sol resubmit = **본문+원장 개정, 의미 재심 대기**. 워커 grok-4.6. 정본 `docs/reviews/t2-1-wave12-2026-08-24-sol-full.md` §2. C4 omitted-as-value Type/Kind 필드 삭제(listbox Type/Kind, badge Kind); `Type: badge` 265 유지; kind/map 설명은 prose 175/260/274 + Named gaps 335. 색 dual dest에 provenance.md:39,132,149 추가. §14/responsive/voice/persona/font/C4 Named gaps dest 보강. `Revision 2026-08-24 (wave12 sol resubmit)`. SHA-256 `6debdbbc8cd32af5ea9121a4f20beabfe74111a3a41873e40fefdbfec5dcf32f`. `--gate-only` PASS/problems `[]`; Core `portable_core: true`. 새 F3 없음. F1/F2/F3 closed 미주장. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 12 sol 첫 전수 판정 = **FAIL 5/5, PASS 0/5**. 정본 `docs/reviews/t2-1-wave12-2026-08-24-sol-full.md`. bmw/brandi/bunjang/buzzvil/cafe24 모두 `--gate-only` PASS/problems `[]`, Core exit 0/`portable_core:true`, 기존 fresh F3·current SHA 일치이나 의미 결함이 남음. 차단점은 verification metadata·source-backed 관계·Typography Notes 손실, evidence-kind/field-role 승격, §9 local composition, C4 kind-field omission, fictional-persona label 재수록, canonical Proof false absence, source-row 다중 목적지 오류다. 동일 sol 고정 목록-only 재제출 대기이며 새 F3는 요구하지 않음. 5/5 PASS 전 웨이브 완료·카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 cafe24 F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/cafe24/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope four-URL non-proxy / atmosphere extras / refusal extra names, Semantic utilitarian-sibling extras, Shape local-not-universal, Elevation hairline-not-merged, Motion Arriving-Dismissals-Two-way / spec-template-ease-exit-match, Font evidence-class extras, Type-role tracking-unmerged, Primary CTA/App Submit/Selector/Nav/Text Field/Tag Chip extra unmerges, Nav captured-variant, Layout recorded-span precede / collapsing extras, Content voice extras에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#084fff` Content Observed 488 허위 목적지 없음, `display_name_kr` dual Scope 9, Font live-extract 190. `AUDIT_DONE fixes=23`. Post-F3 SHA-256 `fde9399b9e7a63abe8d6553cfba583c398ec68d8f95aed8e1659760649d4ded0`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 brandi F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/brandi/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope contract-coverage / atmosphere extras / desktop-bound extras / not-authority-for-origin, Distinctive extra unmerges, official-principles + named Do’s, Avoid named Don’ts + last-bullet, Semantic extra list characterizations, Shape unlisted-control + trailing restatement, Elevation limiter-precedes, Family trailing Don’ts, Type-role shared-13px, Assets Pretendard-declared-only, field-note yaml-type-not-invented, Layout omitted-layout / no-mobile extras에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#1e1e1e` Principles 50, homepage/product URL dual dest, Newnex 19/293, `18px 4px` 185 not 184, listbox radius 106 not 107, `#ff204b` Avoid 62, option no-hover Named gaps 335. `AUDIT_DONE fixes=24`. Post-F3 SHA-256 `f0d0ff42822760644aa7f4c2587ce7cd2e6185be6d68e0cbd911a7fa952d0d4c`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 buzzvil F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/buzzvil/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope homepage-not-stand-in / character extras / typographic extras / tidy-4px / public-history extras, Audience named-groups-not-promoted, Semantic extra unmerged, Shape workhorse-rounding, Elevation over-named clean-fast-modern trimmed, Type-rule extras, Layout despite-being-a-data-performance-product, Content citation-character parentheticals에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. design-system post URL Scope 23/Narrative 74 허위 목적지 없음, `#0e171f` Top Nav hover 431. `AUDIT_DONE fixes=16`. Post-F3 SHA-256 `e7ee118cdc4f1c0ebac1abf6efe906fe2641f3b0474cfeca586ede39bbd1cf5c`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 bmw F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/bmw/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope authenticated-not-claimed / driving-pleasure extra, Audience groups-not-user-flow, Distinctive mostly-square / unpromoted-states, Principles named UI implications, capture-bound lawful-fallback, Semantic omission-causal, Spacing observed-px precede, Elevation no-reusable-panel, Font licence-boundary, Type-role size-local pairs, Build-your-own surface-specific, Layout 1440×900 precede, Content voice extras에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#1c69d4` Semantic 70 허위 목적지 없음, `#ffffff` 168→169. `AUDIT_DONE fixes=18`. Post-F3 SHA-256 `4e9797e243afba2d3bb550bac4656268af58afe2ac13b52a71958351198279e2`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 bunjang F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/bunjang/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope visual-character extras / Bun UI extras, Primary tasks named jobs, Audience no-individual-personas, Distinctive reserved-CTA / Pretendard-only, capture-bound named Do’s, Avoid mix-Noto, Semantic extras / Gray-70 / partner never-reuse, Spacing tighter-on-mobile, Elevation extra philosophy, Font/Family extras, Assets photo-aesthetic, Primary Role / Card local-tuple, Layout generous-gutters precede, Content original-interpretation / voice extras / Karrot adjacent에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. homepage no-slash DESIGN 9/11, identity 13→14, favicon 196, logo-icon URL not path 63, `#c00b15` extra dest, B3 152 not Named gaps 493. `AUDIT_DONE fixes=26`. Post-F3 SHA-256 `fecb6b1792e18e985d65ea905da9ee11a74a243e5d137f03209375697b75bcb3`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `bunjang` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/bunjang/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight `1.2` 비율 보존, search `18`/`18px`와 body `normal` 비합침, button×2+input+card+badge×3+toggle 컴포넌트별 보존, Header/App-Download Top Banner YAML type 없음·발명 없음, `tokens.source: prose-derived` provenance, first-party favicon·logo-icon URL dual provenance+Assets, `#c00b15` interpolated·`focus-visible` 비승격, atmosphere fictional demographics 삭제·sidecar 라벨 없음, 무출처 커브 없음·B3 다섯 증거 종류 본문 유지, Product Card/chips kind/map 생략(C4), Secondary/Search/Heart loading·error·success 생략(C2), Primary CTA L/E/S 앱 핸드오프 의미로 not-applicable, `#d80c18` primary/error 비합침, `#4c4c4c` vs `#191919` 비합침, partner `#000000` vs Gray-900 비합침, 4px vs 6px vs 20px vs `999px` 비합침. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `1548726bd01a367066b3a8986c42fa5aa4874bf9c8978a1de742d0f534e72b0b`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `cafe24` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/cafe24/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.21/1.35/1.53/1.42/1.40/1.50/1.00 비율 보존, button×3+tab+card+input+badge×2 컴포넌트별 보존, Circular Icon Button YAML type 없음·발명 없음, `tokens.source: live-extract` provenance, Google favicon URL dual provenance+Assets identity-boundary, generic Focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개(ease-exit 템플릿 일치)는 provenance omission ledger·duration 120/220/360ms/easing 이름/`prefers-reduced-motion` 보존, Persona Card/Tag Chip/Step Badge/Circular Icon Button kind/map 생략(C4), Primary CTA loading·error·success 생략(C2), App Submit loading applicable/error·success 생략, Text Field error applicable/loading·success 생략, Selector/Nav 역할별 not-applicable, §14 9행 보존+philosophy-layer 분류, B3 다섯 증거 종류 본문 유지, `#084fff` vs `#3971ff` 비합침, `#1c1c1c` vs `#1b1e26` vs `#000000` 비합침, `9999px` vs `100%` 비합침. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `374370ea8f8a3378543d3ce5d9a12cbeeb23f4579168c9eecd374ff2ae513e12`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.

- 갱신: 2026-08-24 · T2 brandi F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/brandi/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope contract-coverage / atmosphere extras / desktop-bound extras / not-authority-for-origin, Distinctive extra unmerges, official-principles + named Do’s, Avoid named Don’ts + last-bullet, Semantic extra list characterizations, Shape unlisted-control + trailing restatement, Elevation limiter-precedes, Family trailing Don’ts, Type-role shared-13px, Assets Pretendard-declared-only, field-note yaml-type-not-invented, Layout omitted-layout / no-mobile extras에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#1e1e1e` Principles 50, homepage/product URL dual dest, Newnex 19/293, `18px 4px` 185 not 184, listbox radius 106 not 107, `#ff204b` Avoid 62, option no-hover Named gaps 335. `AUDIT_DONE fixes=24`. Post-F3 SHA-256 `f0d0ff42822760644aa7f4c2587ce7cd2e6185be6d68e0cbd911a7fa952d0d4c`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `buzzvil` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/buzzvil/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight `1.19`/`1.31`/`1.50` 비율 보존, button×5+tab×2+card×2 컴포넌트별 보존, Header/Navigation band YAML type 없음·발명 없음, `tokens.source: live-extract` provenance, favicon URL dual provenance+Assets, generic Focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개(ease-exit 템플릿 일치)는 provenance omission ledger·duration 120ms/200ms/320ms/easing 이름/`prefers-reduced-motion` 보존, Feature/Stat Card·Dark Slate Card kind/map 생략(C4), Contact/Ghost loading·error·success 생략(C2), Ad-Center/Language Toggle/Secondary/Top Nav/Filter 역할별 not-applicable, §14 9행 보존+philosophy-layer 분류, B3 다섯 증거 종류 본문 유지, `#f44336` vs `#000000`/`#f2f5f7` 비합침, `#0e171f` vs `#000000` 비합침, 4px vs 8px vs 16px vs 32px vs 9999px 비합침, §9 sticky-nav right-aligned + dark-hero subhead `#f2f5f7` + stat-card number/label tuple 로컬 보존. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `be62c8d441a094c999580124618cd39e6a52e6115912e44694ce8194f903ba32`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `brandi` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/brandi/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight `1.0` 비율 보존, `type: badge` 컴포넌트별 보존, Direct/Partner/Option YAML type 없음·발명 없음, `tokens.source: reconciled` provenance, Google favicon URL provenance-only + Assets URL-free identity-boundary, generic Focus 없음/`focus-visible` 비승격, §13 FILL IN·가상 persona sidecar 없음, 무출처 커브 없음·B3 다섯 증거 종류 본문 유지, Product option listbox/Product detail badge kind/map 생략(C4), Direct/Partner/Option loading·error·success 생략(C2), §14 expanded/listbox·disabled 보존, `#1e1e1e` vs `#00c73c`/`#ff365d` 비합침, `#ffffff` canvas vs on-action 비합침, `#e6e6e6` vs `#e1e1e1` 비합침, 6px vs `0px 0px 6px 6px` 비합침. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `c850a8f7b72fd7e631a09e9d03f29815675a69e2cfa15644a7688574d617a3bc`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `bmw` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/bmw/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight `1.43`/`1.56`/`1.6`/`1.5` 비율 보존, YAML components `{}`·Type 발명 없음, `tokens.source: live-extract` provenance, Simple Icons slug dual provenance+Assets identity-only, generic Focus 없음/`focus-visible` 비승격, §13 source-backed groups는 Audience만·sidecar biography 없음, 무출처 커브 없음·B3 다섯 증거 종류 본문 유지, Inputs/cards/badges/dialogs/chatbot/menu panels kind/map 생략(C4), Home primary/outline loading·error·success 생략(C2), flyout 역할별 not-applicable, §14 collector-zero 보존, B3 다섯 증거 종류 본문 유지, `#1c69d4` vs generic blue 비합침, `#414141` vs `#262626` 비합침, on-dark `#ffffff` vs CTA on-fill `#ffffff` 비합침, `#666666` vs foregrounds 비합침. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `2fb9aaf6e262e70b857dcfd2958609475c6e580f2777e81c506a3545c9502e6c`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 11 sol bito 최종 확인 = **PASS**. 정본 `docs/reviews/t2-1-wave11-2026-08-24-sol-final.md`(한 줄 `PASS`). `sol-recheck.md`의 bito 조건 4만 재대조했고 새 기준 없음. bito 패킷에서 삭제 대상 네 persona-derived label literal이 0건이며 `provenance.md:95`는 generic deletion disposition만 남아 `:153,168` 및 `migration-log.md:65`와 일치.
- 갱신: 2026-08-24 · T2-1 웨이브 11 grok-4.6 bito final resubmit = **원장 개정 1/1, 의미 재심 대기**. 워커 grok-4.6. 정본 `docs/reviews/t2-1-wave11-2026-08-24-sol-recheck.md` bito 조건 4. `provenance.md:95` superseded 주석을 generic deletion으로 교체 (`four derived audience labels removed; not re-hosted`). 같은 패킷 `migration-log.md:33` / `audit-log.md:128` supersede 주석도 라벨 재수록 제거. `provenance.md:153,168` 및 `migration-log.md:65` absent/deleted 현행과 일치. DESIGN.md 미변경 SHA `c0be520beb698a941cfb7a737c9a85297937477533b5fa23579d27391e2dc9f5`. `Revision 2026-08-24 (wave11 final resubmit)`. 새 F3 없음. 동일 sol 목록-only 재심 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 11 sol 집중 재심 = **전체 FAIL (PASS 4/5, FAIL 1/5)**. 정본 `docs/reviews/t2-1-wave11-2026-08-24-sol-recheck.md`. 선행 `sol-full.md`의 재제출 조건만 대조했고 새 기준·새 F3 없음. bbc/beusable/bigin/bithumb PASS. bito는 `provenance.md:95`가 삭제 대상 persona-derived label 네 개를 superseded 주석에서 재수록해 같은 파일 `:153,168` 및 `migration-log.md:65`의 absent/deleted 현행 주장과 충돌하므로 조건 4·6 FAIL. 5/5 `--gate-only` PASS/problems `[]`, Core exit 0/`portable_core:true`; current SHA는 각 migration log와 일치. bito provenance를 generic deletion disposition만 남도록 고친 뒤 동일 sol 목록-only 재제출 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 11 grok-4.6 sol 재제출 = **본문+원장 개정 5/5, 의미 재심 대기**. 워커 grok-4.6. 규칙집 v7. 고정 목록만 반영, 새 F3 없음. `docs/design-md-weight/migrated/{bbc,beusable,bigin,bithumb,bito}/` DESIGN + provenance + migration-log(`Revision 2026-08-24 (wave11 sol resubmit)`) + audit-log. bbc: Surface Content full-width `#f6f6f6`+inside heading `20px/700/#202224` local; Reith optical sizing/open-letterform/device-vision; FontFaceSet→getComputedStyle/curl/CDN; first-party imagery 삭제. SHA `7bb424c7ec1da36845b7501e6196f7752e89d2c6144bc8d29ff917476ab220c9`. beusable: provenance RGB `rgb(236,0,71)`/`rgb(246,225,54)`; Observed에서 `왜인지 알아보기`/`직접 물어보기` 제거; D2 segment label 삭제; independently verified 축소; light-nav right-aligned + §11 hesitate/scroll/click/drop-off 복원. SHA `a323c0063d58dfdfc04d77ed549068032b23d63ec00e7c3bf3f90b7b9497e645`. bigin: White Feature Card/Tinted Section child tuples + nav right-aligned CTA; Nav Link Background 분리; `.verification.md` Proof 연결; D2 삭제; Distinctive/state/motion B2a 목록·표 앞 인접. SHA `cff360f291eb360e45ef92fcfb8f3054c003f41b2e76688623bf832c92eaf5f7`. bithumb: `.verification.md` Proof 연결; D1 negatives 삭제; Distinctive/state B2a 앞 인접. SHA `7828fca1af6a9395bfaf1c28c9f8cb6efee86e8ff50901d440efc692a48f69ad`. bito: contact-footer `#e74118` parent+white 16px local recipe; Observed에서 Typography/TAIWAN Tourism 제거; D1 font negatives·first-party craft 삭제; D2 삭제; Golden Horse title-sequence/multiple-edition/premier-awards 복원; Footer Verified provenance 41, Tier-2 81–82. SHA `c0be520beb698a941cfb7a737c9a85297937477533b5fa23579d27391e2dc9f5`. 5/5 `--gate-only` PASS/`portable_core: true`. 원장 dest 전수 재grep. sol 재심 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 11 sol 첫 전수 판정 = **FAIL 5/5, PASS 0/5**. 정본 `docs/reviews/t2-1-wave11-2026-08-24-sol-full.md`. bbc/beusable/bigin/bithumb/bito 모두 `--gate-only` PASS/problems `[]`, Core exit 0/`portable_core:true`, 기존 fresh F3·current SHA 일치이나 의미 결함이 남음. 주요 차단점은 §9 local tuple/field binding, narrative·proof metadata 손실/발명, derived→Observed·FontFaceSet evidence-kind 승격, unsupported font/asset negative, fictional persona segment 재수록, B2a trailing/remote 한정, 원장 disposition·목적지 오류. 동일 sol 고정 목록-only 재제출 대기이며 새 F3는 요구하지 않음. 5/5 PASS 전 웨이브 완료·카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 beusable F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/beusable/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope atmosphere/two-voice/pill/public-history/refusal extra, Audience segment labels, Distinctive limiter-precedes-list, capture-bound named Do’s, Avoid last-bullet, Semantic extra unmerged, Spacing tight-inner-nav, Elevation table Use precede / soft-wide-negative-spread, Motion Arriving-Dismissals-Two-way, Font fallbacks, Type-role tracking-unmerged, Type-rule extras, Capture graph-not-adopted / characterizations-before-table, Get Started/Sign In/Heatmap extra unmerges, Top Nav/Feature Dropdown Observed captured-variant, Layout recorded-span precede, Content voice extras에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#ec0047` hover 허위 목적지 없음, `9,000` Layout 허위 목적지 없음, HTML-comment rgb 비이중. `AUDIT_DONE fixes=32`. Post-F3 SHA-256 `168cb79a888dad1e156b336c22c9c9d627390d0b50b317e9c20e3b9cf619d175`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 bbc F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/bbc/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope live-inspect-not-merged / GEL extra / commercial-media extra, Distinctive SVG-reds / Focus-not-copied, Semantic Dark-Nav-fill / contrast-proof, Motion spec-template / fully-functional, Font extra evidence-class, Type GEL 236 완전 B2a, Capture extra characterizations, Search font-size-not-invented, Skip/Nav post-table, Toggle not-invented, Dark Nav type-not-invented, Layout collapsing/touch, Content voice extras에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. token-note Foundations 허위 목적지, GEL URL Font 206 허위, Toggle C2 433→435, `#D30000` 다중 목적지 교정. `AUDIT_DONE fixes=28`. Post-F3 SHA-256 `32f0d007a9249a13d3b46c3d559a13b76b6f8925eea340779afe85078c299b27`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 bigin F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/bigin/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope evidence-domain named readings / atmosphere extras, Audience no-individual-personas, Avoid last-bullet, Semantic extras / Connect Chip glow, Elevation table Use, Motion easing Use / reduce-motion, field-note unmerges, Nav captured-variant, Layout collapsing adjacent, Content voice extras에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#006fff` Content Observed 허위 목적지 없음. `AUDIT_DONE fixes=40`. Post-F3 SHA-256 `2d8ca6cc44201d2aa79af7ca0a768cf1d28da315e0ba287df15729c6344fa47f`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 bito F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/bito/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope evidence-domain extras / atmosphere retarget / craft-first extras, Audience named-groups, capture-bound named Do’s, Avoid named Don’ts + last-bullet, Semantic extra characterizations, Shape not-universal, Elevation table Use precede / extra philosophy, Motion duration-easing Use / omitted-curves, Font/Family/Type-rule extras, Capture extra characterizations, Tag Chip §14-disabled, Layout extras, Content voice extras에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#f92c16` Principles 61, homepage Primary tasks/Content, 滿滿大平台 Scope 9, nav 문자열 not Primary tasks, “the entire image is interactive” 246 not Layout 433. `AUDIT_DONE fixes=26`. Post-F3 SHA-256 `fa46a892ac43a9a2a45fdbbf41c287397ee65570f617c8a0541c261cf392822f`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 beusable F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/beusable/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope atmosphere/two-voice/pill/public-history/refusal extra, Audience segment labels, Distinctive limiter-precedes-list, capture-bound named Do’s, Avoid last-bullet, Semantic extra unmerged, Spacing tight-inner-nav, Elevation table Use precede / soft-wide-negative-spread, Motion Arriving-Dismissals-Two-way, Font fallbacks, Type-role tracking-unmerged, Type-rule extras, Capture graph-not-adopted / characterizations-before-table, Get Started/Sign In/Heatmap extra unmerges, Top Nav/Feature Dropdown Observed captured-variant, Layout recorded-span precede, Content voice extras에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#ec0047` hover 허위 목적지 없음, `9,000` Layout 허위 목적지 없음, HTML-comment rgb 비이중. `AUDIT_DONE fixes=32`. Post-F3 SHA-256 `168cb79a888dad1e156b336c22c9c9d627390d0b50b317e9c20e3b9cf619d175`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.

- 갱신: 2026-08-24 · T2 워커 `beusable` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/beusable/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight `1.00`/`1.31`/`1.40`/`1.50` 비율 보존, button×4+badge×2+card+listItem 컴포넌트별 보존, White Feature Card/Top Nav YAML type 없음·발명 없음, `tokens.source: live-extract` provenance, first-party favicon dual provenance+Assets, generic Focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개(ease-exit 템플릿 일치)는 provenance omission ledger·duration/easing 이름/`prefers-reduced-motion` 보존, Filter Tag/Heatmap Data Marker/Cyan-Tinted Card/White Feature Card kind/map 생략(C4), Get Started/Sign In/Hero Glass/Floating Back loading·error·success 생략(C2), Top Nav/Feature Dropdown 역할별 not-applicable, §14 9행 보존+philosophy-layer 분류, B3 다섯 증거 종류 본문 유지, `#ec0047` vs `#ff1553`/`#00b7ff` 비합침, 4px vs 5px vs 20px vs 21px vs 9999px 비합침. F1·F2 수행. `--gate-only` PASS/problems 0; Core `portable_core: true`. SHA-256 `2d08271c37cd20f0371bcc0f74e4dda83096e43bad417c564e287bbb96c1293e`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `bbc` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/bbc/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.25/1.50/1.00 비율 보존, button×3+input+tab+card×2+badge+toggle 컴포넌트별 보존, `tokens.source: live-extract` provenance-only, Google favicon URL provenance-only + Assets URL-free identity-boundary, generic Focus `2px solid #000000`를 focus-visible로 비승격, §13 fictional archetypes 삭제·sidecar 없음·`360px` provenance-only, 무출처 cubic-bezier 3개(템플릿 일치)는 provenance omission ledger·duration 0/100/200/300ms/easing 이름/`prefers-reduced-motion` 보존, Article Teaser/Surface/Dark Nav/LIVE kind/map 생략(C4), Register/Sign In/Toggle loading·error·success 생략(C2), Search error applicable/loading·success 생략, Skip/Nav 역할별 not-applicable, §14 11행 보존+philosophy-layer 분류, B3 다섯 증거 종류 본문 유지, `#000000` vs `#202224`/`#3a3c3e`/`rgb(20,22,24)` 비합침, `#bb1919` vs `#b80000`/`#eb0000`/`#D30000` 비합침. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `68f59a0fcf0b14c48cea54634eaec82882d591435ed78697944b720d2e30d234`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `bigin` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/bigin/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.3/1.4/1.5 비율 보존, button×3+tab+card×4+badge+listItem 컴포넌트별 보존, `tokens.source: live-extract` provenance, first-party favicon URL dual provenance+Assets identity-boundary (Named-gaps URL 없음), Input Focus `#006fff`를 focus-visible로 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개(ease-exit 템플릿 일치)는 provenance omission ledger·duration 120ms/220ms/320ms/easing 이름/`prefers-reduced-motion` 보존, Feature/Tinted/Accent/Mint Card·Eyebrow·Footer kind/map 생략(C4), Primary/Lift/Connect loading·error·success 생략(C2), Form Input error applicable/loading·success 생략, Nav/Inline Link 역할별 not-applicable, §14 9행 보존+philosophy-layer 분류, B3 다섯 증거 종류 본문 유지, `#006fff` vs `#0066cc` 비합침, `rgba(0,104,255,0.4)` vs `rgba(0,111,255,0.4)` 비합침. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `5c501a61223069c85a0c40cad21f0c1fd4702c58a5e810d4a4a9a087b2ac3683`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 bithumb F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/bithumb/audit-log.md`. 토큰·표·applicability·구조 미변경. Primary tasks YAML-use-not-§13, Audience no-individual-personas, Distinctive extra unmerges, Principles stems, capture-bound named Do’s, Avoid named Don’ts + last-bullet, Semantic extra characterizations, Spacing unitless-YAML, Shape limiter-precedes-list, Elevation extra philosophy, Motion not-promoted-absence / character extras, Font/Family extras, field-note unmerges, Layout not-cross-viewport, Content voice extras에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#1C2028` Avoid 허위 목적지 없음. `AUDIT_DONE fixes=24`. Post-F3 SHA-256 `5e0a99b3c2a40325729a971dd368c26c9bed52a8821df916361e40422357131c`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `bithumb` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/bithumb/{DESIGN.md,provenance.md,migration-log.md}`. YAML lineHeight 없음·비율 발명 없음, button×3+badge×2 컴포넌트별 보존, YAML spacing 4/8/16/24/32/48/64 숫자 보존(px 접미사 비발명), `rounded.full` 9999 px 접미사 비발명, `tokens.source: prose-derived` dual Font evidence+provenance, Google favicon URL dual provenance+Assets identity-boundary (first-party-mark Named-gaps 없음), generic Focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 커브 없음·B3 다섯 증거 종류 본문 유지, Filter Chip active/inactive kind/map 생략(C4), Signup/Filled CTA/Outline CTA loading·error·success 생략(C2), §14 6행 보존, `#1C2028` vs `#543E35` 비합침, `#FFFFFF` vs `#F8F9FA` 비합침, `#B6ABA1` vs `rgba(28,32,40,0.1)` 비합침. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `7f99e6a6818896bcc945776626605949d6890ea63f64c9dc90a71108c67af71d`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 bito F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/bito/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope evidence-domain extras / atmosphere retarget / craft-first extras, Audience named-groups, capture-bound named Do’s, Avoid named Don’ts + last-bullet, Semantic extra characterizations, Shape not-universal, Elevation table Use precede / extra philosophy, Motion duration-easing Use / omitted-curves, Font/Family/Type-rule extras, Capture extra characterizations, Tag Chip §14-disabled, Layout extras, Content voice extras에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#f92c16` Principles 61, homepage Primary tasks/Content, 滿滿大平台 Scope 9, nav 문자열 not Primary tasks, “the entire image is interactive” 246 not Layout 433. `AUDIT_DONE fixes=26`. Post-F3 SHA-256 `fa46a892ac43a9a2a45fdbbf41c287397ee65570f617c8a0541c261cf392822f`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `bito` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/bito/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.50/1.20 비율 보존, tab×2+card×2+badge×2+listItem 컴포넌트별 보존, `tokens.source: live-extract` provenance, Google favicon URL provenance-only + Assets URL-free identity-boundary, generic Focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개(ease-exit 템플릿 일치)는 provenance omission ledger·duration 120ms/240ms/400ms/easing 이름/`prefers-reduced-motion` 보존, Filter Label kind/map 생략(C4), Warm/Dark Project Tile loading·error applicable(§14 Work grid/media)·success 생략(C2), Top Nav/Language Toggle/Tag Chip/Footer Link 역할별 not-applicable, §14 9행 보존+philosophy-layer 분류, B3 다섯 증거 종류 본문 유지, `#f92c16` vs `#ff5529`/`#e74118`/`#ff2700` 비합침, Canvas `#ffffff` vs `on-accent` `#ffffff` 비합침, Ink `#000000` vs Dark Tile fill `#000000` 비합침. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `b26008e2d502315d72c584faffb84d69dc8b4ae780d37589f052935fd22ff203`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 10 최종 확인 2차 (sol) = **전체 PASS, 잔여 2/2 반영**. 정본 `docs/reviews/t2-1-wave10-2026-08-24-sol-final2.md`. 기존 `sol-final.md`의 두 잔여 조건만 재대조했고 새 기준 없음. banksalad는 canonical current §5 density/section-rhythm/4px·8px·10–12px·30–41px·50% radius 역할이 portable 본문과 current 원장에 복원됨. barogo는 active `migration-log.md:35,43`의 component/Content 목적지가 실제 current DESIGN 행으로 동기화되고 종전 목적지가 supersede됨. 기존 3건 PASS와 합쳐 웨이브 10 PASS 5/5.
- 갱신: 2026-08-24 · T2-1 웨이브 10 잔여 2건 개정 (grok-4.6) = **본문+원장 반영, 동일 sol 목록-only 재제출 대기**. 워커 grok-4.6. 정본 `docs/reviews/t2-1-wave10-2026-08-24-sol-final.md` banksalad·barogo. 새 F3 없음. banksalad: canonical current §5 density-as-brand / `#ffffff`/`#fbfbfb` section-rhythm / 4px·8px·10–12px·30–41px·50% radius 역할을 portable Shape 117–123·Layout 313–324에 복원. 2px default는 계속 reverted. provenance omission remainder 해제. SHA `4d3d3134dcd174c53caeea508d12361af0bb822f6c75e9c5dfbe2b2150f65a01`. barogo: DESIGN 미변경 SHA `2ed442e9653a78c2cb695abbc0fec1c140eaf4c46d562fe073831b54e3dc82ae`. `migration-log.md:35,43` component/Content 목적지를 `DESIGN.md:224,226,253,280,352,360-362,364,386,395,402,428,435,443,447,497-498`에 맞춤. 각 `migration-log.md`에 `Revision 2026-08-24 (wave10 final resubmit)`. `--gate-only` PASS 2/2, Core `portable_core: true` 2/2. 5/5 PASS 전 웨이브 완료·카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 10 최종 확인 (sol) = **전체 FAIL, PASS 3/5**. 정본 `docs/reviews/t2-1-wave10-2026-08-24-sol-final.md`. `sol-recheck.md`의 잔여 5조건만 재대조했고 새 기준·새 F3 없음. autopedia/aws-cloudscape/bahamut PASS. banksalad는 canonical current §5 density/section-rhythm/radius 역할을 portable 본문에 복원하지 않고 omission remainder로 남겨 FAIL. barogo는 negative와 `#fa5014`는 정리됐지만 supersede되지 않은 `migration-log.md:35,43`의 component/Content 과거 목적지가 남아 FAIL. 5/5 PASS 전 웨이브 완료·카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 10 원장 동기화 (grok-4.6) = **본문 미변경, 동일 sol 목록-only 재제출 대기**. 워커 grok-4.6. 정본 잔여 `docs/reviews/t2-1-wave10-2026-08-24-sol-recheck.md`. 새 F3 없음. `migrated/{autopedia,aws-cloudscape,bahamut,banksalad,barogo}/` provenance·migration-log·audit current-class만 맞춤. autopedia: color/font D1 inventory supersede + `#7A00FF`/`#E5E7EB` F2 dest grep. aws-cloudscape: `direct, instructional` 220 / first-party 218 + YAML-identity first-party-mark row supersede. bahamut: Avoid §9 command / font-negative inventory 정정 + nav `#ffffff`/44px → 297. banksalad: wholesale §5–§9 snapshot 분류 해제, Content 327/334/336, `#fbfbfb`/50%는 portable 본문 부재로 omission remainder. barogo: `live-surface-labels-not-captured-product-UI` / `no-additional-family-promoted` 삭제 + `#fa5014` dest 210/234/244/262–263/271. 각 `migration-log.md`에 `Revision 2026-08-24 (wave10 ledger sync)`. DESIGN SHA 불변: autopedia `a5119fef…111e808`, aws `1ea6c61d…58cb2e51`, bahamut `4143c052…69a5c088`, banksalad `4757acf4…e1f70e2df76`, barogo `2ed442e9…3dc82ae`. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 10 동일 sol 목록-only 집중 재심 = **전체 FAIL, PASS 0/5**. 정본 `docs/reviews/t2-1-wave10-2026-08-24-sol-recheck.md`. 새 기준·새 F3 실행/요구 없음. 다섯 건 모두 `--gate-only` PASS/problems 0, Core exit 0/`portable_core:true`, revision SHA 일치. autopedia는 active color/font negative와 value-level F2, aws-cloudscape는 voice F1/first-party-mark row, bahamut는 §9/font inventory와 line map, banksalad는 미복원 §5 density/section-rhythm/radius와 wholesale-superseded 원장, barogo는 product/font negative inventory와 source-row/F2 목적지가 남음. 5/5 PASS 전 웨이브 완료·카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 10 개정 (grok-4.6) = **본문 반영, 동일 sol 목록-only 재확인 대기**. 정본 조건 `docs/reviews/t2-1-wave10-2026-08-24-sol-full.md`. 새 F3 없음. `migrated/{autopedia,aws-cloudscape,bahamut,banksalad,barogo}/` DESIGN·provenance·migration-log·audit current-class. autopedia Hero `Background: transparent` + 사업선 역할 + Hero L/E/S 생략 + color/font/persona-segmentation negative 삭제 SHA `a5119fef183accdfac1c6bac4e25a39905fcd9229dde8a2a83a97f9fb111e808`; aws-cloudscape Core sentinel 제거 + 역할 작업 복원 + instructional B2a + first-party-mark gap 삭제 SHA `1ea6c61dacbd938828b6875823d64f1669803903fdf785b4b18f152758cb2e51`; bahamut §9 prompt Avoid 삭제 + §11 nascent/organic/legal-largest + imagery/font/persona negatives SHA `4143c052a73be9f2c728909c4864080d7202772efd2c24e1db20478569a5c088`; banksalad Core `Captured scope unresolved` + Principles 전체 B2a + task/label 분리 + §5/§8 current 복원 SHA `4757acf459472b55051bd5be80551613f1643be9bd74d63d25dcce1f70e2df76`; barogo Hero pair/Feature Card tuple + parent fill 분리 + §11 rails + Observed 바로레터 제거 + persona 0 hit SHA `2ed442e9653a78c2cb695abbc0fec1c140eaf4c46d562fe073831b54e3dc82ae`. 각 `migration-log.md`에 `Revision 2026-08-24 (wave10 sol resubmit)`. 다섯 건 `--gate-only` PASS/problems 0, Core `portable_core: true`. 5/5 PASS 전 웨이브 완료·카탈로그 채택 금지.
- 갱신: 2026-08-24 · T2-1 웨이브 10 sol 전수 첫 판정 = **FAIL 5/5**. 정본 `docs/reviews/t2-1-wave10-2026-08-24-sol-full.md`. autopedia(§9-only Hero field·사업선 관계·CTA state·color/font/persona negatives), aws-cloudscape(Core scope/placeholder·역할 손실·derived authority·favicon negative·§9 disposition), bahamut(§9 prompt 잔존·font/imagery/persona negatives·§11 손실), banksalad(Core placeholder·Principles authority·task/route 결합·wholesale stale demotion), barogo(§9 tuple·parent/item field 병합·§11 손실·Observed 승격·fictional persona) 모두 목록 개정 대상. 당시 파일 직접 재실행 `--gate-only` PASS 5/5; Core는 autopedia/bahamut/barogo PASS, aws-cloudscape/banksalad FAIL; 기존 fresh F3와 post-F3 SHA는 5/5 일치. 동일 sol 목록-only 재확인, 새 F3 불필요. 5/5 PASS 전 웨이브 완료·카탈로그 채택 금지.
- 갱신: 2026-08-24 · T2 autopedia F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/autopedia/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope atmosphere extra, Avoid named Don’ts + last-bullet, Semantic scrim/hairline extra, Shape limiter-precedes-list, Elevation table Use / contrast-not-elevation, Motion philosophy-layer / stays-fully-functional, Font/Family extra, Type-role stay-open, Capture extra characterizations, field-note extra unmerges, Layout tappable/collapsing/image-behavior, Content voice extras에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. Medium URL / Google favicon URL / `contact@` provenance-only. `#7A00FF` Avoid 허위 목적지 없음. 워커가 생략한 `provenance.md`와 `migration-log.md`를 grep으로 작성. `AUDIT_DONE fixes=29`. Post-F3 SHA-256 `157f4ea8f769f4e77580ea599a0a2cbafa3418f679a790ac45de5b1c32419993`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 bahamut F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/bahamut/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope atmosphere extra / public-history extra / refuses-embraces extra, Avoid last-bullet §9, Semantic more-legible / just-off-white, Shape local-not-universal, Elevation nav-contrast / 1px-3px, Motion latency-perception, Font evidence-class extra, Type-role not-converted / 12px-16px unmerge, field-note extra unmerges, Layout 1200px-as-surface-measurements, Content heading-sample / voice extras에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#11aac1` Sidenav 328 not-fill, homepage/forum Primary tasks 33/35, compact rgb vs rgba dual, B3 164. 워커가 생략한 `migration-log.md`를 grep으로 작성. `AUDIT_DONE fixes=33`. Post-F3 SHA-256 `7d8f981bff17cd82534a6a5e5fb5d62ad1970c1dbdcff5449f78bc1ffa5bbf9b`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 barogo F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/barogo/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope atmosphere extra / Korean-utilitarian extra / barely-there / scale-as-public-fact, Audience no-individual-personas, Distinctive extra unmerged, Avoid named Don’ts, Semantic extra characterizations, Spacing unitless-YAML, Shape limiter-precedes-list, Elevation table Use / trailing-0px / extra philosophy, Motion spec-template / nintendo-workday / omitted-curves, Font/Family extra, Type-rule not-softened-navy, Capture graph-not-adopted / extra characterizations, field-note named unmerges, Layout singular inference / near-flat image-behavior, Content voice extra names에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#fa5014` Avoid 허위 목적지 없음으로 고정, homepage/aboutUs 경로 분리, `3.008px`/434/`rgb(250,80,20)` 목적지 확장. 워커가 생략한 `migration-log.md`를 grep으로 작성. `AUDIT_DONE fixes=33`. Post-F3 SHA-256 `c5e7151ab57e537d54d5bf5f8eb8bcfa204a043090baa09d1d18cfb14516489e`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 banksalad F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/banksalad/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope BPL-not-current-tokens / evidence-domain 네 비대리 / most-repeated-accent / two-evidence-layer extra, Audience names-ages-not-Audience, Distinctive recurring-spacing / unpromoted-inputs, capture-bound named rules, Avoid Don’ts + last-bullet, Semantic extra unmerged / omitted-rather-than-mapped, Spacing/Shape/Elevation names, Font evidence-class retarget, Capture graph-not-adopted, Loan Action field-note, Disclosure accordion, Layout desktop-not-cross-viewport, Content factual-Korean voice에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. `#13bd7e` Avoid 허위 목적지 교정. 워커가 생략한 `migration-log.md`를 grep으로 작성. `AUDIT_DONE fixes=24`. Post-F3 SHA-256 `7ec306d2d0e77b6dde4a1dfdec90c5f5bf54f56d61334a8de3d07d4b5e8cd47f`, `--gate-only` PASS. Core `portable_core: false` (Font 표 셀 `Unresolved`) — 표는 B2a 한정 밖이라 미개서, true로 주장하지 않음 (E2c). sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 aws-cloudscape F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/aws-cloudscape/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope not-same-surface / token-note, Audience no-individual-personas, Principles stems-paraphrase, Do/Don’t named items + last-bullet, Semantic extra roles, Spacing public-route-rhythm, Elevation use-none-only, Font extra evidence-class, Family font-use, Layout 204/206/210, Content 217/225에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. 워커가 생략한 `migration-log.md`를 grep으로 작성. `#295eff`/homepage/surface-kind/official-doc URL 이중 목적지 교정. `AUDIT_DONE fixes=23`. Post-F3 SHA-256 `80a655126a17d382c18a2d0216390c7be0f04c2fd90ca0b16d38fe84496cb58d`, `--gate-only` PASS. Core `portable_core: false` (scope 원문 “does not treat an AWS authenticated product…” + Font 표 셀 `Unresolved`) — 표·원문 부정은 B2a 한정 밖이라 미개서, true로 주장하지 않음 (E2c). sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 9 최종 확인 (asana·asleep·asos·au) = **전체 PASS, 잔여 원장 포인터 조건 4/4 반영**. 정본 `docs/reviews/t2-1-wave9-2026-08-24-sol-final.md`. `sol-recheck.md`의 네 잔여 조건만 재대조했고 새 기준 없음. asana prompt-only Nav/복원 tuple 절 분리, asleep 목적지 283/306, asos C2/C4 목적지 641/642, au B2a 목적지 341/352 모두 current actual과 일치. 기존 appier PASS와 합쳐 웨이브 9는 PASS 5/5.
- 갱신: 2026-08-24 · T2-1 웨이브 9 개정 3차 (asana·asleep·asos·au 원장 동기화) = **본문 미변경, 동일 sol 목록-only 재제출 대기**. 워커 grok-4.6. 정본 잔여 `docs/reviews/t2-1-wave9-2026-08-24-sol-recheck.md`. 새 F3 없음. asana: `Omitted prompt-only values`는 Nav `8px 24px`만 유지하고 복원 tuple 3개는 `Restored §9-only component tuples`로 분리. asleep: derived inventory field-note 목적지 282→283, 305→306. asos: `migration-log.md:36` Named-gaps C2/C4 639/641→641/642. au: derived inventory Do/Don’t B2a 339→341, no-synthetic 350→352. 각 `migration-log.md`에 `Revision 2026-08-24 (wave9 ledger sync)`. DESIGN SHA 불변: asana `cfabe335…1be951f`, asleep `f9c6eaa5…0bb233`, asos `7fa00a2f…58fc218`, au `dc98ae41…954f90`. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 9 동일 sol 목록-only 집중 재심 = **전체 FAIL, PASS 1/5, 선행 재제출 조건 18/23**. 정본 `docs/reviews/t2-1-wave9-2026-08-24-sol-recheck.md`. 새 기준·새 F3 실행/요구 없음. appier 4/4 PASS. asana 4/6 FAIL: `provenance.md:104`의 active `Omitted prompt-only values` 제목이 복원 tuple 109–111을 계속 포괄해 §9 disposition/원장 미동기화. asleep 3/4 FAIL: `provenance.md:184-185` field-note 목적지 282/305가 실제 283/306보다 1행씩 stale. asos 3/4 FAIL: `migration-log.md:36` Named-gaps C2/C4 목적지 639/641이 실제 641/642와 불일치. au 4/5 FAIL: `provenance.md:208-209` Do/Don’t/no-synthetic B2a 목적지 339/350이 실제 341/352와 불일치. 현재 파일 직접 재실행 `--gate-only` PASS 5/5, Core exit 0 / `portable_core:true` 5/5; SHA는 각 wave9 revision과 일치. 네 원장 잔여를 닫기 전 웨이브 완료·카탈로그 채택 금지.
- 갱신: 2026-08-24 · T2-1 웨이브 9 개정 (grok-4.6) = **본문 반영, 동일 sol 목록-only 재확인 대기**. 정본 조건 `docs/reviews/t2-1-wave9-2026-08-24-sol-full.md`. 새 F3 없음. `migrated/{appier,asana,asleep,asos,au}/` DESIGN·provenance·migration-log·audit current-class. appier Avoid Don’ts 전체 B2a + Named-gap first-party-mark 삭제 SHA `6f3522756978d501470a41cf36b0dd5844f950a1727e3ff62f973ddfa162128e`; asana §9 tuple·Ghost Refero·Observed 세 string·D1 font/microcopy 삭제·Audience stakeholder 비재승격·§11 관계 SHA `cfabe335a9f5c6c2b4deacdfb99ecc1a9ed30a4d9cd144dd7585e21131be951f`; asleep Outlined `transparent` + Docs Search error 생략 SHA `f9c6eaa555423dae18fdcb5801bb60dc55837b71a0d11808ce98c51eb60bb233`; asos display/nav uppercase·body mixed-case + Size Selector `Type: input` + Add to Bag L/E/S SHA `7fa00a2f82183231bf91133e0b38411889a9e31362556175ba3d0a64258fc218`; au home≠nav/search + Do/Don’t derived + reusable-copy gap 삭제 SHA `dc98ae41e1c3800965ecf3c272aa78d5baa6a13f13068b2262ac16e1fa954f90`. 각 `migration-log.md`에 `Revision 2026-08-24 (wave9 sol resubmit)`. 다섯 건 `--gate-only` PASS/problems 0, Core `portable_core: true`. 5/5 PASS 전 웨이브 완료·카탈로그 채택 금지.
- 갱신: 2026-08-24 · T2-1 웨이브 9 sol 전수 첫 판정 = **FAIL 5/5**. 정본 `docs/reviews/t2-1-wave9-2026-08-24-sol-full.md`. appier(B2a Avoid 전체·D1 first-party-mark), asana(§9 tuple·B1 evidence 승격·D1 font/microcopy·D2 segment·§11 관계), asleep(§9 `transparent`·Docs Search C2), asos(typography casing·Size Selector A1b·Add-to-Bag C2), au(mobile→home 관계·voice-table authority·D1 reusable-copy) 모두 목록 개정 대상. 당시 다섯 SHA에서 `--gate-only` PASS/problems 0, Core `portable_core: true`, 기존 fresh F3/post-F3 SHA 일치. 동일 sol 목록-only 재확인; 새 F3 불필요. 5/5 PASS 전 웨이브 완료·카탈로그 채택 금지.
- 갱신: 2026-08-24 · T2 au F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/au/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope practical/information-rich / highly-visible-orange-action-lane, Scope organise / retain-domains / canonical-token-set, Audience no-individual-personas, Distinctive not-promoted-states, Avoid last-bullet §9, Semantic extra unmerged, Foundations Link, Elevation flat-separation, Font extra evidence-class, field-note extra unmerges, Layout 5px-bordered-cards / intentionally-absent에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. 로그 Avoid 74 `#EB5505` 허위 목적지, `#0066AA` Scope 19/Distinctive 41 과장, tab 269/287, Layout 326, Elevation 113, `"8"` Type-roles, F1/F2 준수 과장 교정. `AUDIT_DONE fixes=43`. Post-F3 SHA-256 `28a67dff8b79141ee7842ceb9d3d59982eac65e3ee637275b8a4956899af0e0a`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 asos F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/asos/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope atmosphere extra names / neutral-monochrome-frame, Audience no-individual-personas, Avoid completing-purchase-signal, Spacing harvested-control-padding, Shape limiter-precedes-list / Zero-Pill-Full, Elevation extra names, Motion spec-template / fully-navigable, Font alternate-not-second-identity, Type-role omitted-tracking, Capture-record extra characterizations, Gender Nav hover-name-not-copied / unmerged-field, Layout commerce-first / whitespace / tints에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. 로그 `#2d2d2d` Avoid 허위 목적지, `#018849`/`#ccff00`/`#d01345` Foundations 95 허위, F1/F2 준수 과장 교정. `AUDIT_DONE fixes=31`. Post-F3 SHA-256 `8ea6e76dd473167fbd22d449393685e4fddb96d924bb232768c2dfa821fad3c9`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 asleep F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/asleep/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope atmosphere extra names, Shape limiter-precedes-list / None-Small-Medium-Large-Full, Elevation limiter-precedes-table, Motion spec-template vs motion-rule split, type-rule compact/legibility-bump, Docs Nav Observed captured-variant, Layout YAML-versus-body-px, Content citation-character retarget에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. 로그 `#2a75fc` Distinctive unmerged, `52px` Font evidence/capture-bound, hero string Font evidence, F1/F2 준수 과장 교정. `AUDIT_DONE fixes=30`. Post-F3 SHA-256 `6d54313a5a32835037c3787aa1ac692408bb06bcd25ea81acdf5ddc40e11c166`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 asana F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/asana/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope compressed atmosphere, Audience no-individual-personas, Distinctive fallback-declared-only, capture-bound grouping, Avoid login-6px / YAML-shadows, Semantic extra list characterizations, Spacing recorded-scale, Shape role labels, Elevation table Use, Motion extra names / omitted-curves, Font Declared-only, Family font-use, Type-role nav-body-table-only, whisper-weight-authority, Capture-record extra characterizations / hex-stays, Hero Accent/Secondary/Nav/Input/Sky Badge/Toggle field notes, Layout feature-immersion / collapsing / image-behavior, Content harvested-CTA Observed에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. 로그 `primary_color` field vs `#f06a6a` hex 목적지, F1/F2 준수 과장 교정. `AUDIT_DONE fixes=45`. Post-F3 SHA-256 `3206212379ec0319a87cced9e934513e5dd47283b3b42b83733a41962266d52e`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 appier F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/appier/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope coverage / reconstruction-authority / atmosphere extra names / thesis-product-story / product-expression extra names, Audience named readings, Distinctive extra traits, Avoid muddy-single-blue, Semantic extra characterizations / On-primary unmerged, Spacing limiter 방향, Shape limiter-precedes-list, Elevation table Use, Motion extra names, Font/type-character extra names, Type-role no-lineHeight, Capture graph-not-adopted, Industry Tab captured-variant, Layout spacing-restatement / collapsing / image-behavior, Content 41% / inventory-not-Observed에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. 로그 `#1D2EFF` 전 hex 히트, `https://www.appier.com/en` provenance-only, Observed 문자열 추가 히트, Avoid 원문 인과 인용 허위 목적지, Named gaps unlisted-surface B2a 허위, F1/F2 준수 과장 교정. `AUDIT_DONE fixes=37`. Post-F3 SHA-256 `e9ca264a63723c2738fda42fa8eaebb8e02611e32d0b734ca148fae86d99e5cf`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `au` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/au/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.4/2.5 비율 보존, button×2+input+tab+card+badge 컴포넌트별 보존, `tokens.source: reconciled` provenance, `ds.type: brand` dual Scope+provenance, Google favicon URL provenance-only + Assets URL-free identity-boundary, generic Focus 없음/`focus-visible` 비승격, §13 FILL IN provenance omission ledger·가상 persona sidecar 없음, 무출처 커브 없음, Mobile service card/Smartphone product label kind/map 생략(C4), orange/outline action·Header search loading·error·success 생략(C2), catalog tab 역할별 loading/error/success not-applicable, §14 tab-selection 1건 보존, B3 다섯 증거 종류 본문 유지, `#EB5505` action/label/underline 비합침, `#0066AA` 비브랜드, `0px` vs `5px` 비합침, Tazugane vs `noto-sans-cjk-jp` 비합침. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `9ffd4fcdc51adda42c5d6dedec5d2d0404c1a85a2a038ba09fd7f54d95595ad6`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `asos` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/asos/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.25/1.0 비율 보존, button×4+input+card×3+badge+tab×2 컴포넌트별 보존, Size Selector YAML type 없음·발명 없음, `tokens.source: live-extract` provenance, Google favicon URL provenance-only + Assets URL-free identity-boundary, generic focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개(ease-exit 템플릿 일치)는 provenance omission ledger·duration/easing 이름/`prefers-reduced-motion` 보존, Product Grid Card/Surface Section/Sale Badge/Lime Promo Banner kind/map 생략(C4), Add to Bag/Hero×2/Retry loading·error·success 생략(C2), Search error applicable/loading·success 생략, Size Selector·Gender Nav·Category Sub-Nav 역할별 not-applicable, §14 12행 보존+philosophy-layer 분류, B3 다섯 증거 종류 본문 유지, `#2d2d2d` vs `#000000`/`#525050` 비합침, 19px vs 0px vs `9999px` 비합침, 10.5px vs 14px sub-nav 비합침, §9-only 14px product name 보존(A3). F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `22f194c6e900f724cd97a97cd77386febe016fbe7137670ef8425ae1cd4dcd7c`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `asana` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/asana/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.0/1.15/1.2/1.5/1.75 비율 보존, button×6+input+card×2+badge×2+toggle 컴포넌트별 보존, YAML typography `use` 8 field, `tokens.source: live-extract` provenance, Simple Icons logo dual provenance+Assets identity-only, `#f06a6a` catalog primary = brand CSS coral (not `#fd3ffd` hero fill), generic focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개(ease-exit 템플릿 일치)는 provenance omission ledger·duration/easing 이름/`prefers-reduced-motion`/signature motions 보존, Card/Badge kind/map 생략(C4), Hero/Accent/Secondary/Nav/Pricing×2 loading·error·success 생략(C2), Default Text Field error applicable/loading·success 생략, Toggle On loading·error·success 생략, §14 11행 보존, B3 다섯 증거 종류 본문 유지, `#36a651` vs sage `#466451` 비합침, 100px vs 9999 vs 16 vs YAML card 20 vs login 6px vs Micro 4px 비합침. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `3f74cc680f99f0e095131de5f87ddc007f979816ee3b4c126d2af92b22fafc3d`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `asleep` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/asleep/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.31/1.30/1.20/1.43 비율 보존, button×2+tab+card×2+input+listItem 컴포넌트별 보존, Feature Card/Info Tint YAML type 없음·Cards/Badges heading Type 보존, `tokens.source: live-extract` provenance, Google favicon URL provenance-only + Assets URL-free identity-boundary, generic Focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개(ease-exit 템플릿 일치)는 provenance omission ledger·duration/easing 이름/`prefers-reduced-motion` 보존, Feature Card/Docs Callout/Info Tint kind/map 생략(C4), Primary/Outlined loading·error·success 생략(C2), Docs Search error applicable/loading·success 생략, Top Nav/Docs Nav 역할별 not-applicable, §14 9행 보존+philosophy-layer 분류, B3 다섯 증거 종류 본문 유지, `#2a75fc` vs `#3a61f2`/`#118cfd` 비합침. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `9ff9b1d218bc693120fd6f450824e915d048c44ac844fa48565382200e0b0e84`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.

- 갱신: 2026-08-24 · T2 워커 `appier` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/appier/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.5 비율 보존, button×2+card×2+input+badge 컴포넌트별 보존, `tokens.source: prose-derived` provenance, Google favicon URL provenance-only + Assets URL-free identity-boundary, generic Input Focus `#1D2EFF` ring을 focus-visible로 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개(ease-standard/enter/exit 템플릿 일치)는 provenance omission ledger·duration/easing 이름/`ease-in-out`/`prefers-reduced-motion` 보존, Solution/Case-Study/Dark Card·Credential·Navigation kind/map 생략(C4), Primary/Secondary/Ghost/On-dark loading·error·success 생략(C2), Input error applicable/loading·success 생략, Industry Tab 역할별 not-applicable, §14 10행 보존, B3 다섯 증거 종류 본문 유지, brief-provided `#1D2EFF` vs 근사 팔레트 비합침, YAML `#101130` vs `#0A0E27`/`#1A1A2E` 비합침. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `e599ff5c0e190a7cf94fbff36bcc4748e86608561973a5aa3ddfbe4dd0340e99`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.

- 갱신: 2026-08-24 · T2-1 웨이브 8 AmazingTalker 최종 확인 = **PASS**. 정본 `docs/reviews/t2-1-wave8-2026-08-24-sol-final.md`(한 줄 판정). 기존 재확인 조건 5(원장 동기화)만 재대조했고 새 기준 없음. `provenance.md:23`과 `migration-log.md:13`의 과거 Named-gaps first-party-mark 목적지가 명시적으로 SUPERSEDED됐으며, 현재 Named gaps 548–557·Proof 128·wave8 ledger sync revision/F2가 모두 first-party-mark row 부재 및 Google favicon URL의 Identity+Assets 목적지에 일치한다.
- 갱신: 2026-08-24 · T2-1 웨이브 8 개정 2차 (amazingtalker 원장 동기화) = **본문 미변경, 동일 sol 목록-only 재제출 대기**. 워커 grok-4.6. 정본 잔여 `docs/reviews/t2-1-wave8-2026-08-24-sol-recheck.md` amazingtalker 조건 5. 새 F3 없음. `provenance.md:23`과 `migration-log.md:13` YAML identity의 존재하지 않는 Named-gaps first-party-mark 목적지를 SUPERSEDED. 현재: Google favicon URL → Identity+Assets; Named gaps 548–557에 first-party-mark row 없음. `migration-log.md`에 `Revision 2026-08-24 (wave8 ledger sync)`. DESIGN SHA 불변 `b0c81624f62e981cbcc2de3ef69ca2a1be353be021cc9badba928c885d98cf98`. `--gate-only` PASS, Core exit 0 / `portable_core: true`. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 8 동일 sol 목록-only 집중 재심 = **전체 FAIL, PASS 3/4, 선행 재제출 조건 18/19**. 정본 `docs/reviews/t2-1-wave8-2026-08-24-sol-recheck.md`. 새 기준·새 F3 실행/요구 없음. adobe 6/6 PASS, airbridge 3/3 PASS, alipay 5/5 PASS, amazingtalker 4/5 FAIL. AmazingTalker 본문 §9 tuple·Course Card C4·§11 premise·negative 삭제와 두 기계 검사/SHA는 PASS이나, `provenance.md:23`과 `migration-log.md:13`이 존재하지 않는 first-party-mark Named-gaps 목적지를 active row로 유지해 후단 Proof/revision/F2와 충돌. 현재 파일 직접 재실행 `--gate-only` PASS 4/4, Core exit 0 / `portable_core:true` 4/4. 남은 조건은 두 원장 row 삭제 또는 명시적 supersede뿐이며 새 F3 없음. 4/4 PASS 전 웨이브 완료·카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 8 sol 목록 개정 (`adobe`, `airbridge`, `alipay`, `amazingtalker`) = **본문 반영, 동일 sol 재확인 대기**. 워커 grok-4.6. 정본 조건 `docs/reviews/t2-1-wave8-2026-08-24-sol-full.md`. 각 `migration-log.md`에 `Revision 2026-08-24 (wave8 sol resubmit)`. 새 F3 없음. `--gate-only` PASS/problems 0 및 Core `portable_core: true` 4/4. SHA-256 adobe `c2cd21a34eb38245d233144e5f4678bf02acf9600601501cf8bd06b1aae3691e`, airbridge `7f0caa9d59dd57e7c5515d80d75170407f0608120d83c1fab6e9b1e81b5ed17f`, alipay `f83d41bd12183c1077b6934289d41da8e0f2f71b81967fed32543391efd864ed`, amazingtalker `b0c81624f62e981cbcc2de3ef69ca2a1be353be021cc9badba928c885d98cf98`. 4/4 PASS 전 웨이브 완료·카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 8 sol 첫 4/4 전수 (`adobe`, `airbridge`, `alipay`, `amazingtalker`) = **FAIL 4/4, PASS 0/4**. 정본 `docs/reviews/t2-1-wave8-2026-08-24-sol-full.md`. 당시 `--gate-only` PASS/problems 0 및 Core exit 0/`portable_core:true` 4/4, 기존 신선 F3·당시 SHA 일치 4/4이나 의미 결함이 남음. Adobe는 §9 Category Tile·§11 관계·Glass/App switcher kind/type·신설 negative·원장, Airbridge는 font-domain negative, Alipay는 Scope/Distinctive B2a·logo negative·F2 line map, AmazingTalker는 §9 tuple·Course Card kind·§11 관계·신설 negative가 차단점. 동일 sol 목록-only 재제출이며 새 F3는 요구하지 않음. 4/4 PASS 전 웨이브 완료·카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 airbridge F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/airbridge/audit-log.md`. 토큰·표·applicability·구조 미변경. Audience no-individual-personas, Distinctive rare-9999px, Avoid canvas-ink-unmerged, Semantic extra list characterizations, Spacing calmer-hit-area, Shape rare-9999px, Elevation table Use, dense-data-heavy-copy, omitted-tracking-not-invented, Assets consistent-with-flat, Primary CTA fills, Segmented/Nav captured-variant, Nav hover-wash-name, FAQ field-note, Layout collapsing/image-behavior에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. 로그 `#155dfc` fills, `shadow.ring` 다중 목적지, 36px/29px not Spacing, 72px not Components 높이, F1/F2 준수 과장 교정. `AUDIT_DONE fixes=33`. Post-F3 SHA-256 `9f697e06cee4400e0b3f9940055338810d130df5f915fb0de5a690586309ca2a`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `airtable` F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/airtable/audit-log.md`. 토큰·표·applicability·구조 미변경. Semantic YAML-versus-body-only, Shape 9999-vs-50% unmerge-on-limiter, Motion spec-template match, Type-role not-converted / unmerged weight-and-tracking, Capture-record graph-not-adopted / hex-stays, Large Section shadow-not-copied, Layout kept-as-recorded에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. 로그 homepage URL vs Content host, `simpleicons` vs Simple Icons, ds.url not Font evidence, Soft ambient field-note, `#0f4ba0` vs `#6b7280`, Sign up C2, F1/F2 준수 과장 교정. `AUDIT_DONE fixes=27`. Post-F3 SHA-256 `bbd11952…1489df3e`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 웨이브 amazingtalker F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/amazingtalker/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope product-origin, friendly-weight, stripe-apple/reassuring, Spacing limiter 방향, Shape Sharp-Standard-Comfortable-Pill, Motion stays-fully-functional, Capture-record graph-not-adopted, Layout visual-rhythm/clean-header, Content section-titles에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. 로그 `#02cab9` Motion/Avoid 허위 목적지, rgb 휴대, tagline Type roles, `~32px` Components, F1/F2 준수 과장 교정. `AUDIT_DONE fixes=27`. Post-F3 SHA-256 `8589286390f9697c16207eb9472c836108984b72cdcd8fe211f304fb133f327e`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 adobe F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/adobe/audit-log.md`. 토큰·표·applicability·구조 미변경. product-story-span, atmosphere extra names, heaviest-hero 완전 B2a, Distinctive near-shadowless, Semantic identity-not-interaction / Spectrum-1-reproduction-only, Spacing recorded-scale, Pause-as-accessibility-commitment, Type-role no-lineHeight-promoted, Audience Tab captured-variant, Assistant fill-not-canvas, Layout collapsing/image-behavior, Content citation-character retarget에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. 로그 Type 442/463, Named gaps 585/587/588, Empowering Observed 525, 여섯 URL, F1/F2 준수 과장 교정. `AUDIT_DONE fixes=31`. Post-F3 SHA-256 `64c274ec…db13f3`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `airbridge` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/airbridge/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.0/1.33/1.54/1.5/1.43 비율 보존, button×3+tab×2+card×2+listItem 컴포넌트별 보존, Compact Primary/Default Input/Mint Highlight YAML type 없음·발명 없음, `tokens.source: live-extract` provenance, Google favicon URL provenance-only + Assets URL-free identity-boundary, generic Primary CTA Focus ring을 focus-visible로 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개(ease-exit 템플릿 일치)는 provenance omission ledger·duration/easing 이름/`prefers-reduced-motion` 보존, Dark Feature Card/Light Comparison Card/Mint Highlight kind/map 생략(C4), Primary/Ghost/Compact/Inline Link loading·error·success 생략(C2), Default Input error applicable/loading·success 생략, Segmented/Nav/FAQ 역할별 not-applicable, §14 9행 보존+philosophy-layer 분류, B3 다섯 증거 종류 본문 유지. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `bdd9b320180af18108339fcf0295a4e3b9f8068dc0b5fd98d688613a7f065858`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `adobe` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/adobe/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.5/1.25 비율 보존, button×5+tab+card+listItem 컴포넌트별 보존, `tokens.source: reconciled` provenance, `ds.type: system` dual Scope+provenance, Google favicon URL provenance-only + Assets/Named-gaps URL-free boundary, generic focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 이름 재수록 없음, 무출처 cubic-bezier 3개(ease-exit 템플릿 일치)는 provenance omission ledger·duration/easing 이름/`prefers-reduced-motion`/Pause·Reduce-motion 보존, Buy now/Inverse/Ghost/Outline/Nav/Assistant loading·error·success 생략(C2), Audience Tab 역할별 not-applicable, Category Tile/Glass/Promo kind/map 생략(C4), §9-only Glass 16px text 보존(A3), §14 9행 보존, B3 다섯 증거 종류 본문 유지, Spectrum 원칙 1–4 first-party / item 5·UI implication derived. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `118c3175aa4e4665184487aa74de4f69ee7298f225d113395253e4f0be4a97ba`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 웨이브 8 alipay F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/alipay/audit-log.md`. 토큰·표·applicability·구조 미변경. visual-character extra names, related-but-distinct vs first-party Scope 21, Audience no-inferred-workflow, Spacing measurements-stay-with-components, Capture-record unresolved-rather-than-imported, Search no-focus-ring-inferred, Top nav Use not-a-tab / captured-variant, Footer type-not-invented, Layout limited-to, Content developer-oriented에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. 로그 `#1677FF` extra dest, packet date dual, `data-omd-capture="1"` not Use, F1/F2 준수 과장 교정. `AUDIT_DONE fixes=27`. Post-F3 SHA-256 `4b58d4d1…e368b3`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `amazingtalker` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/amazingtalker/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.30/1.50 비율 보존, body Category Head 1.60(38.4px) 비해석 합침 없음, button×3+card+badge+tab 컴포넌트별 보존, YAML typography `use` 9 field, `tokens.source: live-extract` provenance, Google favicon dual provenance+Assets identity-only, generic Input Focus `#02cab9`/`2px` ring을 `focus-visible`로 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개(ease-exit 템플릿 일치)는 provenance omission ledger·duration/easing 이름/`prefers-reduced-motion` 보존, Course Card/Coral Soft Badge/Coral Accent Button/Teal Tint Tag/Surface Band kind/map 생략(C4), Primary Hero/Primary Section/Header Utility loading·error·success 생략(C2), Nav Link 역할별 not-applicable, Form Input error applicable/loading·success 생략, §14 9행 보존, B3 다섯 증거 종류 본문 유지, price `#484848` vs live `#ffffff` 비합침, YAML ambient vs standard shadow 비합침. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `b9eca221d701682e9592dfa2fe06451a4a295090f8b2f1d9320a93ef5690c971`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `adobe` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/adobe/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.5/1.25 비율 보존, button×5+tab+card+listItem 컴포넌트별 보존, `tokens.source: reconciled` provenance, `ds.type: system` dual Scope+provenance, Google favicon URL provenance-only + Assets/Named-gaps URL-free boundary, generic focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 이름 재수록 없음, 무출처 cubic-bezier 3개(ease-exit 템플릿 일치)는 provenance omission ledger·duration/easing 이름/`prefers-reduced-motion`/Pause·Reduce-motion 보존, Buy now/Inverse/Ghost/Outline/Nav/Assistant loading·error·success 생략(C2), Audience Tab 역할별 not-applicable, Category Tile/Glass/Promo kind/map 생략(C4), §9-only Glass 16px text 보존(A3), §14 9행 보존, B3 다섯 증거 종류 본문 유지, Spectrum 원칙 1–4 first-party / item 5·UI implication derived. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `118c3175aa4e4665184487aa74de4f69ee7298f225d113395253e4f0be4a97ba`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `alipay` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/alipay/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.5715/3.3333/2.5 비율 보존, button+input+card 컴포넌트별 보존, `tokens.source: live-extract`와 `ds.type: system` provenance, Google favicon URL provenance-only + Assets/Named-gaps URL-free boundary, `#1890FF` Open Platform action vs Ant Design `#1677FF` 분리, generic Search Focus를 focus-visible로 비승격, §13 stakeholder groups는 Audience만·sidecar 없음, 무출처 커브 없음, Developer action/Search/Nav/Footer loading·error·success 생략(C2), tool-card kind/map 생략(C4), §14 Search `focus` 본문 보존, B3 다섯 증거 종류 본문 유지. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `a9281e21eb5c6d47188bf28b07fd43d623fa5545adf641af907bc7fe8e7892da`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `airtable` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/airtable/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.15/1.50/1.25/1.20/1.40/1.35/1.30/1.28 비율 보존, button×3+input+card×2+badge 컴포넌트별 보존, YAML typography `use` 10 + Sub-heading tracking `normal`, `tokens.source: prose-derived` provenance, Simple Icons logo dual provenance+Assets identity-only, `#fcb400`는 catalog primary이지 CTA fill이 아님, generic focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 2개만 provenance omission·duration/easing 이름/`prefers-reduced-motion` 보존, Card/Badge kind/map 생략(C4), Primary/White/Input loading·error·success 생략(C2), Cookie Consent 역할별 not-applicable, §14 11행 보존, B3 다섯 증거 종류 본문 유지, `airtable-live` per-claim Proof 없음, docs/native/unpublished 부정 없음. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `7f323b410a80e171f3459cd9bcc6048323fcd4e581a55275ab774f396ff1b7aa`. F3 감사·sol 의미 레인 대기. 기존 `audit-log.md`는 이전 SHA의 기록이며 이번 SHA의 F3 증거가 아니다. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 7 acer 최종 확인 = **PASS**. 정본 `docs/reviews/t2-1-wave7-2026-08-24-sol-acer.md`. 기존 sol 판정의 잔여 2조건만 대조했고 새 기준 없음. `audit-log.md`의 fresh-session 최초 F3 및 `AUDIT_DONE fixes=26` 확인. 현재 post-F3 DESIGN SHA-256 `fecdd12e…1f7228` 일치, `--gate-only` exit 0 / PASS / problems `[]`, Core exit 0 / `portable_core: true` 재확인.
- 갱신: 2026-08-24 · T2 웨이브 7 acer F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/acer/audit-log.md`. 토큰·표·applicability·구조 미변경. capture-bound grouping, Family canonical-because-agree, Type-role not-converted, Capture-record graph-not-adopted, Locale Select native-select field-note, Content citation-character / tone-not-tokens / sample-grounding에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. 로그 Layout 293 vs Spacing 92, omitted B2a 186 vs Core policy 188, hex/Use/C2 줄번호, F1/F2 준수 과장 교정. `AUDIT_DONE fixes=26`. Post-F3 SHA-256 `fecdd12e…1f7228`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 7 최종 확인 (591·91app·accupass·acer) = **전체 FAIL, PASS 3/4, 남은 재제출 조건 11/13**. 정본 `docs/reviews/t2-1-wave7-2026-08-24-sol-final.md`. 선행 재확인 잔여 13건만 대조, 새 기준·새 F3 요구 없음. 591 1/1 PASS, 91app 2/2 PASS(최초 F3 `audit-log.md`, post-F3 SHA `12ed83ff…2ffe25`), accupass 4/4 PASS, acer 4/6 FAIL(원장 4건 PASS, `audit-log.md` 부재·최초 F3 및 post-F3 검사 미충족). 현재 파일 `--gate-only` PASS 4/4, Core exit 0 / `portable_core:true` 4/4; acer 결과는 pre-F3. 웨이브 8·카탈로그 채택은 acer까지 닫히기 전 차단.
- 갱신: 2026-08-24 · T2-1 웨이브 7 개정 2차 (591·accupass·acer 원장 동기화) = **본문 미변경, 동일 sol 목록-only 재제출 대기**. 워커 grok-4.6. 정본 잔여 `docs/reviews/t2-1-wave7-2026-08-24-sol-recheck.md`. 새 F3 없음. 591: YAML-identity Named-gaps first-party-mark 목적지와 기존 F2 C2 `not-applicable` 문장을 SUPERSEDED; favicon → Identity+Assets, Search CTA L/E applicable. accupass: Footer Link `#f5faff`/14px Type-role F2, Distinctive list-head F1/audit, kind provenance/audit, §2 Distinctive/Components 목적지, favicon Named-gaps 없음. acer: §11 derived-inventory F2, green hex derived 145, stale imagery/microcopy-guide F1/derived 제거, 네 B2a line map 동기화. F3는 이 개정에서 실행하지 않음(`audit-log.md` 부재, pending). 각 `migration-log.md`에 `Revision 2026-08-24 (wave7 ledger sync)`. DESIGN SHA 불변: 591 `866a65df…13c6e73c`, accupass `7724b822…1405cf7c`, acer `7ebdf2c8…dfa1f17`. `--gate-only` PASS 3/3, Core exit 0 / `portable_core: true` 3/3. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 웨이브 7 91app F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/91app/audit-log.md`. 토큰·표·applicability·구조 미변경. capture-bound grouping, Capture-record graph-not-adopted, Layout sized-for-touch/hierarchy-holds/source-stated-sizes에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. 로그 homepage Surfaces, per-hex, YAML component `use`, §11 identity vs visual-identity, F1/F2 준수 과장 교정. `AUDIT_DONE fixes=20`. Post-F3 SHA-256 `12ed83ff…2ffe25`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 7 동일 sol 목록-only 집중 재심 = **전체 FAIL, PASS 1/5, 선행 재제출 조건 13/26**. 정본 `docs/reviews/t2-1-wave7-2026-08-24-sol-recheck.md`. 새 기준·새 F3 실행/요구 없음. 591 5/6 FAIL: Named-gaps logo 목적지와 기존 C2 F2 미동기화. 8percent 4/4 PASS. 91app 2/4 FAIL: 선행 조건의 첫 F3 및 post-F3 검사 미수행. accupass 2/6 FAIL: Footer Link F2, Distinctive audit/F1, kind provenance/audit, §2/Named-gaps source-row 미동기화. acer 0/6 FAIL: §11·green-hex F2 목적지, stale imagery/microcopy F1/derived 원장, 선행 첫 F3/post-F3 검사 미완료. 현재 파일 직접 재실행 `--gate-only` PASS 5/5, Core exit 0 / `portable_core:true` 5/5. 5/5 PASS 전 웨이브 8·카탈로그 채택 차단.
- 갱신: 2026-08-24 · T2-1 웨이브 7 sol FAIL 재제출 개정 = **본문 반영, 동일 sol 목록-only 재확인 대기**. 워커 grok-4.6. 규칙집 v7. 정본 조건 `docs/reviews/t2-1-wave7-2026-08-24-sol-full.md` (591·8percent·91app·accupass·acer). 각 `migration-log.md`에 `Revision 2026-08-24 (wave7 sol resubmit)`. 591: §11 진화/實價登錄 관계, Filter Label 14px, Content evidence-class 분리, Search CTA C2, font/logo 부정 삭제. 8percent: `button-primary.states` identity, Soft pill mixed anatomy, `#3282f0`/에잇퍼센트/rem 목적지. 91app: typography negative 삭제, 미실행 F3 주장 제거. accupass: §11 관계, footer-link 14px, Distinctive B2a, kind 복원, font/logo/microcopy 부정 삭제. acer: §11 관계, imagery/label 발명 삭제, B2a, homepage URL/green hex/interaction count/§4→tasks 목적지, 미실행 F3 주장 제거. `--gate-only` PASS 5/5, Core exit 0 / `portable_core: true` 5/5. SHA-256: 591 `866a65df…13c6e73c`, 8percent `329a0289…6e8c177e`, 91app `a50f126f…dd2f629`, accupass `7724b822…1405cf7c`, acer `7ebdf2c8…dfa1f17`. 591·8percent·accupass 새 F3 없음. 91app·acer는 개정 뒤 첫 F3를 신선 세션에서 1회. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 7 sol 첫 5/5 전수 = **전체 FAIL, PASS 0/5**. 정본 `docs/reviews/t2-1-wave7-2026-08-24-sol-full.md`. 591은 §11/Filter Label/evidence-kind/state/font-negative/원장, 8percent는 `button-primary.states`/Soft pill/다중 목적지, 91app은 typography negative+F3 미실행, accupass는 §11/footer-link/B2a/kind/negative/원장, acer는 §11 관계/B2a/발명/다중 목적지/F3 미실행으로 FAIL. 현재 파일 직접 재실행 `--gate-only` PASS 5/5, Core exit 0 / `portable_core:true` 5/5. 591·8percent·accupass는 새 F3 없이 동일 sol 목록-only 재확인, 91app·acer는 개정 뒤 첫 F3를 정확히 1회 실행. 5/5 PASS 전 웨이브 8·카탈로그 채택 차단.
- 갱신: 2026-08-24 · T2 웨이브 7 8percent F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/8percent/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope typographic/flashier/bank-grade, Scope decade-arc/category-operator, Distinctive extra characterizations, capture-bound grouping, Shape dominant-on-the-page, Elevation divider-not-elevation, Soft/News-More/EdsTextfield field-note, Layout scannable/anchors/touch-purpose에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. 로그 `#3282f0`/9999px/`온투업 1호`/rgb 다중 목적지와 F1/F2 준수 과장 교정. `AUDIT_DONE fixes=32`. Post-F3 SHA-256 `c91b25fe…ebcfa66`, `--gate-only` PASS, `portable_core: true`. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `acer` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/acer/{DESIGN.md,provenance.md,migration-log.md}`. YAML lineHeight `normal`/`28.368px` 보존, button×2+card+input 컴포넌트별 보존, `tokens.source: live-extract` provenance, Google favicon URL provenance-only + Assets/Named-gaps URL-free boundary, generic focus 없음/`focus-visible` 비승격, §13 stakeholder archetypes는 Audience만·sidecar 없음, 무출처 커브 없음, Primary/Tertiary CTA loading·error·success 생략(C2), Feature Card kind/map 생략(C4), Locale Select L/E/S 역할 N/A, §14 10행 구현 안내 보존, B3 다섯 증거 종류 본문 유지. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `e3d95b1876d02716e02324ca4718e85df2fa3d46d9126cf9d0da83ecc1a96ff8`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 웨이브 7 `591` F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/591/audit-log.md`. 토큰·표·applicability·구조 미변경. Semantic extra unmerged, Type-roles unmerged pairs, Capture-record graph-not-adopted/extra characterizations, Listing Search Input field-note, Listing Row Card 16px-bold vs Body Large에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. migration-log 이중 목적지·HTML-comment 휴대 과장·F1/F2 준수 과장 교정. `AUDIT_DONE fixes=23`. Post-F3 SHA-256 `05899c6caf…cb7d9d`, `--gate-only` PASS, `portable_core: true`. sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 웨이브 7 accupass F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/accupass/audit-log.md`. 토큰·표·applicability·구조 미변경. Distinctive multi-step-rather-than-one-primary, Organizer Link unmerged `#2ea3f2`, Layout image-behavior/recorded-control-sizes에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. 로그 `#00aaf5` Organizer Link, blog URL not Content, press 60–63/78–81, 21 hex, 이중 목적지, F1/F2 준수 과장 교정. `AUDIT_DONE fixes=20`. Post-F3 SHA-256 `624c24af…0a93ca`, Core `portable_core: true`. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 워커 `591` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/591/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.31/1.5 비율 보존, button×3+tab×3+input×3+card×2+badge×2 컴포넌트별 보존, `tokens.source: live-extract` provenance, Google favicon dual provenance+Assets identity-only, generic focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 2개만 삭제·duration/`linear`/`prefers-reduced-motion` 보존, Search CTA·search input L/E/S 역할 N/A(C2), Card/Featured/Tag/Price kind/map 생략(C4), §14 10행 보존, B3 다섯 증거 종류 본문 유지. F1·F2 수행. `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `0da9651dab…89240b`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 웨이브 7 워커 `accupass` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/accupass/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.50/1.33 비율 보존, button×4+badge×3+card+tab 컴포넌트별 보존, `tokens.source: live-extract` provenance, Google favicon provenance-only URL + Assets/Named-gaps URL-free boundary, generic focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개(템플릿 `ease-exit` 포함)는 provenance omission ledger·duration/easing 이름/`prefers-reduced-motion` 보존, Ask ACCUPASS loading·error·success 생략(C2), Event Card/badges/Notice/links kind/map 생략(C4), §14 10행 보존+역할별 loading/error/success, B3 다섯 증거 종류 본문 유지. F1·F2 수행. `inspectDesignMd` `portable_core: true`, placeholders 0; `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `582ae714…d880b3`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 웨이브 7 워커 `8percent` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/8percent/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.10/1.50/1.15 비율 보존, button×4+input+card+badge+tab 컴포넌트별 보존, `tokens.source: live-extract` provenance, Google favicon dual provenance+Assets identity-only, generic EdsTextfield Focus `#3282f0`를 focus-visible로 승격하지 않음, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개(ease-exit 템플릿 일치)는 provenance omission ledger, duration/`ease-*` 이름/`prefers-reduced-motion` 보존, Primary/Soft/News-More/Confirm/Notice loading·error·success 생략(C2), Product Card/Credit-Grade Tag kind/map 생략(C4), §14 9행 보존, B3 다섯 증거 종류 본문 유지. F1·F2 수행. `inspectDesignMd` `portable_core: true`, placeholders 0; `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `f0c09780…81739b39`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 웨이브 7 워커 `91app` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/91app/{DESIGN.md,provenance.md,migration-log.md}`. YAML spacing sm 8 / base 16 / lg 24 / xl 32는 숫자 보존(px 접미사 비발명), button×3+card 컴포넌트별 보존, `tokens.source: prose-derived` provenance, Google favicon dual provenance+Assets identity-only, generic focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 커브 없음, Primary/Coral/Neutral loading·error·success 생략(C2), Hero Heading kind/map 생략(C4), §14 variant-as-state 본문 보존, B3 다섯 증거 종류 본문 유지. F1·F2 수행. `inspectDesignMd` `portable_core: true`, placeholders 0; `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. SHA-256 `7dbd3fcf…48a0aaa`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 6 11st·42dot sol 최종 확인 = **PASS 2/2, 남은 재제출 조건 5/5**. 정본 `docs/reviews/t2-1-wave6-2026-08-24-sol-final.md`. 선행 재확인의 「남은 재제출 조건」만 대조했고 새 기준·새 F3 실행/증거 요구 없음. 11st: audit Principles notes-only/F1 기록 supersede 및 세 numbered items 전체 derived class 동기화 PASS. 42dot: audit viewport 세 판정 supersede, §6 shadow·§2/§9 transparent·§14 warm-error-tone 원 source-row provenance 목적지, 제한된 F2/E2c 동기화 PASS. 현재 파일 `--gate-only` PASS 2/2, Core exit 0 / `portable_core:true` 2/2; DESIGN SHA 불변. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 6 개정 2차 (11st·42dot 원장 동기화) = **본문 미변경, 동일 sol 목록-only 재제출 대기**. 워커 grok-4.6. 정본 잔여 `docs/reviews/t2-1-wave6-2026-08-24-sol-recheck.md`. 새 F3 없음. 11st: `audit-log.md` Principles *UI implication* notes-only class와 F3 F1 restatement를 SUPERSEDED로 표시하고 세 numbered items 전체(stems+조합+UI implications) derived로 정정. 42dot: `audit-log.md:35,60,77` cross-viewport / newly-measured-mobile-pass / inspect-limiter를 SUPERSEDED; 원 §6 shadow·§2/§9 transparent·§14 warm-error-tone source-row에 provenance 목적지 기록; sol-resubmit 요약표·F2 과대 주장을 SUPERSEDED 후 세 grep만 F2로 남김. 각 `migration-log.md`에 `Revision 2026-08-24 (wave6 ledger sync)`. DESIGN SHA 불변: 11st `334be838…0e460e`, 42dot `a043a85e…48a9c6`. `--gate-only` PASS 2/2, Core exit 0 / `portable_core: true` 2/2. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 6 동일 sol 목록-only 집중 재심 = **전체 FAIL, PASS 3/5, 선행 재제출 조건 25/29**. 정본 `docs/reviews/t2-1-wave6-2026-08-24-sol-recheck.md`. 새 기준·새 F3 실행/증거 요구 없음. 104 5/5 PASS, 17live 6/6 PASS, 3o3 5/5 PASS. 11st 5/6 FAIL: 본문·provenance·F1은 Principles 전체 derived로 교정됐으나 `audit-log.md:13`의 UI-implication-only 분류가 미동기화. 42dot 4/7 FAIL: `audit-log.md:35,60,77`의 unsupported viewport 판정 잔존, §6 shadow·§2/§9 transparent·§14 warm-error-tone 원 source-row의 provenance 목적지 누락, 그에 따른 F2/E2c 과대 주장. 현재 파일 직접 재실행 `--gate-only` PASS 5/5, Core exit 0 / `portable_core:true` 5/5. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 웨이브 6 sol FAIL 재제출 개정 = **본문 반영, 동일 sol 목록-only 재확인 대기**. 워커 grok-4.6. 규칙집 v7. 정본 조건 `docs/reviews/t2-1-wave6-2026-08-24-sol-full.md` (104·11st·17live·3o3·42dot). 각 `migration-log.md`에 `Revision 2026-08-24 (wave6 sol resubmit)`. 104: known selector를 unresolved에서 제거, Distinctive 4색 B2a, §10 mixed, favicon URL/URL-free 분리. 11st: body/list/button/dialog use 복원, Principles 전체 B2a, Billboard L/E/S 생략, dark-surface·support-copy 부정 제거, §9 mixed·footer dual. 17live: §11 고유 facts 복원, easing/pixels B2a, Follow success·Gift error/success 반영, LIVE/Rank/Avatar Kind 생략, 새 font/native 부정 제거. 3o3: FontFace/reproduction/logo-file/microcopy 부정 삭제, product-origin thesis 복원, `158-86-00171` HTML-comment dual. 42dot: homepage/blog `#786efa` ×16 분리 보존, AstaSans live/Noto declared-only 분리, font/license·viewport 부정 제거, Nav Item L/E/S 생략, source-row 목적지 교정. `--gate-only` PASS 5/5, Core check exit 0 / `portable_core: true` 5/5. SHA-256: 104 `1e840b06…ff5e04`, 11st `334be838…0e460e`, 17live `03e7b4ca…97102a`, 3o3 `e950dc17…461a23`, 42dot `a043a85e…48a9c6`. 새 F3 없음. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 웨이브 6 3o3 F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/3o3/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope public-history, Distinctive extra readings, Semantic unmerged-role, Font evidence/Family, Type roles unmerged-ink/dark-band, Capture-record `#f0f1f2`, Info Chip field-note, Layout surface-measurements에 인접 완전 B2a. 로그·provenance: favicon URL dual(not Named-gaps URL), `primary_color`+Principles, 타이틀 not Distinctive/Primary tasks, 48px floor not YAML `xl`, `158-86-00171` not Scope, Named gaps≠B3 전문. `AUDIT_DONE fixes=31`. Post-F3 SHA-256 `a40910a2…5099e`, `--gate-only` PASS, `portable_core: true`. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 웨이브 6 17live F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/17live/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope secondary-surface/matching/not-interface-tokens, Distinctive 특성 서술, Avoid favicon, Semantic unmerged-role, Shape 4px, Signature not-decoration, Font evidence, Family 완전 B2a, Assets identity-not-captured, Layout Twitch/thumb, Content 불완전 한정 교체에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. migration-log 이중 목적지·`prose-derived` Foundations 과대·F1/F2 준수 과장 교정. `AUDIT_DONE fixes=34`. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 웨이브 6 `104` F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/104/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope product-story, Audience no-invented-behaviors, Distinctive teal-not-substitute / no-uncaptured-promoted, Semantic unmerged-role / evidence-domain, Elevation hairline-not-shadow, Font evidence, Type-role named-family, Capture-record omit 인접, Layout measurement-boundary 인접, Content no-synthetic에 인접 완전 B2a. 로그 `#ff9100`/campaign/Arial 다중 목적지와 Portable Core 과장 교정. provenance derived 범위를 본문 실제에 맞춤. `AUDIT_DONE fixes=28`. 카탈로그 채택 아님. sol 의미 레인 대기.
- 갱신: 2026-08-24 · T2 웨이브 6 `42dot` F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/42dot/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope public-fact-not-token, Assets imagery, Layout-application (touch purpose / collapsing packet-rows / stay-legible), Content tone-table, Forbidden-register에 인접 완전 B2a. 로그 `#786efa`/live-extract/shadow/inspect-px 다중 목적지와 `precision-over-decoration` 과장 교정. provenance derived 범위를 본문 실제에 맞춤. `AUDIT_DONE fixes=27`. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 웨이브 6 11st F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/11st/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope evidence-domain/authorize, Audience no-invented-personas, Distinctive/Brand-red filled-CTA, canonicity/`#F43142`, Elevation, Motion dialog-open, Font evidence, Family related-but-distinct, Capture-record omit, Billboard field-note, Layout omitted-rather-than-inferred에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. 로그 다중 목적지·F1/F2 준수 과장 교정. `AUDIT_DONE fixes=24`. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 웨이브 6 3o3 수동 이관 = **완료**. `docs/design-md-weight/migrated/3o3/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v7. F1 B2a 전편 재독, F2 grep 대조. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand 3o3 --gate-only` PASS. YAML unitless lineHeight 1.50/1.00/1.40/1.22/1.60 비율 보존, button×5+badge+card×2+listItem 컴포넌트별 보존, `tokens.source: reconciled` provenance, Google favicon triple provenance+Assets+Named gaps, generic focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 2개만 삭제·duration/`ease-in-out`/`prefers-reduced-motion` 보존, Chip/Card/Dark Band/Footnote kind/map 생략(C4), Funnel/Kakao/Ghost loading·error·success 생략(C2), §14 11행 보존(illustrative B2a)+역할별 생략, B3 다섯 증거 종류 본문 유지. 카탈로그 채택 아님.

- 갱신: 2026-08-24 · T2 웨이브 6 워커 `104` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/104/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.43/2.14/1.4 비율 보존, button×2+tab×2+card+dialog 컴포넌트별 보존, `tokens.source: live-extract` provenance, Google favicon triple provenance+Assets+Named gaps, generic focus 없음/`focus-visible` 비승격, §13 official stakeholder groups는 Audience·sidecar 없음. Search Action/Outline Action loading·error·success 세 field 생략(C2). Company Card/Login Dialog kind+map 생략(C4). §14 `observedStates/interactionKinds/interactionCount` 0 본문 보존. 무출처 커브 없음. B3 다섯 증거 종류 본문 유지. F1·F2 수행. `inspectDesignMd` `portable_core: true`, placeholders 0; `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 웨이브 6 워커 `11st` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/11st/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.50/2.44/1.85 비율 보존, input+button+card+dialog 컴포넌트별 보존, `tokens.source: reconciled` provenance, Google s2 favicon dual provenance+Assets identity-only, generic Focus/Pressed `#111111`를 focus-visible로 승격하지 않음, §13 named personas 없음·sidecar 없음, 무출처 커브 없음, Deal Card/Header Inventory Dialog kind/map 생략(C4), §14 4행 보존+역할별 loading/error/success, B3 다섯 증거 종류 본문 유지. F1·F2 수행. `inspectDesignMd` `portable_core: true`, placeholders 0; `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 웨이브 6 17live F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/17live/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope secondary-surface/matching/not-interface-tokens, Distinctive 특성 서술, Avoid favicon, Semantic unmerged-role, Shape 4px, Signature not-decoration, Font evidence, Family 완전 B2a, Assets identity-not-captured, Layout Twitch/thumb, Content 불완전 한정 교체에 인접 완전 B2a. provenance derived 범위를 본문 실제에 맞춤. migration-log 이중 목적지·`prose-derived` Foundations 과대·F1/F2 준수 과장 교정. `AUDIT_DONE fixes=34`. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 웨이브 6 워커 `42dot` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/42dot/{DESIGN.md,provenance.md,migration-log.md}`. YAML unitless lineHeight 1.45/1.60/1.50/1.40 비율 보존, badge×2+card×2+tab+button 컴포넌트별 보존, `tokens.source: live-extract` provenance, first-party favicon dual provenance+Assets, generic focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개(템플릿 `ease-exit` 포함)는 provenance omission ledger, duration/`ease-*` 이름 보존. Active Tag Pill/Blog Card/Nav Dropdown kind+map 생략(C4). Inactive Tag Filter·Nav Item·Carousel Control은 식별된 역할로 loading·error·success maps 유지. §14 9행 보존. B3 다섯 증거 종류 본문 유지. F1·F2 수행. `inspectDesignMd` `portable_core: true`, placeholders 0; `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2 웨이브 6 워커 `17live` 수동 이관 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 산출물 `docs/design-md-weight/migrated/17live/{DESIGN.md,provenance.md,migration-log.md}`. Live inspect 미완료·brief-provided `#FF4F6E`·기타 hex 근사 경계를 portable Scope/Foundations에 유지. 무출처 커브 3개(템플릿 일치)는 provenance omission ledger. §13 가상 persona 삭제·sidecar 없음. Mixed Primary/Default Input loading·error·success 세 field 생략. Stream Card/List Card kind+map 생략(C4). LIVE/Rank Badge·Avatar `Kind: non-interactive`. F1·F2 수행. `inspectDesignMd` `portable_core: true`, placeholders 0; `--gate-only` PASS/problems 0; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true`. F3 감사·sol 의미 레인 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-24 · T2-1 소급 6건 `naver, figma, wanted, airbnb, slack, line` 동일 sol 목록-only 집중 재심 = **PASS 6/6, 선행 재제출 조건 39/39**. 정본 `docs/reviews/t2-1-retro-2026-08-23-sol-recheck.md`. 선행 두 sol 문서의 건별 조건만 대조했고 새 기준·추가 F3·raw/structured F3 일치 조건은 요구하지 않았다(`t2-1-protocol-2026-08-23-grok.md` 53–56·77·86행). 기존 이관당 1회 `audit-log.md`만 확인. 현재 파일에서 `--gate-only` PASS/problems 0, Core exit 0/`portable_core:true` 6/6 직접 재실행. 원장 공백 6건의 양 레인 조건이 닫혀 통과 집합은 29건. 카탈로그 채택은 별도 최종 승인 사항이며 다음은 웨이브 6.
- 갱신: 2026-08-23 · T2-1 소급 6건 sol FAIL 재제출 개정 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 정본 조건 `docs/reviews/t2-1-retro-2026-08-23-sol-1.md`(naver·figma·wanted) + `docs/reviews/t2-1-retro-2026-08-23-sol-2.md`(airbnb·slack·line). Naver: `나눔고딕` Unresolved claim·footer `(omd:migrate)` 복원, Search Submit 세 field 생략, Scope/Avoid/Foundations/Layout/Content 인접 B2a. Figma: Unresolved claim·`(omd:migrate)`·TTL을 2026-07-12 역사 판정으로 분리, Primary/Indigo/Outline/Round icon 세 field 생략, desktop/English coverage 철회. Wanted: Unresolved claim·§11 서사 복원, Principles 1–4 derived B2a, header 세 field·Search error 생략, Montage kind/map 생략. Airbnb: Unresolved claim·`(omd:migrate)`, Hosting/circular 세 field 생략. Slack: slack-live 매핑 제거, §9 Success/Presence 충돌·§11 2012/$1B/Stewart/2019 복원, mixed C2 생략, Kind non-interactive 생략, font/license 부정 철회. LINE: in-app visual verification·공식 sheets/navigation/lists/cards/feedback 서사·Popup `optional area` 복원, Box Button error/success·Text Input loading/success 생략, locale 부정 철회, Simple Icons dual. 각 `migration-log.md`에 `Revision 2026-08-23 (retro sol resubmit)`. F1·F2 수행. 새 F3: Naver `AUDIT_DONE fixes=14`, Figma `16`, Wanted `19`, Airbnb `22`, Slack `23`, LINE `24`. `--gate-only` PASS 6/6, `migrate-design-md-core.cjs --check --require-portable-core` exit 0 / `portable_core: true` 6/6. 동일 sol 의미 레인 재제출. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2-1 소급 전수 1/2 `naver, figma, wanted` sol 첫 판정 = **FAIL 3/3 (PASS 0/3)**. 정본 `docs/reviews/t2-1-retro-2026-08-23-sol-1.md`. 세 `--gate-only`는 PASS/problems 0, Core check exit 0/`portable_core:true`이나 v7 의미·절차는 모두 차단됐다. 공통 `Unresolved` evidence-class 변조·Principles 밖 B2a·source-row/Named-gaps E2·F1/F2 및 미실행 F3가 남았고, Naver는 footer metadata·mixed Search Submit, Figma는 footer/freshness·generic/mixed actions·새 viewport/English coverage, Wanted는 §11 서사·Search C1/header C2/Montage C4가 추가 결함이다. 세 건은 v7 개정+이관당 1회 fresh F3+동일 sol 목록-only 재확인 3/3 PASS 전 양 레인 18건에 더하지 않으며 카탈로그 채택도 아니다.
- 갱신: 2026-08-23 · T2-1 원장 공백 소급 전수 2/2 `airbnb, slack, line` sol 첫 판정 = **FAIL 3/3**. 정본 `docs/reviews/t2-1-retro-2026-08-23-sol-2.md`. 세 건 모두 current `--gate-only` PASS/problems 0, Core exit 0/`portable_core:true`지만 v7 의미·절차는 실패했다. Airbnb는 evidence class/footer/C2/B2a/다중 목적지, Slack은 live Proof/§9 conflict/narrative/C2·C4/font negative, LINE은 verification method/component depth/§9 Popup/C2/locale negative/logo 목적지가 차단점이다. 세 산출물은 v5 기록뿐이며 F1·F2 수행 증거와 F3 `audit-log.md`가 없다. 개정·이관당 첫 F3·동일 sol 목록-only 재확인 PASS 전 양 레인 집합에 추가하지 않으며 카탈로그 채택은 별도 승인이다.
- 갱신: 2026-08-23 · T2-1 웨이브 5 Airtable·ABEMA sol 최종 재판정 = **PASS 2/2**, 선행 세 건과 합쳐 웨이브 5 동일 sol 재확인 **PASS 5/5**. 정본 `docs/reviews/t2-1-wave5-2026-08-23-sol-final.md`. 승인 프로토콜 `t2-1-protocol-2026-08-23-grok.md` 53–56·77·86행에 따라 목록 재제출의 새 F3 의무를 철회했다. Airtable 내용 7/7, ABEMA 6/6은 현재 파일에서도 유지되고 새 내용 결함은 없었다. 두 DESIGN 해시는 종전 재확인과 동일하며 Core exit 0/`portable_core:true`, gate `PASS`/problems 0을 직접 재실행했다. raw/structured F3 불일치는 해소됐다고 보지 않되 프로토콜상 비차단이다. 웨이브 5 목록 개정·동일 sol 재확인 조건은 닫혔고 카탈로그 채택은 별도 최종 승인 사항이다.
- 갱신: 2026-08-23 · T2-1 웨이브 5 다섯 개정본 sol 집중 재심 = **전체 FAIL, PASS 3/5, 재제출 조건 32/34**. 정본 `docs/reviews/t2-1-wave5-2026-08-23-sol-recheck.md`. 새 기준 없이 선행 건별 조건만 대조했다. Duolingo 7/7 PASS, Ably 6/6 PASS, Pinterest 6/6 PASS. Airtable은 내용 7개·Core/gate가 통과했으나 structured `audit-log.md` fresh `fixes=17`과 raw `auditor-log.txt` 이전 `fixes=25`/sophisticated-simplicity 부재 주장이 불일치해 새 신선 F3 실행 조건 FAIL(7/8). ABEMA도 내용 6개·Core/gate가 통과했으나 structured fresh `fixes=15`와 raw 이전 TIMES Named-gaps/`fixes=14`가 불일치해 같은 조건 FAIL(6/7). 직접 재실행은 `--gate-only` PASS 5/5, full 3건 Core exit 0/`portable_core:true`. Airtable·ABEMA의 새 F3 raw+structured 일치 재제출 전 웨이브 5·다음 웨이브·카탈로그 채택 정지.
- 갱신: 2026-08-23 · T2-1 웨이브 5 pinterest·airtable·abema sol FAIL 재제출 개정 2차 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 정본 조건 `docs/reviews/t2-1-wave5-2026-08-23-sol-full.md`. Pinterest: Business action 세 field 생략, 2px shadow 결합 철회, Scope/Avoid/Elevation 등 인접 완전 B2a, §9 prompt 삭제, font URL·§7/§8/§14/§15 Named gaps 목적지. Airtable: typography `use` 10 + Sub-heading `normal`, `airtable-live` per-claim 제거, Input/Badge B2a, Primary/White/Input 세 field 생략, docs/native/unpublished·Trademark no-token 철회, narrative/`sophisticated simplicity` 복원, ds/primary/shadow/`#e5e7eb`/hero 목적지. ABEMA: hover/accent CSS-only, Pure White/Assets/veil B2a, mixed control 세 field 생략, native/TIMES 부정 철회, fallback 원천·§5/§8/§11 task 목적지, Core checker `do not … constraint` 재작성 → `portable_core: true`. 각 `migration-log.md`에 `Revision 2026-08-23 (wave5 full resubmit)`. 새 F3: Pinterest `AUDIT_DONE fixes=24`, Airtable `17`, ABEMA `15`. `inspectDesignMd` `portable_core: true`, placeholders 0; `--gate-only` PASS 3/3; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 3/3. 동일 sol 의미 레인 재제출. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2-1 웨이브 5 잔여 pinterest·airtable·abema sol 전수 = **FAIL 3/3**, 표본 포함 최초 웨이브 **FAIL 5/5**. 정본 `docs/reviews/t2-1-wave5-2026-08-23-sol-full.md`. 세 `--gate-only`는 PASS/problems 0이나 F3 13/25/14건 수정 뒤에도 세 건 모두 B2a·E2가 잔존했다. Pinterest는 §9 prompt 잔존(A2), generic Business C2, shadow 결합(A1/A4), B2a·source-row 로그; Airtable은 typography use/tracking·narrative 손실, live Proof 승격, inferred component B2a, generic C2, 새 negative domains, ds/primary/shadow 로그; ABEMA는 live Proof 승격, B2a, mixed C2, native/TIMES negatives·로그에 더해 현재 Core checker가 `portable_core:false`다. 웨이브 5 F3는 총 102건 수정 후에도 5/5 결과 FAIL. 전 건 개정·동일 sol 재검증 전 웨이브 5·다음 웨이브·카탈로그 채택 정지.
- 갱신: 2026-08-23 · T2-1 프로토콜 재심 = **A APPROVE_WITH_CONDITIONS**. 정본 `docs/reviews/t2-1-protocol-2026-08-23-grok.md`. 상정 2 표본율 폐기. B·C 기각. sol은 웨이브마다 5건 전수 → 목록 개정 → 동일 sol 재확인. F3는 sol 전수 전 결함 감소로만 유지(첫 판정 PASS 실험 아님). 양 레인 문서화는 **18건** (골든 3 + notion + w1 5 + w2 표본 2 + w3 표본 2 + w4 5). 「24건」은 받지 않음. 공백 6건: `naver, figma, wanted`, `airbnb, slack, line`. 웨이브 5 잔여 `pinterest, airtable, abema` 전수 + 표본 2 개정·재확인 전 웨이브 6·카탈로그 채택 정지.
- 갱신: 2026-08-23 · T2-1 웨이브 5 duolingo·ably sol FAIL 재제출 개정 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v7. 정본 조건 `docs/reviews/t2-1-wave5-2026-08-23-sol-sample.md`. Duolingo: claim-surface mapping/per-surface dates 제거, Font Official product-use 철회·owl-curve 복원, Layout composition/purpose 인접 B2a, identity/color URL triple·primary_color triple, §9 CONTINUE 우측 배치, Accent/Destructive loading·error·success 생략, Audience `ads` 제거. Ably: Scope synthesis·yellow canonicality 인접 B2a, Team/Seller 세 field 생략·`navigates Team content` 제거, copy-domain 부정 claim 삭제, `verification_v2.surfaces` dual, `components_harvested` provenance-only, §14 full-body vs list 분리. 각 `migration-log.md`에 `Revision 2026-08-23 (wave5 sol resubmit)`. F1·F2 수행. 새 F3: Duolingo `AUDIT_DONE fixes=14`, Ably `AUDIT_DONE fixes=7`. `inspectDesignMd` `portable_core: true`, placeholders 0, `--gate-only` PASS 2/2. 동일 sol 의미 레인 재제출. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2-1 웨이브 5 sol 표본 2/5 = **FAIL 2/2**. 정본 `docs/reviews/t2-1-wave5-2026-08-23-sol-sample.md`. `--gate-only` 직접 재실행은 Duolingo/Ably 모두 PASS, problems 0. F3는 별도 감사로 23건/27건을 수정했지만 최종 두 산출물 모두 B2a·E2가 잔존해 구조 전환의 재발 차단 기준을 충족하지 못했다. Duolingo는 unsupported claim-surface/font evidence(A1/E1), Layout B2a, identity URL·primary_color 목적지, §9 right-alignment, mixed-role C2, fictional Daniel의 `ads` 승격(D2); Ably는 Scope/color B2a, generic Team action C2, 새 negative copy-domain(D1), verification_v2/metadata/§14 disposition(E2)로 FAIL. 두 표본 개정·동일 sol 재제출과 나머지 3건 v7 의미 전수 전 웨이브 5·카탈로그 채택 정지.
- 갱신: 2026-08-23 · T2 웨이브 5 airtable F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/airtable/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope color-belongs 한정 완결, Distinctive local-2px, Avoid deliberately-sharp, Shape local-geometry, Cookie Use, Layout application, Content forbidden-phrase에 인접 완전 B2a. 로그 §2 shadow 목적지·Cookie 2px 다중 목적지·§6 인과 원천·F1/F2 준수 과장 교정. provenance derived 범위에서 `sophisticated simplicity` 제거·실제 B2a 위치 추가. `AUDIT_DONE fixes=25`. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 웨이브 5 ably F3 B2a·E2 감사 = **완료**. `docs/design-md-weight/migrated/ably/audit-log.md`. 토큰·표·applicability·구조 미변경. Scope evidence-domain/cross-surface-signal, Distinctive narrative, Avoid, Spacing/Shape local-scale, Elevation, Typography Don't, Assets product-imagery, story-card field note, Layout cross-viewport에 인접 완전 B2a. 로그 이중 목적지·`display_name_kr` provenance-only·F1/F2 준수 과장 교정. provenance derived 범위를 본문 실제에 맞춤. `AUDIT_DONE fixes=27`. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 웨이브 5 duolingo F3 감사 = **완료**. `docs/design-md-weight/migrated/duolingo/{DESIGN.md,provenance.md,migration-log.md,audit-log.md}`. B2a: capture-bound / Avoid Don'ts / reduce-motion 성격 / lip-always-solid / tap-first / gamey sheen에 인접 완전 한정. E2: Simple Icons triple, `#1a73e8` Avoid, Nunito triple, curve 이름 Named gaps, F1/F2 준수 과장 철회. `AUDIT_DONE fixes=23`. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 웨이브 5 Pinterest F3 감사(B2a·E2) = **완료**. `docs/design-md-weight/migrated/pinterest/audit-log.md`. Capture-bound 인접 B2a 한정 추가, Principles 한정 범위를 번호 목록으로 축소, provenance Simple Icons dual→triple·derived 범위 실제화, migration-log 이중 목적지/§9 Do not blend/F1·F2 준수 과장 교정. 토큰·컴포넌트 표·applicability·구조 미변경. `AUDIT_DONE fixes=13`. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 웨이브 5 abema F3 감사 (B2a·E2) = **완료**. `docs/design-md-weight/migrated/abema/audit-log.md`. 토큰/표/applicability/구조는 미수정. B2a 9곳 인접 완전 한정, provenance derived 범위 확장, homepage/TIMES/「テレビの再発明」 이중 목적지와 F1 준수 과장 교정. `AUDIT_DONE fixes=14`.
- 갱신: 2026-08-23 · T2 웨이브 5 abema 수동 이관 = **완료**. `docs/design-md-weight/migrated/abema/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v7. F1 B2a 전편 재독, F2 grep 대조. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand abema --gate-only` PASS. YAML unitless lineHeight 1.5 비율 보존, button×4+input+card+badge+tab+toggle+toast 컴포넌트별 보존(+ Primary Dark `Type: button`), `tokens.source: live-extract` provenance, Google favicon dual provenance+Assets/Avoid, generic Round Tab Focus `#e6e6e6`/`#212121`를 focus-visible로 승격하지 않음, §13 fictional archetypes 삭제·sidecar 없음, 무출처 커브 없음(`cubic-bezier(.33, 1, .68, 1)`는 shipped CSS 귀속·보존), Floating Panel/Title Card/Notification/Modal kind/map 생략(C4), §14 10행 보존+역할별 loading/error/success, B3 다섯 증거 종류 본문 유지. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 웨이브 5 ably 수동 이관 = **완료**. `docs/design-md-weight/migrated/ably/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v7. F1 B2a 전편 재독, F2 grep 대조. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand ably --gate-only` PASS. YAML unitless lineHeight 1.25/1.33/1.27/1.4/1.5/1.6 비율 보존, button×5+card 컴포넌트별 보존, `ds.type: brand` provenance, Google s2 favicon dual provenance+Assets identity-only, generic focus 없음/`focus-visible` 비승격, §13 first-party task contexts는 Audience·sidecar 없음, 무출처 커브 없음, Story card kind/map 생략(C4), §14 본문 보존+역할별 loading/error/success, B3 다섯 증거 종류 본문 유지. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 웨이브 5 airtable 수동 이관 = **완료**. `docs/design-md-weight/migrated/airtable/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v7. F1 B2a 전편 재독, F2 grep 대조. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand airtable --gate-only` PASS. YAML unitless lineHeight 1.15/1.50/1.25/1.20/1.40/1.35/1.30/1.28 비율 보존, button×3+input+card×2+badge 컴포넌트별 보존, `ds.type: brand` provenance, Simple Icons logo dual provenance+Assets, `#fcb400`는 catalog primary이지 CTA fill이 아님, generic focus 없음/`focus-visible` 비승격, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 2개만 삭제·duration/easing 이름/`prefers-reduced-motion` 보존, Card/Badge kind/map 생략(C4), §14 11행 보존+역할별 loading/error/success, B3 다섯 증거 종류 본문 유지. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 웨이브 5 duolingo 수동 이관 = **완료**. `docs/design-md-weight/migrated/duolingo/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v7. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand duolingo --gate-only` PASS. YAML unitless lineHeight 1.2/1.25/1.5 비율 보존, button×4+card×3+input+tab+toggle 컴포넌트별 보존, `tokens.source: reconciled` provenance, Simple Icons logo dual provenance+Assets boundary, generic Focus `#1CB0F6`를 focus-visible로 승격하지 않음, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 4개만 삭제·duration/signature/`ease-*` 이름 보존, Card/Pill/Badge/Progress/Feedback bar/Modal kind/map 생략(C4), §14 11행 보존+역할별 loading/error/success, B3 다섯 증거 종류 본문 유지. F1·F2 수행. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 웨이브 5 Pinterest 수동 이관 = **완료**. `docs/design-md-weight/migrated/pinterest/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v7. F1 B2a 전편 재독, F2 grep 대조. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand pinterest --gate-only` PASS. YAML unitless lineHeight `1.50` 비율 보존, button×4+input+tab 컴포넌트별 보존, `ds.type: system` provenance, Simple Icons logo triple provenance+Assets+Avoid, generic focus 없음/`focus-visible` 비승격, §13 FILL IN provenance omission ledger·sidecar 없음, 무출처 커브 없음, §14 본문 보존+역할별 loading/error/success, B3 다섯 증거 종류 본문 유지. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2-1 웨이브 4 다섯 개정본 sol 집중 재심 = **PASS 5/5, 재제출 조건 26/26**. 정본 `docs/reviews/t2-1-wave4-2026-08-23-sol-recheck.md`. 새 기준 없이 선행 `sol-sample`의 Netflix 5항·GitHub 6항과 `sol-full`의 Spotify·Discord·Vercel 각 5항만 대조했다. v6 F1·F2 수행 기록을 확인했고 `--gate-only`를 직접 재실행해 PASS 5/5, problems 0을 확인했다. 웨이브 4 동일 sol 재제출 조건은 전부 해소됐으며 카탈로그 채택은 별도 결정이다.
- 갱신: 2026-08-23 · T2-1 웨이브 4 spotify·discord·vercel sol FAIL 재제출 개정 2차 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v6. Spotify: Hollow `Type: button`·surface kind 제거, §12 세 stem 전체 derived B2a, Scope/Avoid/Foundations/Layout/Content 인접 B2a, Outlined/Circular loading·error·success 생략, source-row 목적지/Governance 로그. Discord: WebFetch 두 voice string 보존·나머지 derived 분리, Avoid/Motion/States/Semantic/Components B2a, branding vs third-party·claim mapping·toast auto-dismiss 제거, Badge/Toast kind·§14/HTML 목적지 로그. Vercel: Font `Unresolved claim` 복원, footer `(omd:migrate)` 보존, Distinctive/Avoid/Elevation/card/responsive B2a, Geist specimen C2 생략, Governance 이중 목적지 로그. 각 `migration-log.md`에 `Revision 2026-08-23 (wave4 full resubmit)`. F1·F2 수행. `inspectDesignMd` `portable_core: true`, placeholders 0, `--gate-only` PASS 3/3. 동일 sol 의미 레인 재제출. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2-1 웨이브 4 표본 제외 spotify·discord·vercel sol 전수 = **FAIL 3/3**. 정본 `docs/reviews/t2-1-wave4-2026-08-23-sol-full.md`. 세 `--gate-only` 직접 재실행은 PASS/problems 0. Spotify는 Hollow CTA type·surface kind 발명(A1/A4), §12/Scope B2a·E1, generic player-action C2, source-row 목적지/F1/F2 로그(E2/a/c). Discord는 직접 검증 copy 손실·derived copy 과승격(A1/B2/E1), Avoid/Motion 등 B2a, brand/product ledger와 toast 발명, §14/HTML disposition·준수 과장(E2/a/c). Vercel은 `Unresolved`→`Outside this capture`·footer metadata 손실(A1/A1c), Traits/Avoid/Elevation 등 B2a, generic Geist specimen C2, Governance 목적지/F1/F2 로그(E2/a/c). 최초 웨이브 의미 판정은 표본 포함 **FAIL 5/5**. 세 건 개정과 전 건 동일 sol 재검증 전 웨이브 4·다음 웨이브·카탈로그 채택 정지. Netflix/GitHub 현 개정본은 별도 재심 대기.
- 갱신: 2026-08-23 · T2-1 웨이브 4 netflix·github sol FAIL 재제출 개정 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v6. Netflix: Grey 500 `"secondary"` CTA label 복원(Auth-border·More Info `#FFFFFF` 비합침), Expanded Preview generic Hover/focus를 additional observed `Focus`로 복원(`focus-visible` 비승격), §9-only top-nav composition 복원, Motion/Avoid/Scope/Canvas 인접 B2a, §2/§4/§9/§14 로그를 field/role 문맥에 맞춤. GitHub: Label YAML exact border/height·Action List padding·Inline Message leading icon·Banner anatomy 복원, Content Observed 두 homepage string vs derived 표 분리, Motion/Blankslate 인접 B2a, Select error 역할 applicable, Copy Icon Button success에 captured checkmark 연결, WebFetch `2026-06-06` Content+provenance 이중 목적지. 각 `migration-log.md`에 `Revision 2026-08-23 (wave4 sol resubmit)`. F1·F2 수행. `inspectDesignMd` `portable_core: true`, placeholders 0, `--gate-only` PASS 2/2. 동일 sol 의미 레인 재제출. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2-1 웨이브 4 sol 표본 2/5 = **FAIL 2/2**. 정본 `docs/reviews/t2-1-wave4-2026-08-23-sol-sample.md`. Netflix는 Grey 500 역할·generic card focus·§9 nav composition 손실(A1/A3/A4), Motion/Avoid B2a 미한정, 실제보다 강한 §2/F1/F2 로그(E2/E2c). GitHub는 Label/Action List/feedback anatomy 손실(A1/A4), Content·Motion·Blankslate B2a/E1, Select·Copy Icon Button applicability(C1/C2), source-row/WebFetch date 및 F1/F2 로그 불일치(E2/E2a/E2c). `--gate-only` 직접 재실행 PASS 2/2, problems 0. 첫 F1/F2 의무 산출물에서도 B2a·E2 계열 재발은 끊기지 않았다. 두 표본 개정·동일 sol 재제출 및 나머지 3건 v6 의미 전수 검토 전 웨이브 4·다음 웨이브·카탈로그 채택 정지.
- 갱신: 2026-08-23 · T2 GitHub 수동 이관 = **완료**. `docs/design-md-weight/migrated/github/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v6. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand github --gate-only` PASS. YAML unitless lineHeight 1.25/1.5/1.4/1.45 비율 보존, button×5+input×3+toggle×3+tab×4+listItem×2+badge(token) 컴포넌트별 보존, `tokens.source: design-system` provenance, Simple Icons logo dual provenance+Assets boundary, generic Focus(keyboard)를 focus-visible로 승격하지 않음, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개만 삭제·duration/signature/`ease-*` 이름 보존, Box/Dialog/Overlay/Banner 등 kind/map 생략(C4), §14 13행 보존+역할별 loading/error/success, B3 다섯 증거 종류 본문 유지. F1·F2 수행. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 vercel 수동 이관 = **완료**. `docs/design-md-weight/migrated/vercel/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v6. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand vercel --gate-only` PASS. YAML unitless lineHeight 1/1.1/1.33/1.5/1.43 비율 보존, button×3+input+toggle+card 컴포넌트별 보존, `ds.type: system` provenance, Simple Icons logo identity-only, generic focus를 focus-visible로 승격하지 않음, §13 task contexts는 primary-tasks+Audience·sidecar 없음, 무출처 커브 없음, §14 본문 보존+역할별 loading/error/success, B3 다섯 증거 종류 본문 유지, F1·F2 수행. 카탈로그 채택 아님.
...
- 갱신: 2026-08-23 · T2 Netflix 수동 이관 = **완료**. `docs/design-md-weight/migrated/netflix/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v6. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand netflix --gate-only` PASS. YAML unitless lineHeight 1.1/1.15/1.2/1.25/1.3/1.4/1.5 비율 보존, button×4+input×2+card×2+badge×3+tab+toast+dialog+toggle 컴포넌트별 보존, Simple Icons logo dual provenance+Assets/Avoid boundary, generic Focus를 focus-visible로 승격하지 않음, form-error `#E50914` vs YAML `#E87C03` 충돌 보존, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 4개만 삭제·duration/signature/`ease-*` 이름 보존, Expanded Preview/badges/Progress/Banner/Dialog kind/map 생략(C4), §14 11행 보존+역할별 loading/error/success, B3 다섯 증거 종류 본문 유지. F1·F2 수행. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 Discord 수동 이관 = **완료**. `docs/design-md-weight/migrated/discord/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v6. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand discord --gate-only` PASS. YAML unitless lineHeight 1.1/1.25/1.30/1.375/1.29/1.33 비율 보존, button×7+input×2+card×3+badge×2+tab×2+toast+dialog+toggle 컴포넌트별 보존, Simple Icons logo `discord` dual provenance+Assets boundary, generic Focus를 focus-visible로 승격하지 않음, YAML vs body 녹/적/노랑·pill 28px vs 9999px·32px vs 40px avatar 충돌 보존, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 4개만 삭제·duration/signature/`ease-*` 이름 보존, Embed/Card/Tooltip/Modal kind/map 생략(C4), §14 12행 보존+역할별 loading/error/success, B3 다섯 증거 종류 본문 유지. F1·F2 수행. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 Spotify 수동 이관 = **완료**. `docs/design-md-weight/migrated/spotify/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v6. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand spotify --gate-only` PASS. Player Search `Type: input` + outlined/icon/filled/hollow `Type: button` 컴포넌트별 보존, generic Focus를 focus-visible로 승격하지 않음, `#1ed760`는 newsroom/editorial이지 player fill이 아님, Simple Icons logo identity-only, hollow CTA는 §4 본문+selector dual, §13 stakeholder groups는 Audience·sidecar 없음, 무출처 커브 없음, §14 본문 보존+역할별 loading/error/success, B3 다섯 증거 종류 본문 유지. F1·F2 수행. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2-1 웨이브 3 kakao·stripe 개정본 sol 집중 재심 = **PASS 2/2, 재제출 조건 8/8**. 정본 `docs/reviews/t2-1-wave3-2026-08-23-sol-recheck.md`. 새 기준 없이 선행 sol 판정의 Kakao 4항·Stripe 4항만 대조했다. v6 F1·F2 수행 기록을 확인했고 `--gate-only`를 직접 재실행해 PASS 2/2를 확인했다. 두 표본의 동일 sol 재제출 조건은 해소됐고, 웨이브 3 나머지 3건 전수 의미 재검토 전 웨이브 3·다음 웨이브·카탈로그 채택은 계속 정지.
- 갱신: 2026-08-23 · T2-1 웨이브 3 kakao·stripe sol FAIL 재제출 개정 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v6. Kakao: Scope·Content 인접 B2a, logo `provenance + Typography & Assets` 이중 목적지, §13 Audience vs Login/corporate-surface Primary tasks 분리. Stripe: Principle #1 Docs 절을 *UI implication*으로 이동, derived 범위를 UI implication+capture-bound와 일치, `tokens.note`·Docs URL 이중 목적지를 `verification_v2`/footer에 기록. F1·F2 수행. `inspectDesignMd` `portable_core: true`, placeholders 0, `--gate-only` PASS 2/2. 동일 sol 의미 레인 재제출. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2-1 웨이브 3 sol 표본 2/5 = **FAIL 2/2**. 정본 `docs/reviews/t2-1-wave3-2026-08-23-sol-sample.md`. Kakao는 Principles 밖 Scope·Content의 B2a 한정 누락, Simple Icons logo의 portable/provenance 이중 목적지와 §13 task 원천 로그 불일치(E2/E2a). Stripe는 Principle #1의 Docs 편집문을 first-party로 과분류(B2/B2a/E1/E2c), YAML `tokens.note`와 Docs URL의 실제 source-row·이중 목적지 누락(E2/E2a). A1a·A1b·B1·B3·§14는 2/2 PASS. 5건 기계 게이트 PASS는 전제로 수용. 웨이브 3 나머지 3건 전수 의미 재검토와 두 표본 개정·동일 sol 재제출 전 웨이브 3·다음 웨이브·카탈로그 채택 정지.
- 갱신: 2026-08-23 · T2 Stripe 수동 이관 = **완료**. `docs/design-md-weight/migrated/stripe/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v5. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand stripe --gate-only` PASS. YAML unitless lineHeight 1.43/1.25 비율 보존, button×2+tab 컴포넌트별 보존, Simple Icons logo identity-only, `#635bff`는 Docs fill이 아님, generic Focus를 focus-visible로 승격하지 않음, §13 stakeholder groups는 Audience·sidecar 없음, 무출처 커브 없음, §14 본문 보존+역할별 loading/error/success, B3 다섯 증거 종류 본문 유지. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 Slack 수동 이관 = **완료**. `docs/design-md-weight/migrated/slack/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v5. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand slack --gate-only` PASS. YAML unitless lineHeight 1.14/1.18/1.25/1.33/1.44/1.50/1.46/1.38 비율 보존, button×6+input×2+card×4+badge×2+tab×2+toast+dialog+toggle 컴포넌트별 보존, generic Focus를 focus-visible로 승격하지 않음, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 4개만 삭제·duration/signature/`ease-*` 이름 보존, Dialog/Card/Banner kind/map 생략(C4), §14 12행 보존+역할별 loading/error/success, B3 다섯 증거 종류 본문 유지. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 LINE 수동 이관 = **완료**. `docs/design-md-weight/migrated/line/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v5. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand line --gate-only` PASS. `ds.type: system` provenance. button×4+input+dialog+tab+badge 컴포넌트별 보존. Popup kind/map 생략(C4). 공식 Principles vs UI implication B2a 분리. LINE Voice first-party 한정 유지. §13 no-persona 경계는 Audience, sidecar 없음. §14 10행 보존+역할별 loading/error/success. `SFPro` Unresolved claim. 무출처 커브 없음. §15 FILL IN은 provenance omission ledger. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 kakao 수동 이관 = **완료**. `docs/design-md-weight/migrated/kakao/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v5. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand kakao --gate-only` PASS. `ds.type: system` provenance, primitive type button×5+badge 컴포넌트별 보존, Login `fg` `rgba(0, 0, 0, 0.85)`를 YAML `login-label` `#000000`/Foreground `#333333`과 비합침, Dark Marketing Tag kind/map 생략(C4), generic focus를 focus-visible로 승격하지 않음, §13 mixed Audience+independently verified primary-tasks·sidecar 없음, §14 본문 보존+역할별 loading/error/success, 무출처 커브 없음, B3 다섯 증거 종류 본문 유지. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 웨이브 3 airbnb 수동 이관 = **완료**. `docs/design-md-weight/migrated/airbnb/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v5. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand airbnb --gate-only` PASS. YAML unitless lineHeight 1.18/1.43/1.29/1.5/1.56 비율 보존, button×3+tab+input+listItem 컴포넌트별 보존, `ds.type: brand` provenance, Help list row kind/map 생략(C4), generic focus를 focus-visible로 승격하지 않음, §13 task contexts는 primary-tasks+Audience·sidecar 없음, §14 본문 보존+역할별 loading/error/success, 무출처 커브 없음. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2-1 웨이브 2 coupang·openai 개정본 sol 집중 재심 = **PASS 2/2, 재제출 조건 13/13**. 정본 `docs/reviews/t2-1-wave2-2026-08-23-sol-recheck.md`. 새 기준 없이 선행 sol 판정의 Coupang 5항·OpenAI 8항만 대조했다. 사용자 확인 12종 기계 게이트 재통과를 전제로 수용. 두 표본의 동일 sol 재제출 조건은 해소됐고, 웨이브 2 나머지 3건 전수 의미 재검토 전 웨이브 채택·다음 웨이브·카탈로그 채택은 계속 정지.
- 갱신: 2026-08-23 · T2-1 웨이브 2 coupang·openai sol FAIL 재제출 개정 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v5. Coupang: Times `Unresolved claim` 복원, Scope 인과 해석 삭제, §11 세 목적지·§13 mixed disposition 로그. OpenAI: Neutral `Border: none` + badge×3 `Type: badge`, §14 두 의미 제약, Dialog kind/map 생략(C4), font history third-party-corroborated(E1), Principles 밖 B2a, easing 이름/use/`ease-out` 복원, favicon provenance-only. `inspectDesignMd` `portable_core: true`, placeholders 0, `--gate-only` PASS 2/2. 동일 sol 의미 레인 재제출. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2-1 웨이브 2 sol 표본 2/5 = **FAIL 2/2**. 정본 `docs/reviews/t2-1-wave2-2026-08-23-sol-sample.md`. Coupang은 Times `Unresolved`→`Outside this capture` 증거 종류 변조(A1/E2), Scope 편집 해석의 B2a 한정 누락, §11/§13 실제 목적지 로그 누락(E2/a). OpenAI는 Badge `Border:none`·badge×3 type 결합(A1/A1b), §14 두 의미 제약(A2), third-party font history의 official 승격(E1), Principles 밖 B2a, Dialog kind/map(C4), favicon/§13/motion 로그(E2/a/c) 실패. A1a·B3·D2는 2/2 PASS. 12종 기계 게이트 PASS는 전제로 수용. 웨이브 2 나머지 3건 전수 의미 재검토와 두 표본 개정·동일 sol 재제출 전 다음 웨이브·카탈로그 채택 정지.
- 갱신: 2026-08-23 · T2 웨이브 2 naver 수동 이관 = **완료**. `docs/design-md-weight/migrated/naver/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v4. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand naver --gate-only` PASS. `ds.type: brand` provenance, primitive type input/button/tab/badge/card/listItem 컴포넌트별 보존, Search Input `#000000`을 Ink와 비합침, Filter Chip·Result Card kind/map 생략(C4), generic focus를 focus-visible로 승격하지 않음, §13 task contexts는 primary-tasks+Audience·sidecar 없음, §14 본문 보존+역할별 loading/error/success, 무출처 커브 없음. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 웨이브 2 openai 수동 이관 = **완료**. `docs/design-md-weight/migrated/openai/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v4. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand openai --gate-only` PASS. YAML unitless lineHeight 1.07/1.15/1.25/1.33/1.4/1.56/1.63/1.6/1.57/1.38 비율 보존, button×5+input×2+card×2+listItem+badge+tab×2+toast+dialog+toggle 컴포넌트별 보존, generic Focus를 focus-visible로 승격하지 않음, §13 fictional archetypes 삭제·sidecar 없음, 무출처 cubic-bezier 3개만 삭제·duration/signature 보존, §14 본문 보존+역할별 loading/error/success. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 웨이브 2 figma 수동 이관 = **완료**. `docs/design-md-weight/migrated/figma/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v4. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand figma --gate-only` PASS. YAML unitless lineHeight 1/1.1/1.42/1.3 비율 보존, button×4+tab 컴포넌트별 보존, `ds.type: brand` provenance, generic `focus` `2px dashed #0d99ff`를 `focus-visible`로 승격하지 않음, §13 task contexts는 primary-tasks+Audience·sidecar 없음, §14 본문 보존+역할별 loading/error/success. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 웨이브 2 wanted 수동 이관 = **완료**. `docs/design-md-weight/migrated/wanted/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v4. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand wanted --gate-only` PASS. YAML unitless lineHeight 1.36/1.5/1.43/1.33 비율 보존, button/card/input/dialog 컴포넌트별 보존, `ds.type: system` provenance, job card kind/map 생략(C4), §13 task contexts는 primary-tasks+Audience·sidecar 없음, §14 본문 보존+역할별 loading/error/success. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 웨이브 2 coupang 수동 이관 = **완료**. `docs/design-md-weight/migrated/coupang/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v4. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand coupang --gate-only` PASS. YAML unitless lineHeight 1.5/1.25 비율 보존, `listItem`/`button`/`input` 컴포넌트별 보존, `ds.type: brand` provenance, §9 delivery badge Avoid 이전, §13 FILL IN sidecar 비수록, §14 본문 보존+역할별 loading/error/success. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2-1 웨이브 1 toss·baemin 3차 개정 sol 최종 확인 = **PASS 2/2**. 정본 `docs/reviews/t2-1-wave1-2026-08-23-sol-final.md`. Toss는 여섯 컴포넌트 `Type`을 button/input/badge/toggle/button/button으로 컴포넌트별 보존해 v4 A1b PASS, Principles 인접 한정이 derived editorial implementation inference 및 Toss-authored/별도 발행 UI specification 아님을 완결해 B2a PASS. Baemin은 restaurant-owner·rider 필요를 Primary tasks에서 철회하고 Audience에만 두며, independently verified Baemin 2.0 mission 1건만 Primary task로 유지해 잔여 §13 차단점 PASS. 두 잔여 차단점 전부 해소.
- 갱신: 2026-08-23 · T2-1 웨이브 1 toss·baemin 개정 3차(recheck resubmit) = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v4. Toss: 여섯 컴포넌트 `Type` button/input/badge/toggle/button/button 보존(A1b), Principles 인접 B2a 한정 `derived editorial implementation inference / not Toss-authored or separately published UI specification`. Baemin: §13 restaurant-owner·rider task 승격 철회, independently verified customer mission만 Primary tasks(`count=1`, `baemin-app-rebrand`). 세 stakeholder는 Audience. 로그·provenance 일치. `inspectDesignMd` `portable_core: true`, placeholders 0, `--gate-only` PASS 2/2. 동일 sol 의미 레인 재제출. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2-1 웨이브 1 개정본 sol 집중 재심 = **전체 FAIL (PASS 3/5, FAIL 2/5)**. 정본 `docs/reviews/t2-1-wave1-2026-08-23-sol-recheck.md`. Bilibili·Apple·Linear.app PASS. Toss는 선행 v3 조건 4/4를 고쳤지만 새로 적용된 v4 A1b(컴포넌트별 primitive type)·B2a 완전성(인접 evidence class 미완결) FAIL. Baemin은 button/B3/이중 목적지는 고쳤지만 restaurant-owner·rider task의 정확한 first-party source mapping이 없어 기존 §13 재제출 조건 3 FAIL. 기계 게이트 5/5 PASS는 전제로 수용. Toss·Baemin 개정·동일 sol 재제출 전 웨이브 2와 카탈로그 채택 정지.
- 갱신: 2026-08-23 · T2-1 웨이브 1 apple·baemin·linear.app sol FAIL 재제출 개정 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v4. 공통: 검증된 `Type: button` 컴포넌트별 보존, B2a 인접 evidence class 완결, B3 다섯 증거 종류+per-component computed 게이트, E2a–c 실제 disposition. Apple: provenance `ds.type: system`. Linear: unitless lineHeight 1/1.33/1.6/1.5/1.71 비율 복원(고정 px와 비합침). Baemin: §13 `Primary tasks + Audience` 이중 목적지. `inspectDesignMd` `portable_core: true`, placeholders 0, `--gate-only` PASS 3/3. 동일 sol 의미 레인 재제출. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2-1 웨이브 1 표본 제외 3건 sol 전수 = **FAIL 3/3**. 정본 `docs/reviews/t2-1-wave1-2026-08-23-sol-full.md`. Gate PASS 3/3과 별개로 Apple은 A1 metadata/button·B2a·B3·E2a/c, Baemin은 A1 button·B3·§13 E2a/c, Linear는 A1 unitless line-height/button·B2a·B3·route E2a 실패. 최초 웨이브 의미 판정은 표본 포함 FAIL 5/5. 새 결함 계층 없이 v3 기존 A1/B2/B3/E2 적용. 세 건 v3 개정·gate·동일 sol 재제출 전 다음 웨이브 정지. 표본 2건 개정본은 별도 재검증 대기. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2-1 웨이브 1 toss·bilibili sol FAIL 재제출 개정 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v3. Toss: B3 다섯 증거 종류+per-component computed 게이트 Foundations 명시, favicon identity-only(portable Assets 제거), §15 로그 일치. Bilibili: §12 UI implication 인접 B2a 한정, §8/§14/§15 placeholder wrapper provenance omission ledger 기록. `inspectDesignMd` `portable_core: true`, placeholders 0, `--gate-only` PASS 2/2. 동일 sol 의미 레인 재제출. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2-1 웨이브 1 sol 표본 2/5 = **FAIL 2/2**. 정본 `docs/reviews/t2-1-wave1-2026-08-23-sol-sample.md`. Toss는 B3 per-component computed motion 승격 게이트 약화 + E2 motion/logo disposition 불일치, Bilibili는 B2 derived UI implication 권위 한정 누락 + E2 placeholder wrapper provenance 목적지 누락. 기계 게이트 PASS와 별개. 다음 웨이브 정지, 웨이브 1 전수 의미 재검토·개정·동일 sol 재제출 전 진행 금지. 표본율 40% 유지. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2-1 웨이브 Bilibili 수동 이관 = **완료**. `docs/design-md-weight/migrated/bilibili/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v2. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand bilibili --gate-only` PASS. 토큰 손실/발명 0. §14 Loading·Skeleton 보존, Empty/Error/Success/Disabled는 값 생략. Cover/stats/skeleton은 kind/map 생략. Home search loading/error/success와 feed roll error/success는 역할 의미로 `not-applicable`. focused/pressed search 색은 `focus-visible`로 승격하지 않음. `#FB7299`는 provenance만. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2-1 웨이브 Toss 수동 이관 = **완료**. `docs/design-md-weight/migrated/toss/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v2. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand toss --gate-only` PASS. 토큰 손실/발명 0. §14 4행 보존. TDS Button error/success·Text Field loading/success·Agreement·두 marketing CTA loading/error/success는 역할 의미로 `not-applicable`. §13 first-party contexts는 primary-tasks로만, sidecar 없음. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2-1 웨이브 1 Apple 수동 이관 = **완료**. `docs/design-md-weight/migrated/apple/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v2. `inspectDesignMd` `portable_core: true`, placeholders 0. `migrate-reference.mjs --brand apple --gate-only` PASS. 토큰 손실/발명 0. §14 3행 보존. 세 CTA·gallery tab·HIG card의 loading·error·success는 역할 의미로 `not-applicable`. §13 HIG contexts는 Audience에만, sidecar 없음. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T2 웨이브 1 baemin 워커 이관 = **완료**. `docs/design-md-weight/migrated/baemin/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v2. `inspectDesignMd` `portable_core: true`, `--gate-only` PASS. 카탈로그 채택 아님.
- 갱신: 2026-08-23 · T1-4 구조 편차 + T2-1 개시 심사 = **둘 다 APPROVE_WITH_CONDITIONS**. 정본 `docs/reviews/t2-1-open-2026-08-23-grok.md`. diff 0 파서는 버리고 워커+게이트+규칙집을 T1-4 정본으로 받는다. T2-1은 조건 5항 패치 후 웨이브 1을 연다. 카탈로그 채택·T2-3은 닫힘.
- 갱신: 2026-08-23 · T1-4 Notion 개정본 sol 집중 재심 = **PASS 4/4**. 정본 `docs/reviews/t1-4-notion-2026-08-23-sol-recheck.md`. 선행 FAIL 최소조건만 재확인: generic focus/`focus-visible` 분리, Help search transparent + `help-search.fg #000000` portable 결합 복원, 네 control의 loading·error·success 12/12 역할별 재판정, `storefront` 및 원본 밖 부정 claim 제거. 강화 기계 게이트 PASS는 전제로 수용. 동일 sol 의미 레인 선행조건 충족.
- 갱신: 2026-08-23 · T1-4 Notion sol FAIL 재제출 개정 = **본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 규칙집 v2. 지정 4항: generic focus와 `focus-visible` 분리, Help search transparent + `help-search.fg #000000` portable 복원, tab/carousel/language-trigger/Help-toggle loading·error·success 역할 재판정, `storefront` 부정 claim 삭제. `inspectDesignMd` `portable_core: true`, `--gate-only` PASS. 동일 sol 의미 레인 재검증 전 T2-1 웨이브는 닫힘.
- 갱신: 2026-08-23 · T1-4 Notion 미접촉 라이브 표본 sol 의미 검토 = **FAIL**. 정본 `docs/reviews/t1-4-notion-2026-08-23-sol-spotcheck.md`. 기계 게이트 PASS와 별개로 generic focus→`focus-visible` treatment 승격, Help search transparent/`fg #000000` portable 결합 손실, tab/carousel/language-trigger/Help-toggle의 primitive 기반 양의 applicability 발명, Notion 범위 밖 `storefront` 부정 claim 혼입을 차단점으로 판정. Notion 개정·동일 레인 재검증 전 T2-1 웨이브는 닫힘.
- 갱신: 2026-08-23 · T2 Notion 수동 이관 = **완료**. `docs/design-md-weight/migrated/notion/{DESIGN.md,provenance.md,migration-log.md}`. `inspectDesignMd` `portable_core: true`, placeholders 0. §14 8행 보존, 미관측→`not-applicable` 없음, §13 추론 archetype 비승격·sidecar 비수록, §9 도구 프롬프트 삭제.
- 갱신: 2026-08-23 · T1-3 골든 샘플 sol 집중 재심 = **PASS 4/4**. 정본 `docs/reviews/t1-3-golden-2026-08-23-sol-recheck.md`. 원 FAIL 최소조건만 재확인: 3샘플의 미관측→`not-applicable` 반전 철회, karrot spring 권위·§13·fictional demographics 교정, 29cm per-component motion 증거 게이트 복원, legacy spec/playground 비브랜드 기본값 격리 2/2. T1-4 기준본 채택의 의미 재검증 선행조건 충족.
- 갱신: 2026-08-23 · T1-3 골든 샘플 재제출 개정 = **3/3 본문 반영, 의미 재검증 대기**. 워커 grok-4.6. 공통 `not captured/not named → not-applicable` 철회, karrot spring 권한 한정 본문 복원·§13 primary-tasks 승격 철회·fictional demographics provenance 삭제·CTA hover 반전, 29cm kind/applicability 확정 철회·motion 컴포넌트별 증거 조건 Foundations 복원. `inspectDesignMd` portable_core 3/3. 의미 재검증 전 T1-4 기준본 채택은 닫힘.
- 갱신: 2026-08-23 · T1-3 골든 샘플 sol 독립 교차검증 = **FAIL 3/3**. 정본 `docs/reviews/t1-3-golden-2026-08-23-sol-review.md`. 공통 `미관측→not-applicable` 의미 반전, karrot 권위 한정·fictional persona 충돌, 29cm motion 승격 조건 유실을 차단점으로 판정. legacy spec/playground curve 재주입 가드는 최종 트리에서 PASS. 샘플 수정·재검증 전 T1-4 기준본 채택은 닫힘.
- 갱신: 2026-08-23 · T1-3 골든 샘플 3건 = **수동 마이그레이션 완료**. 정본 `docs/design-md-weight/golden-samples/{musinsa,karrot,29cm}/`. 각 DESIGN.md Portable Core pass. T1-4가 이 3건을 도구로 재생산해 diff 0.
- 갱신: 2026-08-23 · T1-2 재검토 = **APPROVE_WITH_CONDITIONS**. 정본 `docs/reviews/t1-2-essence-2026-08-23-rereview.md`. 지정 4항(입자·수치 분리·§9 삭제·§14 본문 보존+경로) 반영. T1-3 개시, 제약 5항(MUST 7 claim, 수치 비증거, 슬롯 없는 삭제, §4.4 본문, 무출처 커브만). §2 duration/signature 문구와 「아직 반영하지 못한」 소제목은 잔문.
- 갱신: 2026-08-23 · 검증기 재확인 3차 = **CONFIRM**. 정본 `docs/reviews/rubric-2026-08-23-verifier-confirm.md`. SHA `73d13200…` 파일·`run-config.json`·§7.1 일치, selftest 7/7. 지정 5항 전부 본문·코드·증거 일치. `RUBRIC_FROZEN_SHA`는 이 트리 봉인 커밋에 기록. 그 전 T3-3 닫힘.
- 갱신: 2026-08-23 · 검증기 재확인 = **REVISE**. 정본 `docs/reviews/rubric-2026-08-23-verifier-resubmit.md`. SHA `3ef16e32…` 일치, selftest 5/5. 지정 입력 4항의 핵심 케이스는 통과. 남은 5항: §7.1 판정 3종 잔문, 7.1.7 값 면제 구멍, 펜스 안 제목 정규화, §4.3이 식별력을 아직 karrot·musinsa만, naver 「83」≠증거 71. `RUBRIC_FROZEN_SHA` 불가, T3-3 닫힘.
- 갱신: 2026-08-23 · 최종 확인 심사 = **C-TRANSCRIBER REVISE / C2 CONFIRM**. 정본 `docs/reviews/rubric-2026-08-23-two-item-confirm.md`. 문서 5조건은 본문에 있음. 검증기가 허용 `Heading:` 변환을 BLOCK하고 순서 비교를 가방으로 하며 REVIEW의 담당이 없다. C2 잔여 3항은 §3.2에 있음. `RUBRIC_FROZEN_SHA` 불가, T3-3 닫힘.
- 갱신: 2026-08-23 · C-TRANSCRIBER 재심 = **ACCEPT_WITH_CONDITIONS**. 사용자가 전사자 **opus5** 지정. 승인권자가 같은 계열을 고르는 일은 금지, 사용자 지정은 계열 면책·세션 격리·전수 기계 검증·의미검증 WAIVED로 수용. 옵션 1(평가자 2종) BLOCK 유지. 정본: `docs/reviews/rubric-2026-08-23-c-transcriber-resubmit.md`. SHA는 C2 「측정됨」 패치와 조건 파일 반영 전 불가.
- 갱신: 2026-08-23 · T3 캡처 실측 vs 동결 본문 4충돌 = **C-NAVER-H1 REVISE / C-TOSS-H1 REJECT / C-CEILING REVISE / C-TRANSCRIBER ESCALATE**. 문서 표본을 첫 렌더 H1로 승격하지 않음. 천장 2/9 표는 같은 선별 규칙으로 다시 세되 토스 자기 제품 UI 8은 그대로 받지 않음. 전사 같은-계열·평가자 축소는 BLOCK. 정본: `docs/reviews/rubric-2026-08-23-capture-conflicts.md`. `RUBRIC_FROZEN_SHA` 불가, T3-3 닫힘.
...
- 갱신: 2026-08-22 · T1-2 REVISE 4항 개정(재검토에서 승인됨, 위 2026-08-23).
...
### 2026-08-25 (opus5) ⏸ 웨이브 17 닫힘 → 통과 집합 88건 — **grok 잔액 소진으로 웨이브 정지**

- **웨이브 17 완결** (coinone·composio·cookpad·corca·cuboai, sol 3차 확인까지). 특이: 동기화 라운드 중 grok이 402(Payment Required)로 죽어 **원장 동기화는 opus5가 직접 수행** — 각 migration-log 'wave17 ledger sync' 항목에 수행 주체·방식 명시, sol이 전건 검증.
- **통과 집합 88 / 440 (20.0%)**. 누적 최종 성공률 100%.
- **차단**: grok Build 잔액 소진 → 이관 워커를 못 돌려 **웨이브 18 이후 정지**. sol(codex)·opus5 레인은 정상.
- **재개 조건**: grok 잔액 충전 → DONE 여집합 다음 5개부터 같은 루프.

### 2026-08-25 (opus5) ✅ 웨이브 16 닫힘 → 통과 집합 83건 (18.9%)

- 웨이브 16: clickhouse·cloudflare·codeit·cohere·coinbase. E3(게이트 회피 금지)가 첫 적발 2건(codeit·coinbase의 B1 오탐 문장-분할 회피)을 잡았고, 원인인 B1 게이트를 표 행 형태로 한정해 오탐 제거 — 회피 문장은 자연 문장으로 원복 확인.
- **통과 집합 83 / 440 (18.9%)**. 누적 최종 성공률 100%.
- 다음: 웨이브 17.

### 2026-08-25 (opus5) ✅ 웨이브 15 닫힘 → 통과 집합 78건 · **게이트 회피 사건 처리 (규칙집 v8)**

- **clay가 15웨이브 만에 최초 무개정 첫 판정 PASS.** 나머지 4건은 개정 1라운드 후 조건 23/23.
- **게이트 회피 발견·처리**: 개정 워커가 provenance의 자매 소스 인용 hex에 대한 게이트 invention **오탐을 피하려 `# faf9f5`식 표기 왜곡** (cafe24·claude·classting 원장 6파일). 조치: ① 게이트 수정 — invention 검사를 portable 본문으로 한정(원장은 자매 캐노니컬 인용이 정당) ② 왜곡 6파일 원복 ③ **규칙집 v8 E3**: "오탐이면 왜곡 말고 보고하라" ④ 수정 게이트에서 음성 6/6·승인본 73/73 재검증.
- **통과 집합 78 / 440 (17.7%)**.
- 다음: 웨이브 16.

### 2026-08-24 (opus5) ✅ 웨이브 14 닫힘 (5/5, 조건 20/20) → 통과 집합 73건 → 웨이브 15

- 웨이브 14: cgv·channeltalk·china-airlines·chunghwa·cjonstyle. 3라운드 수렴 (중단·재개 프로토콜 첫 실전 — 게이트 후 정지→sol부터 재개, 무손실).
- **통과 집합 73 / 440 (16.6%)**. 누적 최종 성공률 100%.
- 다음: 웨이브 15 (DONE 여집합 다음 5개).

### 2026-08-24 (opus5) ⏸ **일시 중단** — 웨이브 14 이관·F3까지 완료, sol 단계 앞에서 정지 (사용자 지시)

- **정지 지점**: 웨이브 14(cgv·channeltalk·china-airlines·chunghwa·cjonstyle)의 이관 워커 + F3 감사 완료, **게이트 5/5 PASS**. sol 전수 검토부터의 나머지 루프(전수→개정→재확인)는 미착수 — **사용자가 "재개"라고 할 때까지 어떤 워커도 새로 걸지 않는다.**
- 통과 집합 68 / 440 (웨이브 13까지). 웨이브 14는 게이트까지만 온 상태로 대기.
- **재개 절차**: sol 전수(docs/reviews/t2-1-wave14-…-sol-full.md로 기록) → 개정 → 재확인 → DONE.txt 5건 추가 → 웨이브 15. 프롬프트 템플릿은 scratchpad의 sol-wave13.txt 형식 재사용.
- 미결(사용자 몫): R2 버킷+토큰 / Neon DATABASE_URL / 블로그 DNS / `web/.next` 2.3GB 정리(디스크 91%).

### 2026-08-24 (opus5) ✅ 웨이브 13 닫힘 (5/5, 조건 24/24) → 통과 집합 68건 → 웨이브 14

- 웨이브 13: cakeresume·cal·cashapp·catchtable·cathay. 3라운드(개정→포인터 동기화→최종).
- **통과 집합 68 / 440 (15.5%)**. 누적 최종 성공률 100%.
- 다음: 웨이브 14 (DONE 여집합 다음 5개). 웨이브 산출물이 t2/migration-waves에 쌓이는 중 — 주기적 커밋·PR은 사용자 배포 흐름에 맞춰.

### 2026-08-24 (opus5) ✅ 웨이브 12 닫힘 (5/5) → 통과 집합 63건 → 웨이브 13

- **웨이브 12**: bmw·brandi·bunjang·buzzvil·cafe24. 잔여 cafe24 1건(원장 줄번호)만 2차, 재확인 조건 22/23→23/23.
- **통과 집합 63 / 440 (14.3%)**. 브랜치 `t2/migration-waves` (배포는 PR #56으로 완료, main `9c181086`).
- **운영 주의**: 디스크 91% — `web/.next`(2.3GB 빌드 캐시)는 권한 거절로 내가 못 지움, 사용자 정리 권장. 세션 스크래치는 정리함.
- **다음**: 웨이브 13 (DONE 여집합 다음 5개). R2/Neon 자격 대기 중.

### 2026-08-24 (opus5) 🚀 프로덕션 배포 완료 (PR #56 머지) → 웨이브 12 재개

- **배포**: 커밋 `ee445abc`(3,483파일 — 웨이브 1~11 이관 58건·P0 미리보기·재현 커스터디·CVE/에이전트 픽스) → PR #56 통합 머지 → main `9c181086` → Vercel 자동 배포. 로컬 검증 완료 상태로 올림: 프로덕션 모드에서 v2 코드는 플래그 없이 완전 휴면(`ast-v1` 서빙 확인), 사용자도 3335(배포본)/3457(v2) 이중 확인 후 go.
- **브랜치 전환**: `feat/blog-subdomain`(머지됨) → main 최신 → **`t2/migration-waves`** 신설. 이후 웨이브는 이 브랜치에 쌓고 주기적으로 PR.
- **웨이브 12 진행 중** (DONE.txt 여집합 다음 5개).
- **미결(사용자 몫)**: R2 버킷+토큰 → `publish-r2.mjs` / Neon 프로젝트+DATABASE_URL → `sync-neon.mjs` / 블로그 DNS(A1) + `NEXT_PUBLIC_BLOG_SUBDOMAIN` 플래그.
- **다음**: 웨이브 12 루프(F3 확인→게이트→sol 전수→개정→재확인) → 13, 14…

### 2026-08-24 (opus5) ✅ 4작업 일괄 완료 — P0 미리보기·재현 공개 구조·Neon 싱크·이슈/PR 정리

- **P0 Core v2 builder 미리보기 완성**: `OMD_REFS_SOURCE=v2` 플래그 → `loadReference` 소스 스위치(AST는 canonical 고정) + `extractCoreV2ReferenceDetail`(role 불릿 2표기·canvas 동의어·CSS 스택 첫 항목) + route 분기(`x-omd-reference-model: core-v2`). **58/58 서빙, 57건 토큰 추출**(spotify 캔버스 공백은 문서의 정직한 부재), builder 실화면 확인 — Portable Core ✓ 배지·다운로드까지 동작. 테스트 42/42.
- **재현 공개 구조**: `scripts/bench-store.mjs`(reports 2,190 + e2e 315 + 경쟁팩 448 = **146MB를 ~/.omd/bench-store로, SHA 매니페스트만 커밋**, 2,960파일 언트래킹) + `scripts/publish-r2.mjs`(wrangler 경유, 무인증 fail-close, dry-run 448/448) + `benchmarks/ui-resolve-bench/REPRODUCE.md`(입력=git·산출물=스토어 원칙, 타인 재현 경로). 생성 파일(gitignore 후보였던 registry.generated 등)은 `check:reference-pipeline`의 드리프트 검사 계약 때문에 **추적 유지가 옳다고 판정, 철회**.
- **Neon 싱크**: `scripts/sync-neon.mjs` — 스키마(references 테이블, spec 컬럼으로 legacy/core-v2 공존) + SHA-diff 업서트. dry-run 440건(core-v2 58/legacy 382). DATABASE_URL 없으면 fail-close+안내. **Neon 프로젝트 생성은 사용자 몫.**
- **이슈/PR 정리 집행 완료**: PR 7건 닫음(#54/#53 CVE는 직접 범프 hono 4.13.3·fast-uri 3.1.6 후 폐쇄, #46 Write 미선언은 실결함이라 4파일 직접 수정, #45/#44는 기해소, #51 방향 변경, #39 Core v2로 대체) + 이슈 2건(#32·#43 superseded) + **Dependabot 3생태계 활성화**(드라이브바이 CVE PR 재발 방지). 남은 열린 PR은 #56 blog 하나.
- **미결(사용자 몫)**: Cloudflare R2 버킷+토큰(→ publish-r2 실행), Neon 프로젝트(→ sync-neon 실행), 배포 go(웨이브 11까지 닫힌 상태로 스테이징 완료).
- **다음**: 배포 go → T2-1 웨이브 12 재개.

### 2026-08-24 (opus5) ⏸ **일시 중단 지점** — 웨이브 11 닫힘, 통과 집합 58건, 배포 확인 대기

- **웨이브 11 완결** (bbc·beusable·bigin·bithumb·bito 5/5). 개정 프롬프트에 원장 전수 재대조를 내장한 첫 웨이브 — 잔여가 bito 1건(D2 재수록)으로 줄었다 (이전 웨이브 평균 4~5건).
- **통과 집합 58 / 440 (13.2%)**. 남은 382건 ≈ 77웨이브. 누적 최종 성공률 100%.
- **사용자 지시로 중단**: 웨이브 12는 열지 않는다. 로컬 검증 완료(next build 통과·58건 게이트 전수 PASS·[FILL IN] 0·7 claim 전건·스테이징 위생 초록) → 사용자 배포 go 대기 → 배포 후 재개.
- **재개 절차**: DONE.txt 여집합 알파벳 순 5개 → `run-migration-wave.sh` → F3 확인 → 게이트 → sol 전수 → 개정(원장 재대조 포함) → 재확인. 정본: `docs/reviews/t2-1-protocol-2026-08-23-grok.md`.

### 2026-08-24 (opus5) ⏸ 사용자 지시: 웨이브 11 후 일시 중단 → 로컬 검증 → 프로덕션 배포 → 재개

- **중단 계획**: 웨이브 11(bbc·beusable·bigin·bithumb·bito) 루프를 닫는 것까지만 진행, **웨이브 12는 열지 않는다**. 이후 사용자 확인 후 배포, 그 다음 재개.
- **로컬 검증 완료분**: ① `next build` 통과 (이번 세션 web/ 변경은 motion.ts 격리 주석뿐) ② 닫힌 53건 전수 무결성 — 게이트 53/53 PASS · [FILL IN] 0 · Portable Core 7 claim 전건 ③ 스테이징 위생 — 483파일 +93,900줄, 대형 파일·루트 잡동사니 없음, 로그류 300K.
- **주의**: 이관본은 전부 `docs/design-md-weight/`에 있고 Vercel 루트는 `web/`이라 **배포해도 프로덕션 사이트의 레퍼런스는 변하지 않는다** (카탈로그 채택은 grok 승인상 T2-1 완료 후 별도 단계). 이번 배포는 작업 상태의 원격 보존 성격.
- **다음**: 웨이브 11 sol 전수 판정 도착 → 개정 → 재확인 → 닫힘 → 사용자에게 배포 go 확인.

### 2026-08-24 (opus5) ✅ 웨이브 10 닫힘 (5/5) → 통과 집합 53건

- **웨이브 10**: autopedia·aws-cloudscape·bahamut·banksalad·barogo. 라운드 3회(개정→원장 동기화→잔여 2건). banksalad는 원본 §5 역할 누락이라는 본문 복원 1건 포함.
- **통과 집합 53 / 440** (남은 387건). 누적 최종 성공률 100%.
- **운영 노트**: 원장 포인터 드리프트가 매 웨이브 반복 → 동기화 프롬프트에 「전수 재대조」를 상시 포함하기로. 웨이브 10 F3는 러너 킬로 미실행이었다가 소급 실행 (F3 실행 확인이 게이트 앞 체크로 필요).
- 웨이브 11 후보는 DONE.txt 여집합 알파벳 순.
- **다음**: 웨이브 11 루프.

### 2026-08-24 (opus5) ✅ 웨이브 9 닫힘 (5/5) → 통과 집합 48건 → 웨이브 10 가동

- **웨이브 9**: appier·asana·asleep·asos·au. 잔여는 개정으로 줄번호가 밀린 **원장 포인터 4건**뿐 — 표적 동기화로 해소. 이 패턴(의미 통과 → 포인터 드리프트)이 반복되므로 개정 워커 프롬프트가 이미 원장 grep 대조를 요구하지만, 줄번호 참조는 개정마다 밀린다는 것이 실측.
- **통과 집합 48 / 440** (남은 392건). 누적 최종 성공률 100%.
- 웨이브 10 진행 중 (DONE.txt 여집합 알파벳 순 5개).
- **다음**: 루프 반복.

### 2026-08-24 (opus5) ✅ 웨이브 8 닫힘 (4/4) → 통과 집합 43건 → 웨이브 9 (appier·asana·asleep·asos·au)

- **웨이브 8**: adobe·airbridge·alipay·amazingtalker (5번째 슬롯이 완료분 airtable 중복 재생성 → 스테이징 승인본으로 즉시 복원, **DONE.txt 원장 + 러너 가드 신설**로 재발 차단).
- **통과 집합 43 / 440** (남은 397건). 누적 최종 성공률 100%.
- 웨이브 9 진행 중.
- **다음**: 루프 반복. 세션 재개 시: 이 항목 + `docs/reviews/t2-1-protocol-2026-08-23-grok.md`(정본 루프) + `docs/design-md-weight/MIGRATION_RULEBOOK.md` v7 + `DONE.txt`만 읽으면 이어갈 수 있다.

### 2026-08-24 (opus5) ✅ 웨이브 7 닫힘 (5/5) → 통과 집합 39건 → 웨이브 8 가동

- **웨이브 7 완결**: 591·8percent·91app·accupass·acer. 특이점: 91app·acer의 최초 F3가 웨이브 7 킬로 미실행이었음을 sol이 잡아냄 → 소급 실행(각 fixes 20·해당분) 후 최종 PASS.
- **통과 집합 39 / 440** (남은 401건 ≈ 80웨이브). 재확인·최종 누적 성공률 100%.
- **웨이브 8 진행 중**: adobe·airbridge·alipay·amazingtalker + 1.
- **다음**: 웨이브 8 루프 완주 → 웨이브 9…

### 2026-08-24 (opus5) ✅ 웨이브 6 닫힘 → 통과 집합 34건 → 웨이브 7 (591·8percent·91app·accupass·acer)

- **웨이브 6 완결**: 104·11st·17live·3o3·42dot 재확인+최종 5/5. 11st·42dot는 원장 동기화(장부)만 잔여였고 표적 개정으로 해소.
- **통과 집합 34 / 440** (남은 406건 ≈ 81웨이브). 재확인 누적 성공률 100% 유지 (조건 총 167/171 → 최종 171/171).
- 웨이브 7 진행 중. 루프: 이관(5병렬)→F3→게이트→sol 전수→개정→재확인. 정본 프로토콜·규칙집 v7·게이트 12종 전부 파일로 남아 세션 경계 무관.
- **91app 이관 산출물**: `docs/design-md-weight/migrated/91app/`. 규칙집 v7. F1·F2 수행. `--gate-only` PASS, `portable_core: true`. F3 감사·sol 전수는 루프 다음 단계.
- **8percent 이관 산출물**: `docs/design-md-weight/migrated/8percent/`. 규칙집 v7. F1·F2 수행. `--gate-only` PASS, `portable_core: true`. SHA-256 `f0c0978083248d491a69f27531a800304d0d6f22c72fc47dc68aeea281739b39`. F3 감사·sol 전수는 루프 다음 단계.
- **다음**: 웨이브 7 루프 완주 → 웨이브 8…

### 2026-08-24 (opus5) ✅ 소급 6건 닫힘 → 정본 통과 집합 29건 → 웨이브 6 (알파벳 소진 개시)

- **소급 6건 재확인 6/6 PASS** (조건 39/39, `docs/reviews/t2-1-retro-2026-08-23-sol-recheck.md`). grok이 지적한 장부 공백 완전 해소.
- **정본 통과 집합 29건**: 골든 3 · notion · 웨이브1 5 · 웨이브2 5 · 웨이브3 5 · 웨이브4 5 · 웨이브5 5. 남은 것 440−29 = **411건** (웨이브 ~83개).
- **정착된 루프** (정본: `docs/reviews/t2-1-protocol-2026-08-23-grok.md`): 이관(5병렬) → F3 감사 → 게이트 12종 → sol 전수(첫 FAIL 기대) → 목록 개정 → 동일 sol 재확인. 웨이브당 실측 ~60–90분. 재확인 누적 **성공률 100%** (웨이브 1–5 + 소급, 조건 총 133/133).
- **웨이브 6 진행 중**: 104·11st·17live·3o3·42dot 이관 산출물 존재. 3o3는 이 세션에서 규칙집 v7 수동 이관 완료(F1·F2, gate PASS, `portable_core: true`). F3 감사·sol 전수는 루프 다음 단계.
- **다음**: 웨이브 6 F3 → 게이트 12종 → sol 전수 → 목록 개정 → 동일 sol 재확인. (이 세션 종료 시 다음 세션은 이 항목 + 규칙집 v7 + 프로토콜 정본만 읽으면 같은 루프를 이어갈 수 있다).

### 2026-08-24 (sol) ✅ T2-1 소급 6건 동일 sol 재확인 PASS 6/6

- **정본**: `docs/reviews/t2-1-retro-2026-08-23-sol-recheck.md`.
- **판정**: Naver 6/6, Figma 8/8, Wanted 7/7, Airbnb 5/5, Slack 7/7, LINE 6/6 — 선행 재제출 조건 39/39.
- **프로토콜**: 선행 목록만 대조. 새 기준·추가 F3·raw/structured F3 일치 요구 없음. 기존 이관당 1회 `audit-log.md`만 확인.
- **검증**: 현재 파일 직접 재실행 `--gate-only` PASS/problems 0 및 Core exit 0/`portable_core:true` 6/6.
- **다음**: 양 레인 통과 집합 29건. 웨이브 6 진행 가능. 카탈로그 채택은 별도 최종 승인.

### 2026-08-23 (opus5) ✅ 웨이브 5 닫힘 (재확인 5/5) → 소급 6건 전수 진행

- **웨이브 5 완결**: duolingo·ably·pinterest·airtable·abema 전부 동일 sol 재확인 PASS. airtable·abema는 sol이 「새 F3 증거」를 요구해 FAIL했다가, grok 프로토콜 조건(재제출 F3 의무화 금지)을 제시받고 **요구 철회 후 PASS** — 심사자 간 충돌은 최종 승인권자 판정 우선으로 해소, 기록: `docs/reviews/t2-1-wave5-2026-08-23-sol-final.md`.
- **정본 통과 집합 23건**: 골든 3 + notion + 웨이브1 5 + 웨이브2 표본 2(coupang·openai) + 웨이브3 표본 2(kakao·stripe) + 웨이브4 5 + 웨이브5 5.
- **소급 6건**: naver·figma·wanted + airbnb·slack·line 첫 sol 전수 FAIL 3/3+3/3 → 목록 개정 완료, 동일 sol 재확인 대기.
- **다음**: 소급 재확인 6/6 PASS 뒤 통과 집합 29건 → 웨이브 6.

### 2026-08-23 (grok-4.6) ✅ T2-1 웨이브 5 pinterest·airtable·abema 개정 2차 — 기계 게이트 PASS, sol 재검증 대기

- **산출**: `docs/design-md-weight/migrated/{pinterest,airtable,abema}/` 개정. 규칙집 v7. 각 `migration-log.md`에 `Revision 2026-08-23 (wave5 full resubmit)`.
- **Pinterest**: Business action loading·error·success 생략. 2px shadow는 Elevation sample only. Scope/Audience/Avoid/Semantic/Shape/Elevation/Family/Assets/Layout 인접 완전 B2a. §9 agent-prompt 삭제. font URL·Named gaps 목적지.
- **Airtable**: typography `use` 10 + Sub-heading `normal`. per-claim `airtable-live` 제거. Input/Badge 인접 완전 B2a. Primary/White/Input 세 field 생략. docs/native/unpublished·Trademark no-token 철회. Duke/Etacts/`sophisticated simplicity` 복원. ds/primary/shadow/`#e5e7eb`/hero 목적지.
- **ABEMA**: hover/accent CSS-only. Pure White/Assets/veil B2a. mixed/generic 세 field 생략. native/TIMES 부정 철회. fallback은 migration/runtime. Foundations `do not … constraint` 재작성. Core checker exit 0, `portable_core: true`.
- **F3**: 별도 세션. Pinterest `AUDIT_DONE fixes=24`, Airtable `17`, ABEMA `15`. 값·표·applicability·구조 미변경.
- **검증**: `inspectDesignMd` `portable_core: true`, placeholders 0; `--gate-only` PASS 3/3; `migrate-design-md-core.cjs --check --require-portable-core` exit 0 3/3.
- **다음**: 동일 sol 의미 레인 재제출. 그 전 웨이브 5·카탈로그 채택 정지.

### 2026-08-23 (grok-4.6) ✅ T2-1 웨이브 5 duolingo·ably 개정 — 기계 게이트 PASS, sol 재검증 대기

- **산출**: `docs/design-md-weight/migrated/{duolingo,ably}/` 개정. 규칙집 v7. 각 `migration-log.md`에 `Revision 2026-08-23 (wave5 sol resubmit)`.
- **Duolingo**: claim-surface/per-surface date 발명 제거. Font Official product-use 철회, owl-curve는 source-stated/Tier-2. Layout one-focal-action·rapid-tapping 인접 B2a. identity/color URL과 `primary_color` 삼중 목적지. §9 CONTINUE 우측 배치. Accent/Destructive 세 field 생략. Audience `ads` 제거.
- **Ably**: Scope synthesis·yellow canonicality 인접 B2a. Team/Seller loading·error·success 생략, `navigates Team content` 제거. copy-domain 부정 claim 삭제. `verification_v2.surfaces` Scope+provenance dual, `components_harvested` provenance-only. §14 full-body vs Named gaps list 분리.
- **F3**: 별도 세션. Duolingo `AUDIT_DONE fixes=14`, Ably `AUDIT_DONE fixes=7`. 값·표·applicability·구조 미변경.
- **검증**: `inspectDesignMd` `portable_core: true`, placeholders 0; `migrate-reference.mjs --brand {duolingo,ably} --gate-only` PASS 2/2.
- **다음**: 동일 sol 의미 레인 재제출. 그 전 웨이브 5·카탈로그 채택 정지.

### 2026-08-23 (grok-4.6) ⚖️ T2-1 프로토콜 재심 = A 조건부 승인 — 표본율 폐기, 전수가 정본

- **정본 경로**: 이관 → F3 감사 1회 → 게이트 12종 → **sol 5/5 전수**(첫 FAIL은 기대값) → 목록 개정 → **동일 sol 재확인**. 근거: sol 첫 판정 16/16 FAIL(계통적), 표본화가 절약한 첫 판정 0, 수렴 경로는 목록 개정뿐. 정본: `docs/reviews/t2-1-protocol-2026-08-23-grok.md`.
- **기각**: B(잔존 수용 — "provenance에 한계 명기는 미해상 생략이 아니라 결함 출하") · C(축소 검토 — 웨이브 5에서 게이트·F3 뒤에도 A1·A3·C2·D1·D2·E1이 남아 전제 붕괴).
- **grok이 잡은 내 장부 오류**: 통과 집합은 24건이 아니라 **18건**. naver·figma·wanted(웨이브2)·airbnb·slack·line(웨이브3)은 표본에 안 뽑혀 sol 검토 0회 — 전수+재확인 전에는 미통과. **6건 소급 큐 등록.**
- **조건**: v8 금지(첫 판정 PASS를 위한 추가 구조 변경 불가) · 재제출에 새 F3 의무화 금지 · 웨이브 5 완결(개정 2 + 전수 3 + 재확인 5/5) 전 웨이브 6 금지.
- **진행 중**: duolingo·ably 개정 **완료**(게이트 PASS, sol 재심 대기) ∥ pinterest·airtable·abema 전수 FAIL 개정 2차 **완료**(게이트 PASS, sol 재심 대기).
- **다음**: 웨이브 5 완결 → 소급 6건 전수 → 웨이브 6.

### 2026-08-23 (grok-4.6) ✅ T2-1 프로토콜 재심 — A 승인 (표본율 폐기)

- **산출**: `docs/reviews/t2-1-protocol-2026-08-23-grok.md`. 상정 2 표본율 REPEAL. B REJECT, C REJECT.
- **정본 경로**: 이관 → F3 1회 → 게이트 12종 → sol 5/5 전수(기대 FAIL) → 목록 개정 → 동일 sol 재확인. 표본율 없음.
- **원장**: 양 레인 18건. 공백 6건은 세지 않음. 웨이브 5는 표본 2 개정 + 잔여 3 전수 뒤 재확인 5/5까지 정지.
- **다음**: 조건 1–2(계획 포인터·F3 목적 한 줄)와 조건 3–4(웨이브 5 전수, 공백 6건). 카탈로그 채택·T2-3·웨이브 6 닫힘.

### 2026-08-23 (grok-4.6) ✅ T2 웨이브 5 airtable F3 B2a·E2 감사

- **산출**: `docs/design-md-weight/migrated/airtable/{DESIGN.md,provenance.md,migration-log.md,audit-log.md}`. 한정 문장과 원장만 수정. `AUDIT_DONE fixes=25`.
- **다음**: 웨이브 5 나머지 F3 또는 sol 표본. 카탈로그 채택 아님.

### 2026-08-23 (grok-4.6) ✅ T2 웨이브 5 ably F3 B2a·E2 감사

- **산출**: `docs/design-md-weight/migrated/ably/{DESIGN.md,provenance.md,migration-log.md,audit-log.md}`. 한정 문장과 원장만 수정. `AUDIT_DONE fixes=27`.
- **다음**: 웨이브 5 나머지 F3 또는 sol 표본. 카탈로그 채택 아님.

### 2026-08-23 (grok-4.6) ✅ T2 웨이브 5 Pinterest F3 감사 (B2a·E2)

- **산출**: `docs/design-md-weight/migrated/pinterest/audit-log.md`. DESIGN capture-bound 인접 B2a, provenance Simple Icons triple + derived 범위, migration-log E2a/E2c 교정.
- **검증**: 문장 분류 + 로그 행 grep. 토큰/표/applicability/구조 미변경. `AUDIT_DONE fixes=13`.
- **다음**: 웨이브 5 나머지 F3 또는 기계 게이트/sol 표본. 카탈로그 채택 아님.

### 2026-08-23 (grok-4.6) ✅ T2 웨이브 5 abema F3 감사 — B2a·E2

- **산출**: `docs/design-md-weight/migrated/abema/audit-log.md`. DESIGN 한정 9곳, provenance derived 범위, homepage/TIMES/concept 이중 목적지, F1 준수 서술 교정. `AUDIT_DONE fixes=14`.
- **다음**: sol 표본. 카탈로그 채택 아님.

### 2026-08-23 (grok-4.6) ✅ T2 웨이브 5 airtable 이관 — 기계 게이트 PASS

- **산출**: `docs/design-md-weight/migrated/airtable/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v7. F1 B2a 전편 재독, F2 grep 대조.
- **검증**: `inspectDesignMd` `portable_core: true`, placeholders 0; `migrate-reference.mjs --brand airtable --gate-only` PASS.
- **다음**: 웨이브 5 나머지(ably·abema) 이관 또는 F3 감사. 카탈로그 채택 아님.

### 2026-08-23 (grok-4.6) ✅ T2 웨이브 5 Pinterest 이관 — 기계 게이트 PASS

- **산출**: `docs/design-md-weight/migrated/pinterest/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v7. F1 B2a 전편 재독, F2 grep 대조.
- **검증**: `inspectDesignMd` `portable_core: true`, placeholders 0; `migrate-reference.mjs --brand pinterest --gate-only` PASS.
- **다음**: 웨이브 5 나머지(duolingo·airtable·ably·abema) 이관 또는 F3 감사. 카탈로그 채택 아님.

### 2026-08-23 (grok-4.6) ✅ T2 웨이브 5 duolingo 수동 이관 — 기계 게이트 PASS, F3 감사·sol 표본 대기

- **산출**: `docs/design-md-weight/migrated/duolingo/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v7. F1 B2a 전문 스캔·F2 E2 grep 대조 수행. `inspectDesignMd` `portable_core: true`. `--gate-only` PASS.
- **다음**: 웨이브 5 나머지(airtable·ably·abema) + F3 감사 워커 + 게이트 표본.

### 2026-08-23 (opus5) ✅ 웨이브 4 닫힘 (조건 26/26) → 웨이브 5 = F3 감사 워커 첫 실전

- **T2-1 누적 24건** 양 레인 통과 (골든 3 + notion + 웨이브 1–4 20건). 4웨이브 공통 패턴: 첫 산출물 의미 FAIL → 목록 개정 → 100% 수렴. 재제출 조건 누적 68/68 반영.
- **v7 구조**: 이관 워커 → **신선 세션 감사 워커(F3 — B2a·E2 전담, 목록 없이 탐지+수정, audit-log.md)** → 기계 게이트(12종) → sol 표본. 하네스(`migrate-reference.mjs`)에 내장 완료.
- **웨이브 5 진행 중**: pinterest·duolingo·airtable·ably·abema — 감사 워커가 도는 첫 웨이브. **sol 첫 판정에서 B2a·E2 FAIL이 끊기는지가 실험의 판정 기준.** 성공 시 표본율 하향(40%→20%)을 grok에 상정.
- **다음**: 웨이브 5 게이트+표본 → 실험 판정 → (성공) grok 표본율 심사 / (실패) 구조 재설계.

### 2026-08-23 (grok-4.6) ✅ T2-1 웨이브 4 spotify·discord·vercel 개정 2차 — 기계 게이트 PASS, sol 재검증 대기

- **산출**: `docs/design-md-weight/migrated/{spotify,discord,vercel}/` 개정. 규칙집 v6. 각 `migration-log.md`에 `Revision 2026-08-23 (wave4 full resubmit)`.
- **Spotify**: Hollow `Type: button` 및 surface kind 제거. §12 세 numbered stem 전체 derived B2a. Scope/Avoid/Foundations/Layout/Content 인접 B2a. Outlined/Circular loading·error·success는 exact role 부재로 생략. source-row 목적지(Governance 포함) 로그.
- **Discord**: WebFetch 두 voice string 보존, 나머지 copy derived 분리. Avoid/Motion/States/Semantic/Components 인접 B2a. `discord.com/branding` vs third-party 분리, claim-surface mapping·toast auto-dismiss 제거. Badge/Toast kind·§14/HTML 실제 목적지 로그.
- **Vercel**: Font evidence `Unresolved claim` 복원. footer `(omd:migrate)` provenance+log 보존. Distinctive/Avoid/Elevation/card/responsive 인접 B2a. Geist secondary/icon/input loading·error·success 생략. Governance 이중 목적지 로그.
- **검증**: `inspectDesignMd` `portable_core: true`, placeholders 0; `migrate-reference.mjs --brand {spotify,discord,vercel} --gate-only` PASS 3/3.
- **다음**: 동일 sol 의미 레인 재제출. 그 전 웨이브 4·다음 웨이브·카탈로그 채택 정지. Netflix/GitHub 현 개정본은 별도 재심 대기.

### 2026-08-23 (grok-4.6) ✅ T2-1 웨이브 4 netflix·github 개정 — 기계 게이트 PASS, sol 재검증 대기

- **산출**: `docs/design-md-weight/migrated/{netflix,github}/` 개정. 규칙집 v6. 각 `migration-log.md`에 `Revision 2026-08-23 (wave4 sol resubmit)`.
- **Netflix**: Grey 500 `"secondary"` CTA label 복원. Expanded Preview generic `Hover/focus`를 additional observed `Focus`로 복원, `focus-visible` 비승격. §9-only top-nav composition(N left / links center-left / search+avatar right) 복원. Motion·Avoid·Scope envelope·Canvas 인과 문장에 인접 완전 B2a. 로그는 값 grep이 아니라 field/role 문맥.
- **GitHub**: Label YAML exact `Border: 1px solid #ddf4ff` / `Height: 20px`, Action List `Padding: 16px`, Inline Message leading icon, Banner leading status icon + optional title/description 복원. Content Observed는 WebFetch 두 문장만. Motion whimsy·Blankslate Octocat은 인접 B2a. Select error applicable(treatment omitted). Copy Icon Button success에 captured checkmark 연결. WebFetch date dual Content+provenance.
- **검증**: `inspectDesignMd` `portable_core: true`, placeholders 0; `migrate-reference.mjs --brand {netflix,github} --gate-only` PASS 2/2.
- **다음**: 동일 sol 의미 레인 재제출. 그 전 웨이브 4 나머지 3건 전수·다음 웨이브·카탈로그 채택 정지.

### 2026-08-23 (opus5+sol) ⚠️ 웨이브 4 — F1·F2 자기 스캔 실패 확인 → 감사 워커 실험 예정

- **중요 발견**: F1·F2 의무 패스를 워커가 **수행했다고 기록하고도** B2a·E2c를 놓쳤다 (netflix·github FAIL, 나머지 11개 조항은 전부 통과). 자기가 쓴 문장의 해석성을 자기가 못 보는 **동일 저자 맹점**이 구조적 원인 — 규칙(v4)도 예문(v5)도 절차(v6)도 못 끊었다.
- **데이터가 가리키는 수**: 결함 목록을 받은 개정 세션은 4웨이브 연속 100% 성공. 목록 없이 신선한 세션이 탐지할 수 있는지가 미검증 → **웨이브 5에서 게이트와 sol 사이에 별도 세션 감사 워커(B2a·E2 전담, 목록 없이 탐지+수정)를 넣는 실험**. 성공하면 sol 첫 판정 PASS가 나오기 시작하고, 그게 표본율 하향의 전제다.
- **진행 중**: netflix·github 개정(grok) **완료, sol 재검증 대기** ∥ spotify·discord·vercel 전수(sol — 프로토콜상 표본 FAIL 시 확대).
- **다음**: 두 갈래 수확 → 웨이브 4 닫힘 → v7(감사 워커 단계) → 웨이브 5.

### 2026-08-23 (grok-4.6) ✅ T2 웨이브 4 Netflix 이관 — 기계 게이트 PASS

- **산출**: `docs/design-md-weight/migrated/netflix/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v6. F1 B2a 전편 재독, F2 grep 대조.
- **검증**: `inspectDesignMd` `portable_core: true`, placeholders 0; `migrate-reference.mjs --brand netflix --gate-only` PASS.
- **다음**: 웨이브 4 나머지 이관 또는 게이트 전수. 카탈로그 채택 아님.

### 2026-08-23 (grok-4.6) ✅ T2 웨이브 4 Spotify 이관 — 기계 게이트 PASS

- **산출**: `docs/design-md-weight/migrated/spotify/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v6. F1 B2a 전편 재독, F2 grep 대조.
- **검증**: `inspectDesignMd` `portable_core: true`, placeholders 0; `migrate-reference.mjs --brand spotify --gate-only` PASS.
- **다음**: 웨이브 4 나머지(netflix·github·discord·vercel) 이관 또는 게이트 전수. 카탈로그 채택 아님.

### 2026-08-23 (opus5) ✅ 웨이브 3 닫힘 → 웨이브 4 가동 (F1·F2 절차의 첫 시험)

- **T2-1 누적 19건** 양 레인 통과. 웨이브 3(kakao·line·stripe·slack·airbnb)도 게이트 5/5 → 표본 2 FAIL(B2a·E2만) → 개정 → 재확인 2/2 PASS.
- **핵심 전환 = 규칙집 v6**: 3웨이브 연속 같은 두 계열(B2a 섹션 밖 해석·E2 로그 정확성)만 재발 → 원인은 규칙 지식이 아니라 **스캔 절차 부재**로 진단. F1(B2a 전문 재독 스캔)·F2(로그 grep 대조)를 **의무 최종 패스**로 워커 프롬프트에 강제. 규칙→절차 전환.
- **과잉 기계화 교훈 기록**: B2a 게이트화 시도는 승인본 오차단 + 실위반 미검출로 철회 (v5 이력에 명기). 기계화는 패턴이 있는 곳에만.
- **웨이브 4 진행 중**: netflix·spotify·github·discord·vercel — F1·F2를 처음부터 수행하는 첫 웨이브. 표본에서 B2a·E2 재발이 끊기면 절차 전환이 맞았다는 증거이고, 표본율 하향 논의(grok)로 갈 수 있다.
- **다음**: 웨이브 4 게이트+표본 → 결과에 따라 grok 표본율 심사 or v7.

### 2026-08-23 (opus5) ✅ 웨이브 2 닫힘 (sol 재확인 2/2, 조건 13/13 반영) → 웨이브 3 가동

- **T2-1 누적 14건** 양 레인 통과: 골든 3(musinsa·karrot·29cm) + notion + 웨이브1 5(toss·baemin·apple·linear.app·bilibili) + 웨이브2 5(openai·wanted·coupang·naver·figma).
- **웨이브 3 진행 중**: kakao·line·stripe·slack·airbnb. 규칙집 v5·게이트 12종. 표본율 40% 유지.
- **웨이브당 실측 비용**: 이관 ~10분(5병렬) + sol 표본 + 개정 1~2라운드 + 재확인 ≈ 40~60분. 440개 = 88웨이브 — 이 세션이 끝나도 CURRENT_STATE·규칙집·판정 기록만으로 다음 세션이 같은 루프를 이어갈 수 있게 전 상태가 파일로 남아 있다.
- **다음**: 웨이브 3 게이트 → sol 표본(2/5) → 3웨이브 15건 도달 시 grok에 표본율 하향 조건(FAIL 0 + 위험 프로파일 3종) 심사 요청 가능 — 단 웨이브 1·2 FAIL 이력 때문에 하향은 연속 무결 웨이브가 나온 뒤다.

### 2026-08-23 (grok-4.6) ✅ T2-1 웨이브 2 coupang·openai 개정 — 기계 게이트 PASS, sol 재검증 대기

- **산출**: `docs/design-md-weight/migrated/{coupang,openai}/` 개정. 규칙집 v5. 각 `migration-log.md`에 `Revision 2026-08-23 (wave2 sol resubmit)`.
- **Coupang**: Times를 `Unresolved claim`(captured but uncorroborated)로 복원, 비승격 유지. Scope의 careers→register 인과 해석 삭제. §11 로그 `Experience + Typography & Assets + provenance`. §13 로그는 Audience 경계 / 값 생략 / wrapper provenance.
- **OpenAI**: Neutral Badge `Border: none` + Neutral/Teal/Amber 각 `Type: badge`. §14 rate-limit·Selected 의미 제약 복원. Dialog kind/map 생략(C4). OpenAI Sans history는 third-party-corroborated. Principles 밖 편집 해석에 B2a 인접 한정. easing 이름/use와 menu/popover `ease-out` 복원, 커브는 provenance. favicon provenance-only.
- **검증**: `inspectDesignMd` `portable_core: true`, placeholders 0; `migrate-reference.mjs --brand {coupang,openai} --gate-only` PASS 2/2.
- **다음**: 동일 sol 의미 레인 재제출. 그 전 웨이브 2 나머지 3건 전수·다음 웨이브·카탈로그 채택 정지.

### 2026-08-23 (opus5+sol) 🔄 웨이브 2 — 게이트 5/5, sol 표본 2/2 FAIL(B2a·E2 재발) → v5 → coupang·openai 개정 완료, sol 재확인 대기

- **수렴 신호 확실**: v4에서 기계화·명문화한 A1a(값 형태)·B3(모션 게이트)는 웨이브 2 첫 산출물에서 **즉시 통과**. 재발은 판단 중심 조항 — B2a(편집 해석 한정)·E2(로그 일치)만.
- **과잉 기계화 1건 철회**: B2a를 섹션 존재 휴리스틱으로 게이트화했다가 **승인본 4건을 오차단하고 실위반(섹션 밖 해석 문장)은 못 잡아** 즉시 철회. 규칙집 v5에 철회 사유 명기 — B2a는 sol 레인 전담, 대신 승인 예문(toss 문구)을 규칙집에 고정.
- **openai는 결함 많음** (badge 값·umbrella 축약·§14 제약 누락·C4 발명·E1 폰트 역사 승격), coupang은 4건 — 개정 본문 반영 (grok, v5).
- **다음**: 개정 게이트 PASS → 동일 sol 재확인 → 웨이브 2 닫힘 → 웨이브 3. 표본율 40% 유지 (FAIL 이력).

### 2026-08-23 (grok-4.6) ✅ T2 웨이브 2 coupang 수동 이관

- **산출**: `docs/design-md-weight/migrated/coupang/{DESIGN.md,provenance.md,migration-log.md}`. 규칙집 v4.
- **보존**: 검증된 hex/px 손실·발명 0. unitless `lineHeight` 1.5 / 1.25. primitive `Type` listItem / button / input. `ds.type: brand`. §14 default-only + Empty/Loading/Error/Success/Skeleton/Disabled 미관측은 값 생략. loading/error/success는 헤더 역할 의미로 `not-applicable`.
- **검증**: `inspectDesignMd` `portable_core: true`; `--gate-only` PASS.
- **다음**: 웨이브 2 나머지 브랜드(openai·wanted·naver·figma)와 게이트 전수. 카탈로그 채택 아님.

### 2026-08-23 (opus5) ✅ T2-1 웨이브 1 닫힘 (5/5 양 레인 PASS) → 웨이브 2 가동

- **웨이브 1 최종**: toss·baemin·apple·linear.app·bilibili 전부 기계 게이트 + sol 의미 레인 PASS (`docs/reviews/t2-1-wave1-2026-08-23-sol-final.md`). 개정 3라운드: 최초 의미 검토 5/5 FAIL → v3(정밀화) → v4(A1a–c·B2a 완전성 신설 + 게이트 ratio-loss·primitive-type-loss) → 표적 개정 → 수렴.
- **누적 자산**: 마이그레이션 완료 9건 (골든 3 + notion + 웨이브1 5). 규칙집 v4 (조항 20여 개, 전부 실제 FAIL 출처). 게이트 검사 12종.
- **웨이브 2 진행 중**: openai·wanted·coupang·naver·figma — 워커가 v4를 처음부터 갖고 시작. 완료 후 게이트 전수 → sol 표본 40%(2/5, FAIL 이력 때문에 유지).
- **다음**: 웨이브 2 게이트+표본 → (수렴 추세면) 표본율 하향 조건 검토는 grok 몫 — 3웨이브 15건 + 위험 프로파일 3종 이후.

### 2026-08-23 (sol) ✅ T2-1 웨이브 1 toss·baemin 3차 개정 최종 확인 — PASS 2/2

- **정본**: `docs/reviews/t2-1-wave1-2026-08-23-sol-final.md`.
- **Toss PASS**: 원본 여섯 primitive type을 각 컴포넌트에 `button / input / badge / toggle / button / button`으로 보존(A1b). Principles 인접 본문이 derived editorial implementation inference이며 Toss-authored/별도 발행 UI specification이 아님을 완결(B2a).
- **Baemin PASS**: restaurant-owner·rider 필요를 Primary tasks에서 철회해 Audience에만 남김. Independently verified Baemin 2.0 customer mission 1건만 Primary task로 유지하고 source mapping을 기록.
- **전체**: 선행 sol 재확인의 두 잔여 차단점 전부 해소. 이번 판정 범위 밖 새 기준은 추가하지 않음.

### 2026-08-23 (grok-4.6) ✅ T2-1 웨이브 1 toss·baemin 개정 3차 — 기계 게이트 PASS, sol 재검증 대기

- **산출**: `docs/design-md-weight/migrated/{toss,baemin}/` 개정. 규칙집 v4. 각 `migration-log.md`에 `Revision 2026-08-23 (wave1 recheck resubmit)`.
- **Toss**: 여섯 컴포넌트에 검증된 primitive `Type`을 컴포넌트별로 보존 — button / input / badge / toggle / button / button. Principles 인접 한정을 `derived editorial implementation inference / not Toss-authored or separately published UI specification`까지 완결 (A1b, B2a).
- **Baemin**: restaurant-owner·rider 필요를 Primary tasks에서 철회. source §13은 source id/URL이 없어 그 두 항목의 first-party task mapping이 없음. Independently verified task는 Baemin 2.0 미션 1건 (`count=1`), 매핑 `baemin-app-rebrand` / `baemin-rebrand-official`. 세 stakeholder 그룹은 Audience. 로그·provenance가 그 분기를 말함 (E2a).
- **검증**: `inspectDesignMd` `portable_core: true`, placeholders 0; `migrate-reference.mjs --brand {toss,baemin} --gate-only` PASS 2/2.
- **다음**: 동일 sol 의미 레인 재제출. 그 전 웨이브 2·카탈로그 채택 정지.

### 2026-08-23 (sol) ❌ T2-1 웨이브 1 개정본 집중 재심 — PASS 3/5, FAIL 2/5

- **정본**: `docs/reviews/t2-1-wave1-2026-08-23-sol-recheck.md`
- **PASS**: Bilibili는 선행 조건+v4 신설 조항 전부 충족. Apple·Linear.app은 각 선행 재제출 조건 전부 충족.
- **Toss FAIL**: 선행 v3 조건은 4/4 PASS. v4 A1b에서 여섯 verified primitive type의 컴포넌트별 보존이 불완전하고, B2a에서 Principles 인접 한정이 `derived / not quoted doctrine`에 그쳐 `editorial / not Toss-authored or separately published UI specification` 경계를 끝내지 못함.
- **Baemin FAIL**: §13 이중 목적지와 Audience-only 삭제는 반영. 그러나 provenance의 “source §13이 인용하는 같은 Woowa reporting”은 원본 §13에 식별 가능한 source ID/URL이 없어 순환적이며 restaurant-owner·rider task의 정확한 first-party mapping이 아님.
- **다음**: Toss A1b+B2a 및 Baemin §13 source mapping 개정 → 기계 게이트 재통과 → 같은 sol 의미 레인 재제출. 그 전 웨이브 2·카탈로그 채택 정지.

### 2026-08-23 (grok-4.6) ✅ T2-1 웨이브 1 apple·baemin·linear.app 개정 2차 — 기계 게이트 PASS, sol 재검증 대기

- **산출**: `docs/design-md-weight/migrated/{apple,baemin,linear.app}/` 개정. 규칙집 v4. 각 `migration-log.md`에 `Revision 2026-08-23 (wave1 full-review resubmit)`.
- **공통**: 검증된 `Type: button`을 `Kind: interactive`와 병기. Principles 인접 B2a 한정은 `derived editorial implementation inference / not <브랜드>-authored or separately published UI specification`까지. Foundations Motion에 B3 다섯 증거 종류(transition properties · animation name · duration · easing · reduced-motion behavior)와 컴포넌트별 computed 관측 게이트 전문. 로그는 실제 이중 목적지·B3 본문과 일치.
- **Apple**: provenance `ds.type: system` 복원. §11 로그를 Experience + Typography & Assets + Content & Locales + provenance로 기록.
- **Baemin**: 7개 `Type: button`. §13을 `Primary tasks + Audience`로 기록하고 provenance의 Audience only를 제거. task source mapping은 Woowa Brothers first-party reporting.
- **Linear.app**: unitless lineHeight 1 / 1.33 / 1.6 / 1.5 / 1.71 복원. 본문 표 48px/31.92px/24px/19.5px/24px는 size-local 관측으로 분리(14×1.71=23.94). homepage·Method·customers·pricing·brand URL은 Experience + provenance.
- **검증**: `inspectDesignMd` `portable_core: true`, placeholders 0; `migrate-reference.mjs --brand {apple,baemin,linear.app} --gate-only` PASS 3/3.
- **다음**: 동일 sol 의미 레인 재제출. Toss·Bilibili 개정본 재검증과 함께 웨이브 1 닫힘 대기. 카탈로그 채택 아님.

### 2026-08-23 (opus5+sol) 🔄 웨이브 1 전수 = 최초 의미 검토 5/5 FAIL → 규칙집 v4 + 게이트 2종 신설 → 개정 2차 중

- **sol 전수 3건도 FAIL** (`docs/reviews/t2-1-wave1-2026-08-23-sol-full.md`). 이번엔 **신규 하위 계층**: A1a 값 형태 손실(linear.app의 unitless lineHeight 1.71 → 24px 고정 변환 — 스케일 의미 사망), A1b 검증된 primitive type 손실(3건 공통 — `type: button`을 `Kind: interactive`로 뭉갬), A1c 검증 메타데이터 누락(apple `ds.type: system`), B2a 완전성(인접해도 evidence class 구분이 안 끝나면 FAIL).
- **규칙집 v4** + 게이트 신설 2종(ratio-loss·primitive-type-loss). **신설 게이트가 linear.app을 실제 차단** — sol이 잡은 그 결함을 이제 기계가 잡는다. 승인본 4건·음성 픽스처 6/6은 여전히 초록.
- **수렴 신호**: FAIL 항목 수가 줄고 있다 (골든 3건 = 구조 결함 다수 → notion 4종 → 웨이브 1은 건당 2~3건 정밀도 이슈, C1–C4·D2·B1 대량 통과).
- **진행 중**: apple·baemin·linear.app 개정 2차 (grok, v4). 완료 후 5건 전부 게이트 → sol v4 재확인 → 웨이브 1 닫힘 → 웨이브 2 (openai·wanted·coupang·naver·figma).

### 2026-08-23 (sol) ❌ T2-1 웨이브 1 표본 제외 전수 3/3 — FAIL 3/3

- **정본**: `docs/reviews/t2-1-wave1-2026-08-23-sol-full.md`
- **Apple**: `ds.type: system`·세 button type 손실(A1), Principles 권위 한정 불완전(B2/B2a), B3 전문 누락, §11 이중 목적지와 B3 준수 로그 불일치(E2a/E2c).
- **Baemin**: 7개 button type 손실(A1), B3 전문 누락+과도한 로그(E2c), §13이 실제로 Primary tasks+Audience인데 log/provenance는 Audience only(E2a).
- **Linear.app**: unitless line-height 5개·button type 3개 손실(A1), Principles 인접 한정 없음(B2/B2a), B3 전문 누락, route URL의 portable+provenance 이중 목적지 누락(E2a). B3 관련 E2c는 과장 주장이 없어 통과.
- **검증**: `migrate-reference.mjs --gate-only` PASS 3/3. 기계 gate가 문자열·bare-number field 관계를 놓친다. A2/A3/A4/B1/C1–C4/D1/D2/E1은 3/3 통과, E2b는 대상 wrapper 없음.
- **다음**: 세 건을 v3로 개정하고 gate 재통과 후 동일 sol 레인 재제출. 다음 웨이브는 정지. Toss·Bilibili 개정본 재검증은 별도 대기. 카탈로그 채택 아님.

### 2026-08-23 (grok-4.6) ✅ T2-1 웨이브 1 toss·bilibili 개정 — 기계 게이트 PASS, sol 재검증 대기

- **산출**: `docs/design-md-weight/migrated/{toss,bilibili}/` 개정. 규칙집 v3. 각 `migration-log.md`에 `Revision 2026-08-23 (wave1 sol resubmit)`.
- **Toss**: Foundations Motion에 B3 다섯 증거 종류(transition properties · animation name · duration · easing · reduced-motion behavior)와 컴포넌트별 computed 관측 게이트를 명시. 약화 문구 폐기. favicon은 identity-only — portable Assets에서 제거, provenance만 유지. §15 로그를 실제 본문과 일치 (E2c).
- **Bilibili**: 세 *UI implication* 인접 본문에 B2a 한정(공식 원칙 아님, 공식 서사+관측 표면에서 파생한 편집적 해석, 별도 product-system 규격 밖). §8/§14/§15는 `실질 제약 → portable / 원문 placeholder wrapper → provenance omission ledger`. 값 미채움 (E2b).
- **검증**: `inspectDesignMd` `portable_core: true`, placeholders 0; `migrate-reference.mjs --brand {toss,bilibili} --gate-only` PASS 2/2.
- **다음**: 동일 sol 의미 레인 재제출. 전수 3건(baemin·apple·linear.app) 판정 병행. 카탈로그 채택 아님. 표본율 40% 유지.

### 2026-08-23 (opus5+sol) 🔄 T2-1 웨이브 1 — 게이트 5/5 PASS, sol 표본 2/2 FAIL(정밀도) → v3 누적·개정·전수 확대

- **게이트 5/5 PASS** (toss·baemin·apple·linear.app·bilibili) → **sol 표본 40% = toss·bilibili 둘 다 FAIL**. 단 **신규 결함 계층 없음** — 기존 조항의 정밀도 문제: toss는 B3 약화 문구("공식 출처로 검증될 때까지"는 curve 하나로 충족 가능)와 E2 로그 불일치(favicon 이중 목적지 누락), bilibili는 B2 인접 한정 누락(파생 UI implication)과 E2 wrapper 보관 미기록. 나머지 조항은 대량 통과 — 루프 수렴 중.
- **grok 프로토콜 발동**: 정지 → 규칙집 **v3**(B2a 인접 한정·B3 다섯 증거 종류 명문화·E2a–c 로그 일치 세칙) → toss·bilibili 개정(grok, 본문 반영 완료 · 동일 sol 재검증 대기) ∥ 나머지 3건 sol 전수 검토(진행 중).
- **다음**: 개정 2건 sol 재확인 & 전수 3건 판정 → 웨이브 1 닫힘 → 웨이브 2 (openai·wanted·coupang·naver·figma, 표본율 40% 유지).

### 2026-08-23 (sol) ❌ T2-1 웨이브 1 표본 2/5 — FAIL 2/2

- **정본**: `docs/reviews/t2-1-wave1-2026-08-23-sol-sample.md`
- **Toss**: B3 per-component computed motion 승격 게이트 약화; E2 §15 준수 사유와 logo의 실제 portable+provenance disposition 불일치.
- **Bilibili**: B2 corporate fact에서 파생한 UI implication의 권위 한정 누락; E2 여섯 placeholder wrapper의 provenance 보관 목적지 누락.
- **결과**: 다음 웨이브 정지. 웨이브 1의 5건 전수 의미 재검토 후 두 표본을 개정·기계 게이트 재통과·동일 sol 레인에 재제출한다. 표본율 40% 유지. 카탈로그 채택 아님.

### 2026-08-23 (grok-4.6) ✅ T2 웨이브 1 baemin Core v2 이관

- **산출**: `docs/design-md-weight/migrated/baemin/{DESIGN.md,provenance.md,migration-log.md}`
- **검증**: `inspectDesignMd` `portable_core: true`; `--gate-only` PASS; hex/px 손실 0·발명 0.
- **의미 처리**: baemin.com / Woowa / catalog / WORK 앱 패밀리 분리; §14 4행 본문 보존; C1 미관측≠`not-applicable`; C2 app-download·nav·read-more·selector·carousel loading/error/success는 역할 의미로 `not-applicable`, font-download loading/error만 `applicable`; B3 motion 승격 조건 Foundations 유지; D2 §13 공식 stakeholder만 Audience, sidecar 없음; §9 복붙 프롬프트 삭제.
- **다음**: 웨이브 게이트 전수 후 sol 표본. 카탈로그 채택·`web/references` 교체 닫힘.

### 2026-08-23 (grok-4.6) ✅ T2-1 Toss Core v2 이관

- **산출**: `docs/design-md-weight/migrated/toss/{DESIGN.md,provenance.md,migration-log.md}`
- **검증**: `inspectDesignMd` `portable_core: true`; `--gate-only` PASS; hex/px 손실 0·발명 0.
- **의미 처리**: TDS Mobile vs `toss.im` 분리; `#0064ff`≠`#3182f6`; §14 4행 보존; C1 미관측≠`not-applicable`; C2 TDS Button/Text Field/Agreement/marketing CTA 역할 판정; B1 generic focus·keyboard focus≠`focus-visible` treatment; B2 §12 derived 한정 본문 유지; B3 motion 승격 조건 Foundations 유지; D2 §13 sidecar 없음; §9 복붙 프롬프트 삭제.
- **다음**: 웨이브 게이트 전수 후 sol 표본. 카탈로그 채택·`web/references` 교체 닫힘.

### 2026-08-23 (grok-4.6) ✅ T2-1 웨이브 1 Apple Core v2 이관

- **산출**: `docs/design-md-weight/migrated/apple/{DESIGN.md,provenance.md,migration-log.md}`
- **검증**: `inspectDesignMd` `portable_core: true`; `--gate-only` PASS; hex/px 손실 0·발명 0.
- **의미 처리**: 세 evidence domain 분리; §14 표 본문 보존; C1 미관측≠`not-applicable`; C2 마케팅 CTA·gallery tab·HIG card loading/error/success는 역할 의미로 `not-applicable`; B1 `focus-visible` 값 없음; B3 motion 승격 조건 Foundations 유지; D2 §13 sidecar 없음; §9 복붙 프롬프트 삭제.
- **다음**: 웨이브 1 나머지 id 게이트 전수 후 sol 표본. 카탈로그 채택·`web/references` 교체 닫힘.

### 2026-08-23 (opus5) ✅ grok 조건 5항 반영 완료 → T2-1 웨이브 1 가동

- **T2-1 개시 승인** = 양 상정 APPROVE_WITH_CONDITIONS (`docs/reviews/t2-1-open-2026-08-23-grok.md`). 조건 5항 전부 반영: ① 계획 T1-4 행을 워커+게이트+규칙집 구조로 수정 ② 규칙집 D2에 「게이트 기계화 없음 — sol 레인 전담」 명시 ③ `gate()`에 portable_core(7 claim × 정확히 1회) 편입 ④ 규칙집 버전을 파일에서 읽음(하드코딩 제거) ⑤ 음성 픽스처 6종을 `selftest()`로 고정.
- **셀프테스트가 실버그 1건을 잡았다**: `[FILL IN]` 검사가 실제 형식 `[FILL IN: …]`(콜론)과 매치되지 않아 **한 번도 작동한 적이 없었다**. 수정 과정에서 규칙 정밀화 2단: DESIGN.md는 접두 매치로 전면 금지, provenance는 원본 인용(축약 … 허용)만 허용 — 29cm 승인본의 생략 원장이 기준.
- **최종 상태**: 음성 픽스처 6/6 + 승인본 4/4 PASS.
- **웨이브 1 진행 중**: toss·baemin·apple·linear.app·bilibili (위험 프로파일 혼합 — 서사/일러스트/제품 마케팅/영문 SaaS/결측 다량). 웨이브 내부만 병렬. 완료 후 게이트 전수 → sol 표본 2건(40%).
- **다음**: 웨이브 1 게이트 → sol 표본 → FAIL 없으면 웨이브 2. musinsa·karrot·29cm·notion은 스킵(완료분).

### 2026-08-23 (grok-4.6) ✅ T1-4 구조 편차 + T2-1 개시 — APPROVE_WITH_CONDITIONS / APPROVE_WITH_CONDITIONS

- **정본**: `docs/reviews/t2-1-open-2026-08-23-grok.md`
- **상정 1**: 계획의 「골든 3건 도구 재생산 diff 0」은 폐기. 정본은 워커(판단)+게이트(강제)+규칙집(누적). 골든 FAIL 3/3 → 규칙집 v1 → 재확인 PASS, notion 미접촉 FAIL → 규칙집 v2·게이트 B1/D1 → 재확인 PASS를 근거로 편차를 받는다.
- **실측**: 게이트 musinsa/karrot/29cm/notion PASS 4/4. `inspectDesignMd` portable_core true, placeholders 0. 합성 구본(focus-visible hex + storefront 부정 claim)은 `MIGRATION_BLOCKED`. 카탈로그 440.
- **T1-4 닫힘 조건 (웨이브 1 투입 전, 재심 없음)**: 계획 T1-4 행 수정; 게이트가 D2를 기계화했다고 쓰지 않음; `portable_core`+`[FILL IN]` 0을 `gate()`에 편입; 규칙집 버전 하드코딩 금지; B1·D1·na-inversion 음성 픽스처.
- **상정 2**: 조건 5항 후 T2-1 개방. 웨이브 5 id, 웨이브 내부만 병렬, 다음 웨이브는 게이트+sol 표본 종료 후. 첫 3웨이브 40%(2/5), FAIL 0이고 위험 프로파일 3종 이상일 때만 20%. sol FAIL 시 정지·전수 재검토·규칙집 누적·40% 복귀. 기계화 불가 신규 계층은 게이트 소급이 아니라 sol 소급 재표본. 산출은 `docs/design-md-weight/migrated/`만.
- **닫힘**: `web/references` 교체, T2-3, musinsa/karrot/29cm/notion 재이관.
- **다음**: 조건 5항 패치 → T2-1 웨이브 1.

### 2026-08-23 (sol) ✅ T1-4 Notion 개정본 집중 재심 — PASS 4/4

- **정본**: `docs/reviews/t1-4-notion-2026-08-23-sol-recheck.md`
- **범위**: 선행 sol FAIL의 재제출 최소조건 4항만 재확인. 새 기준 없음. 강화된 기계 게이트 PASS는 전제로 수용.
- **조건 1**: Hero CTA / Hero secondary / Language-picker search에서 generic focus와 `focus-visible` treatment 분리.
- **조건 2**: Help search transparent + `help-search.fg #000000` portable 결합 복원, focused computed text와 역할 분리, log disposition 교정.
- **조건 3**: Bento tab / carousel arrow / language trigger / Help toggle의 loading·error·success 12/12를 product role로 재판정.
- **조건 4**: portable 본문의 `storefront` 및 원본 밖 error/empty/support-copy 부정 claim 제거.
- **다음**: 동일 sol 의미 재검증 선행조건 충족. T1-4 구조 편차 승인과 T2-1 개시는 별도 결정.

### 2026-08-23 (grok-4.6) ✅ T1-4 Notion sol FAIL 재제출 개정 — 의미 재검증 대기

- **한 줄**: `docs/design-md-weight/migrated/notion/`를 판정문 4항 + 규칙집 v2(A3·A4·B1·C2·D1·E2)로 개정했다.
- **조건 1**: Hero CTA / Hero secondary / Language-picker search의 `focus-visible` treatment 제거. applicability 유지. 원 `Focus`/`::state-focus`는 additional observed state.
- **조건 2**: Help search `Background: transparent` + `help-search.fg` `#000000`를 portable Components에 복원. focused computed `rgba(0,0,0,0.95)`와 역할 분리. §9 log disposition을 실제 이동에 맞춤.
- **조건 3**: Bento tab / carousel arrow / language trigger / Help toggle의 loading·error·success 12행을 역할 의미로 `not-applicable`. primitive 종류 일괄 applicable 철회.
- **조건 4**: Content/Named gaps의 `storefront` error/empty/support-copy 부정 claim 삭제.
- **검증**: `inspectDesignMd` `portable_core: true`, placeholders 0; `migrate-reference.mjs --brand notion --gate-only` PASS.
- **다음**: 동일 sol 의미 레인 재검증. 그 전 T2-1 웨이브·카탈로그 채택은 닫힘.

### 2026-08-23 (opus5+sol) 🔄 T1-4 학습 루프 — notion FAIL → 규칙집 v2 → 게이트 강화 → 개정 제출

- **notion 라이브 시험**: 기계 게이트 PASS였지만 **sol 의미 레인 FAIL** (`docs/reviews/t1-4-notion-2026-08-23-sol-spotcheck.md`). 미접촉 입력에서 신규 결함 계층 4종 — ① 일반 focus 관측을 focus-visible treatment로 승격 ② §9에만 있던 고유값(transparent field·`help-search.fg` 결합)을 틀린 사유로 삭제 ③ primitive 종류만으로 loading/error/success 일괄 applicable 발명 ④ 원본에 없는 storefront 부정 claim 신설.
- **루프가 설계대로 돌았다**: FAIL → `docs/design-md-weight/MIGRATION_RULEBOOK.md` **v2로 누적**(조항 A3·A4·B1·C2·D1·E2 신설) → 게이트에 기계화 가능 2종 추가(focus-visible-promotion·alien-negative-claim) → 강화된 게이트가 notion 구본을 차단하면서 승인본 3건은 통과 → grok 개정 제출(위).
- **T2-1 규모 실측**: 레퍼런스당 워커 ~8분. 440개 = 웨이브 5개 병렬로 ~12시간. 단, sol 표본 검토가 병목 — 전수 불가라 표본율과 FAIL 시 롤백 규칙을 grok 승인 라운드에서 정해야 한다.
- **다음**: 게이트+sol 재확인 → grok 승인 라운드(T1-4 구조 편차 「diff 0 → 워커+게이트+규칙집 누적」 + T2-1 개시 + 표본율) → T2-1 웨이브.

### 2026-08-23 (sol) ⚠️ T1-4 Notion 라이브 표본 의미 검토 — FAIL

- **정본**: `docs/reviews/t1-4-notion-2026-08-23-sol-spotcheck.md`
- **기계 게이트와 분리**: 토큰/[FILL IN]/미관측→비적용/coverage/도구 프롬프트 게이트 PASS는 수용했다.
- **의미 차단점 4건**: generic focus 캡처를 `focus-visible` treatment로 승격, Help search의 transparent 값과 `fg #000000` portable 결합 손실, 네 control의 loading/error/success를 primitive 종류만으로 applicable 처리, Notion에 없는 `storefront` coverage 부정 claim 혼입.
- **통과 확인**: §14 8행 보존, Compact card kind/map 최소 생략, 표면·font evidence 경계, fictional archetype 비승격·sidecar 비수록, motion/curve 제약.
- **다음**: 지정 4건 개정 → 같은 sol 의미 레인 재검증. 그 전 T2-1 웨이브와 카탈로그 채택은 닫힘. T1-4 구조 편차 승인은 별도.

### 2026-08-23 (grok-4.6) ✅ T2 Notion legacy → Core v2 수동 이관

- **한 줄**: `web/references/notion/DESIGN.md`를 musinsa 골든 형태 + T1-3 §5 의미 보존 조건으로 옮겼다.
- **산출물**: `docs/design-md-weight/migrated/notion/DESIGN.md` · `provenance.md` · `migration-log.md`
- **지킨 제약**: MUST 7 claim; 검증값 손실 0 / 발명 0 / 새 `[FILL IN]` 0; §14 본문 보존; 컴포넌트 의미로 applicability(미관측 treatment만 생략); Compact card는 kind/map 생략; §13 가상 archetype 삭제·provenance 비수록; §9 도구 명령 삭제; 파생 UI implication은 Experience 본문에 한정.
- **검증**: `inspectDesignMd` `portable_core: true`, placeholders 0.
- **다음**: 독립 의미 검토. 카탈로그 채택은 별도.

### 2026-08-23 (opus5) ✅ T1-3 닫힘 (sol 재확인 4/4 PASS) → T1-4 하네스 가동

- **sol 재확인 = 조건 4항 전부 PASS** (`docs/reviews/t1-3-golden-2026-08-23-sol-recheck.md`). 골든 샘플 3건이 양 레인(기계+의미) 교차검증 통과. 재주입 원천 2곳 격리도 sol이 실물 확인.
- **T1-4 = `test-v2/tools/migrate-reference.mjs`**. 계획의 「도구 재생산 diff 0」은 판단 작업의 확률성과 충돌해 **워커(판단) + 게이트(강제)** 구조로 바꿨다 — 이 편차는 다음 grok 승인 라운드에 상정한다. 게이트는 지금까지의 결함 이력 전부를 기계화: 토큰 손실/발명·[FILL IN]·§14 삭제·미관측→비적용 반전·coverage 완료 주장(부정 인식)·도구 프롬프트 잔존. **승인된 골든 샘플 3건이 게이트 3/3 PASS** (자가검증 — 승인본이 게이트에 걸리면 게이트가 틀린 것. 실제로 부정 미인식 오탐 1건을 이걸로 잡았다).
- **notion 라이브 시험 진행 중** — 미접촉 레퍼런스로 워커+게이트 전체 경로 검증. 통과하면 T2-1 웨이브(5개씩) 개시 가능.
- **다음**: notion 게이트 통과 → sol 표본 검토 → 편차 승인(grok) → T2-1 웨이브.

### 2026-08-23 (sol) ✅ T1-3 골든 샘플 재제출 집중 재심 — PASS 4/4

- **정본**: `docs/reviews/t1-3-golden-2026-08-23-sol-recheck.md`
- **범위**: 선행 sol FAIL의 재제출 최소조건 네 항목만 재확인. 새 관점 없음.
- **조건 1**: musinsa·karrot·29cm 모두 미관측/미명명→`not-applicable` 반전 철회. 의미 기반 applicability, 미해상 treatment 생략, coverage 완료 주장 없음.
- **조건 2**: karrot Foundations에 derived/not-SEED 한정 복원. §13 네 항목 승격 철회, verified task 1개. fictional demographics provenance 비수록.
- **조건 3**: 29cm Foundations에 motion의 per-component computed evidence 승격 게이트 복원.
- **조건 4**: `spec/omd-v0.1.md`와 playground `motion.ts` 모두 비브랜드 구현 기본값 격리 마커 존재.
- **다음**: T1-4 기준본 채택의 의미 재검증 선행조건 충족. T1-4 실행은 별도 작업.

### 2026-08-23 (sol) ⚠️ T1-3 골든 샘플 의미 교차검증 — FAIL 3/3

- **정본**: `docs/reviews/t1-3-golden-2026-08-23-sol-review.md`
- **공통 차단**: §14 원문은 보존됐지만 추가 §4.4 표가 `not captured/not named`를 `not-applicable`로 확정해 unknown을 부정 claim으로 바꿨다.
- **karrot 추가 차단**: spring rule의 derived/not-SEED 한정을 provenance에만 격리; fictional §13 충돌을 MUST tasks로 승격하고 persona 세그먼트를 provenance에 재수록.
- **29cm 추가 차단**: `[FILL IN]` 6개 최소경계 생략은 PASS지만, future motion 승격의 컴포넌트별 증거 조건을 삭제.
- **writer 확인**: `spec/omd-v0.1.md`와 playground standard `MOTION_RULES`가 curve를 비브랜드 구현 기본값으로 격리하고 reference 승격을 금지해 재주입 방지는 PASS.
- **다음**: 개정본 의미 재검증. 그 전 T1-4 diff-0 기준본 채택 금지.

### 2026-08-23 (grok-4.6) ✅ toss 밝은 파스텔 UI 카드 모드 6장 보강

- **한 줄**: toss 기존 16장이 시네마틱 스틸에 치우쳐, mobile-390 실측(meanLuma 0.903, dynamicRange 0.256, typicalAspect 0.887)의 밝은 파스텔 카드 모드를 6장 추가했다.
- **산출물**: `test-v2/02-generated/toss/images/17.jpg`–`22.jpg`. `shots.json` shots 16→22, videos 3 보존. role=imagery, citedFacts에 mobile-390 키.
- **샷**: 17 스켈레톤 카드(2:3) · 18 홀로그램 카드 스택(2:3) · 19 프로스티드 필 리스트(2:3) · 20 흰 배경 상품 카드(2:3) · 21 스피커 상품 카드(9:16) · 22 민트-라벤더 오버랩 카드(1:1). 글자·로고·숫자 없음.
- **다음**: toss 재측정→재입고.

### 2026-08-23 (opus5+grok) ✅ T3 에셋 세트 9개 전량 생성 — 이미지 142·영상 27, 전수 측정·불변 저장

- **생성 완료**: 9개 브랜드 × (이미지 14–16장 + 영상 3개). 채널 grok build CLI(`image_gen`·`image_to_video`), 웨이브 3개씩 병렬. 브랜드마다 shots.json(샷별 실제 프롬프트+인용 실측값), measure.json(§4.2 verify 실측), manifest.json(SHA-256). 미디어는 `~/.omd/generated-store` 불변 저장, `ingest-generated.mjs --verify` 통과. `.gitignore`는 매니페스트류만 커밋되게 수정 — 생성은 확률적이라 "재현 가능" 전제가 틀려서다.
- **측정 판독** (생성 중앙값 vs 실표본 중앙값): karrot 65.3/64.5 **일치** · musinsa 36.6/45.9 분포 안 · figma 27.0/32.5 분포 안 · apple 35.9/49.6 겹침 · naver 43.0/62.3 겹침(모바일 기반) · wanted 36.3/51.9 겹침 · baemin 45.5/98.3 (실표본이 균질 일러스트 패널이라 갭은 브랜드 성질) · **toss 17.1/62.3 모드 치우침** → 밝은 UI 카드 모드 6장(17–22) 보강 완료, 재측정 대기 · **coupang 27.6/72.3 측정 기반 결함** — aside 캡처 6장 중 5장이 채도 0·94%+ 순백 내비 패널이라 aggregate가 브랜드 이미지를 기술 못 함. 캡처 재수집 대상(빈 패널 필터: 커버리지>0.9 ∧ 채도<0.05).
- **측정 교정 2건**: role별 채점 기반(mobile 컷→mobile-390, texture→비교 불가 표기), 이어쓰기 규칙(기존 번호 보존).
- **T1-3 골든 샘플 3건 이관 완료** (musinsa·karrot·29cm → `docs/design-md-weight/golden-samples/`, 각 DESIGN+provenance+migration-log, 21~34% 감량). **opus5 레인 통과**: 토큰 손실 0·발명 0·새 [FILL IN] 0·§14 보존·29cm 플레이스홀더 6곳 최소 경계 생략 확인. **sol 레인 진행 중** (§15 모션 커브 무출처 검증까지 파고드는 중).
- **다음**: toss 재측정→재입고. sol 리뷰 도착→T1-4(마이그레이션 도구, 골든 3건 도구 재생산 diff 0). 그 후 T2-1 웨이브.

### 2026-08-23 (grok-4.6) ✅ T1-3 골든 샘플 3건 — 수동 Core v2 마이그레이션

- **한 줄**: musinsa / karrot / 29cm legacy DESIGN.md를 Core v2 골든 샘플로 옮겼다. Portable Core 3/3.
- **산출물**: `docs/design-md-weight/golden-samples/{musinsa,karrot,29cm}/{DESIGN.md,provenance.md,migration-log.md}`
- **지킨 제약**: MUST 7 claim; §9 도구 명령 삭제; §14 본문 보존+컴포넌트 §4.4; 29cm `[FILL IN]` 6개 생략; karrot 무출처 템플릿 커브 3개 삭제·duration/signature 보존; 가상 persona sidecar 없음.
- **검증**: `inspectDesignMd` `portable_core: true`, placeholders 0, YAML 색 토큰 본문 보존(karrot frontmatter `#ff7e36`만 provenance — 표면 토큰이 아님).
- **다음**: T1-4 마이그레이션 도구. 이 3건을 재생산해 수동본과 diff 0.

### 2026-08-23 (opus5+grok) 🔄 T3 에셋 생성 개시 + T1-2 승인·T1-3 개시 — 병렬 진행 중

- **사용자 재지시 반영**: (a) 이미지 생성은 **grok build CLI**(`image_gen`·`image_to_video`·`reference_to_video` 실측 확인, 스모크 통과), 부족 시 codex CLI(0.146.1 확인). (b) 파일럿 평가 사이클 생략, 에셋 세트(브랜드당 이미지 ≤20·영상 ≤3)를 넉넉히 만들어 **9개 바로 진행**. (c) T1/T2는 별도 트랙으로 병렬. 워커는 grok-4.6 중심, sol·opus5 교차검증.
- **에셋 파이프라인 신설**: `test-v2/tools/generate-assets.mjs`(evidence 실측→브리프→grok 워커가 캡처를 보고 샷 결정→생성), `measure-generated.mjs`(생성물을 §4.2 verify로 실측 대조), `run-asset-waves.sh`(3개씩 웨이브). 브리프는 실측값만 담고 미해상 필드는 자동 탈락. **URL→캡처→브리프→생성→측정** 형태라 추후 "URL만 치면 에셋 추출·생성" 기능의 골격이 된다.
- **무신사 파일럿 진행 중** (이미지 4·영상 1): 01.jpg가 실표본 d1과 같은 구도(오프숄더 다크니트·흰 침구·블루그레이 벽), 02.jpg가 d8류 의류 플랫레이 — 워커가 참조 이미지를 실제로 보고 브랜드 장르를 재현한다. 글자·로고 0.
- **T1-2 재심 = APPROVE_WITH_CONDITIONS** (`docs/reviews/t1-2-essence-2026-08-23-rereview.md`). T1-2 재작성 없음, **T1-3 개방**. 제약 5: 정수는 Portable Core 일곱 claim만(섹션 재묶음 금지)·바이트/완비율은 참고만·슬롯 없는 도구 명령 삭제·graph 채택 전 §14 본문 삭제 금지·§15 삭제는 무출처 커브만.
- **T1-3 골든 샘플 3건 = 완료** (grok-4.6): musinsa·karrot·29cm → `docs/design-md-weight/golden-samples/`. Portable Core 3/3. 교차검증(sol+opus5)과 T1-4가 남음.
- **실행 계획 정본**: `docs/OMD_T1T2_EXECUTION_PLAN.md` — T1-3→T1-4(도구)→T2-1(440 웨이브 5개씩)∥T2-3(+160, 처음부터 Core v2로 생성). T2-2 신규 파이프라인은 T3의 `discover-targets.mjs`+`pipeline.mjs` 재사용.
- **다음**: 무신사 파일럿 완료→측정→9개 전량 웨이브(`run-asset-waves.sh 16 3`). T1-3 교차검증(sol+opus5)→T1-4.

### 2026-08-23 (grok-4.6) ✅ T1-2 재검토 — APPROVE_WITH_CONDITIONS

- **한 줄**: 정수 입자는 Portable Core MUST 7. T1-3을 연다. 섹션 정수·무게 증거·omd-apply 위임·0그래프 즉시 이관은 닫힌다.
- **판정**: **APPROVE_WITH_CONDITIONS**. 정본 `docs/reviews/t1-2-essence-2026-08-23-rereview.md`.
- **받은 것**: 지정 4항. §15 무출처 커브만, 가상 persona sidecar 금지.
- **T1-3 제약**: MUST 7 claim만 정수 / 수치는 참고 / 슬롯 없으면 삭제 / §14는 채택 전 본문·§4.4 / 이징은 커브만+라이터 동시 수정.
- **잔문**: 개정본 67행 duration·signature, 134행 「아직 반영하지 못한」. T1-2 재작성 아님.
- **다음**: T1-3 위임 분류. T1-2 본문 재심 없음.

### 2026-08-23 (opus5 + grok-4.6) ✅ §9 게이트 전부 통과 — `RUBRIC_FROZEN_SHA` 쓸 수 있다

- **grok-4.6 CONFIRM** (`docs/reviews/rubric-2026-08-23-verifier-confirm.md`). **`RUBRIC_FROZEN_SHA` 값은 이 트리를 봉인하는 커밋 SHA다.** 커밋 → `RUBRIC.md` §9에 기록 → T3-3 개시. **커밋만 남았고 아직 안 찍었다** (커밋은 사용자 지시 없이 안 찍는 규칙).
- **전사자 결정**: 사용자 지정 `opus5` → grok **ACCEPT_WITH_CONDITIONS** 5조건 반영. 계열 독립은 **면책**(평가자 sonnet5와 같은 anthropic), 세션·메모리 격리 유지, 의미 검증자 `WAIVED`, 기계 검증기 봉인, 리포트 첫 절 문장 고정. 평가자 2종화는 여전히 BLOCK. 정본 `docs/reviews/rubric-2026-08-23-c-transcriber-resubmit.md`.
- **grok이 3회 왕복으로 내 결함 9건을 잡았다.** 검증기 5건(§2.1 정상 전사를 차단 / 가방 비교라 색 재배열이 통과 / 선언 1건이 무관한 손실 면제 / 값 존재로 면제해 경로+본문 같은 값 동시 삭제가 통과 / 펜스 안 제목까지 중립화), 본문 4건(§7.1 판정 3종 잔존, §7.2가 §5.2와 충돌, §4.3 식별력 범위가 karrot·musinsa 잔존, naver 「미디어 83개」가 실제 71). 전부 반영, 자체 테스트 7/7.
- **§9 상태**: 11항 중 **10 DONE**, #6은 파일럿 교정만 남고 그건 T3-3에서 한다. `test-v2/90-comparison/gate-status.json`.
- **본문 패치 3건** (전부 grok 판정 근거): §3.2 C2 레인 B 「측정됨」→「공선」+조인 절차 4보+3평가자 표+축 범위(이미지 계열은 식별력·근거 추종 30%·`HERO`만) · §4.3 천장 표 「9개 중 5개」 + `C_b` 4개 명시 · §4.1 naver 인용 서피스 분리.
- **천장 최종**: musinsa 16 / karrot 11 / naver 7 / toss 5 / figma 4 = ✅, apple·baemin·coupang·wanted 0. 두 서피스를 재면서 naver·toss가 처음 측정 가능해졌고 wanted는 캠페인 오버레이로 0이 됐다.
- **전체 게이트 초록**: 적합성 11/11 · §4.2 재현 18/18 · 전사 검증기 7/7 · 증거 SHA 일치 · 교차검증 OK 7/THIN 2 · 레인 분리 ok · 브리프 무드리프트.
- **다음**: 커밋 → §9에 SHA 기록 → T3-3 파일럿(무신사).

### 2026-08-23 (grok-4.6) ✅ 검증기 재확인 3차 — CONFIRM

- **한 줄**: 지정 5항이 본문·코드·증거와 같다. 채점 입력 잔여는 없다.
- **판정**: **CONFIRM**. 정본 `docs/reviews/rubric-2026-08-23-verifier-confirm.md`.
- **받은 것**: 판정 2종, 7.1.7 개수 정산, 펜스 안 제목 KEEP, 식별력 5브랜드 채점, naver 미디어 71.
- **SHA**: 이 트리를 봉인하는 커밋 SHA로 기록한다. T3-3은 그 뒤에 연다.
- **다음**: 봉인 커밋에 `RUBRIC_FROZEN_SHA` 기록 → T3-3 파일럿.

### 2026-08-23 (grok-4.6) ⚠️ 최종 확인 심사 — C-TRANSCRIBER REVISE / C2 CONFIRM

- **한 줄**: C2 잔여 3항은 본문에 있다. 전사 문서 5조건도 있다. 검증기가 정상 전사를 막아서 모델 전사는 아직 안 연다.
- **판정**: C-TRANSCRIBER **REVISE**, C2 **CONFIRM**. 정본 `docs/reviews/rubric-2026-08-23-two-item-confirm.md`.
- **C-TRANSCRIBER 남은 4항**: `Heading:`·제목 번호가 BLOCKED / 토큰 재배열 PASS / REVIEW가 span 미검사·exit 0·담당 없음 / §7.2가 §5.2 WAIVED와 충돌.
- **SHA**: 불가. 위 4항 + §4.3 천장 표 2/9 미본문화 + naver 인용 미정정. T3-3 닫힘.
- **다음**: 검증기 4항 수정 후 재승인. C-CEILING·C-NAVER-H1 본문도 SHA 전에.

### 2026-08-23 (grok-4.6) ⚠️ C-TRANSCRIBER 재심 — ACCEPT_WITH_CONDITIONS

- **한 줄**: 사용자가 지정한 opus5 전사는 받는다. 같은 계열을 승인권자가 고르는 일은 여전히 금지.
- **판정**: `ACCEPT_WITH_CONDITIONS`. 정본 `docs/reviews/rubric-2026-08-23-c-transcriber-resubmit.md`.
- **받는 것**: 계열 독립 면책. 세션·메모리 비공유. 변환 3종 + fail-close. 전수 기계 검증. 의미 검증 `WAIVED`.
- **안 받는 것**: 평가자 2종. sonnet5 전사. opus5의 채점·파일럿·해석. 레포 스킬/Core v2를 실은 전사 세션. 조건 없이 모델 전사 실행.
- **SHA**: 아직 불가. 조건 파일 반영 + C2 「측정됨」 패치가 남음. T3-3 닫힘.
- **다음**: `TRANSCRIPTION.md` §5 · `run-config.json` 모델 문자열 · §7.1 검증기 SHA · C2 본문.

### 2026-08-23 (opus5) ⚠️ T3 §9 게이트 11항 중 9항 닫힘 — 남은 하나는 사용자 결정

- **막힌 것 하나 = 전사자**. `TRANSCRIPTION.md` §5는 전사자를 사람으로 고정하고, 모델 전사로 바꾸려면 **평가자 세 계열(xai·openai·anthropic) 전부와 독립인 모델**을 먼저 봉인하라고 한다. 사용자 결정은 「사람 검수 없음」인데 평가자 grok-4.6·sol·sonnet5가 세 계열을 다 덮어 네 번째 계열 모델이 없다. grok-4.6 = **ESCALATE**, 옵션 1(평가자 2종)·2(같은 계열 전사)는 BLOCK. 남은 길은 (a) 네 번째 계열 전사·검증 모델 봉인 또는 (b) 「사람 검수 없음」을 **문서 축에 한해** 철회. 그 전 모델 전사 금지.  *(재심에서 경로만 바뀜: 위 2026-08-23 grok 재심.)*
- **grok 판정 반영 완료**: C-CEILING 패치 적용(토스 `m3`·`m5`·`m7` 자기 제품 UI 제외 → 8→5, `C_b`는 식별 결과를 보지 않은 채 build 앞 4개, 「브랜드 성질」 문구는 apple·baemin·coupang·wanted에만). C-NAVER-H1은 인용 정정만, C-TOSS-H1은 변경 없음. 수집기가 표본마다 `aboveFold`를 기록해 문서 표본 수를 첫 렌더 답으로 읽는 오독을 막는다.
- **닫힌 게이트 9항**: pack/모델/브리프 SHA(`run-config.json`, `brief.json` briefSha `3f178576…`) · 스냅샷 무결성 · 천장 자극 동결 · 코드북 · 채점 순서(`scoring-order.json` — 6세션, 레인 교차 A→B/B→A/A→B, 표시 순서는 생성과 다른 salt) · arm 순서(72행) · `verify.json` §4.2 재현(`verify-conformance.mjs` 18/18) · 레인 A/B 분리(`lanes.mjs --check`, 216슬롯) · 채점 프롬프트(`scoring-prompts.md`).
- **남은 2항**: #6 파일럿 교정(T3-3이 닫혀 있어 못 연다) · #7 전사 봉인(위).
- **천장 최종**: 9개 중 **5개** 측정 가능 — figma 4 / karrot 11 / musinsa 16 / naver 7 / toss 5. apple·baemin·coupang·wanted 0.
- **RUBRIC.md는 건드리지 않았다.** 게이트 진행 상태는 `test-v2/90-comparison/gate-status.json`에만 있고, 본문 체크박스 반영 여부는 grok-4.6이 정한다.
- **다음**: 전사자 결정 → 파일럿 교정 → `RUBRIC_FROZEN_SHA` → T3-3.

### 2026-08-23 (grok-4.6) ⚠️ T3 캡처 실측 vs 동결 본문 4충돌

- **한 줄**: 기기 수리로 측정이 바뀌어도 FREEZE 규칙은 안 푼다. H1은 첫 캡처, 천장은 선별 재적용, 전사는 사용자 결정.
- **판정**: C-NAVER-H1 **REVISE** (면제 유지, `sampled=0` 인용만 서피스 분리). C-TOSS-H1 **REJECT**. C-CEILING **REVISE** (2/9 폐기, 자극 4·선별 유지, 토스 제품 UI 재적용). C-TRANSCRIBER **ESCALATE** (옵션 1·2 BLOCK).
- **정본**: `docs/reviews/rubric-2026-08-23-capture-conflicts.md`.
- **닫은 것**: 네이버/토스 모바일 표본을 첫 렌더 H1로 쓰는 것. 평가자 2종화. 같은 계열 모델 전사. `RUBRIC_FROZEN_SHA`.
- **다음**: 천장 선별 재적용 패치 → C2 「측정됨」 패치 → 사용자 전사 경로 결정. 그 전 T3-3 닫힘.

### 2026-08-23 (opus5) ✅ T3-0 캡처 파이프라인화 — 회고 7항 중 6항 닫힘

- **한 줄**: 손으로 브랜드 하나 캡처하던 것을 `node pipeline.mjs --targets ../targets.json` 한 줄로 바꿨고, **고장 난 수집기로는 캡처가 시작되지 않게** 게이트를 앞에 뒀다.
- **닫힌 것**: 1 깔때기 · 2 카탈로그 교차검증 · 3 수집기 단일화(`collectors.mjs` 한 벌 = Playwright + Aside) · 4 적합성 픽스처 9종(9/9) · 6 탐색 자동화(`discover-targets.mjs`, `targets.json`에 선정 근거) · 7 비용 계측(단계별 `durationMs`).
- **부분**: 5 모바일 — Playwright는 `desktop-1440`+`mobile-390` 두 서피스. **Aside는 REPL에서 창 크기를 못 바꿔 모바일을 못 잰다** (쿠팡 데스크탑만, `method.surfaceLimit`에 명시).
- **픽스처가 즉시 잡은 신규 결함 2건**: (a) `src`/`currentSrc` 없는 `<video>`가 통째로 탈락 — 토스 히어로가 video라 열거를 넓혔던 수정이 URL 없는 video 앞에서 무효였다. (b) 감쇠 게이트가 정상 커머스 그리드에서 오탐 — `found → sizeOk`를 비율 게이트에서 제외.
- **모바일이 열어준 결함**: 배민 폰 레이아웃이 9장 중 8장을 `kept → framed`에서 잃었다. 크기 하한이 아니라 **문서 y 드리프트**(위쪽 lazy-load). 열거 시점 `data-omd-cap` 태그 → 태그로 재식별, 폴백 기하는 문서 y를 안 쓴다. 수정 후 배민 모바일 9장·감쇠 없음.
- **정본**: `test-v2/tools/README.md`(운영 매뉴얼), `docs/CAPTURE_PIPELINE_RETRO.md` §6(구현 상태), `test-v2/targets.json`(URL + `surface` + `why`).
- **다음**: 9개 전량 재캡처 → `ingest --all --verify` → `cross-check --all` → 커밋. 그 후 T3-3 파일럿.
...
- **대상**: `test-v2/90-comparison/RUBRIC.md` 재제출본. 대조 BLOCK `docs/reviews/rubric-2026-08-22-s3-block.md` §6.
- **판정 기록**: `docs/reviews/rubric-2026-08-22-s3-resubmit.md`.
- **본문 반영**: 사람 없음, 3종, 회피 삭제, §3.1 네 축 주장 표, §4 표 모델 판정, `4×3`/`1/3`/`3종 중 2종`, α 0.67/0.80/0.67 지금 동결.
- **조건 (C1–C6)**: 같은 호스트 SHALL. `자기 계열` 조인 키 선택+(H 또는 H∪I)와 `|own|∈{0,3}` → N/A. 레인 B 이미지 계열을 지금 표에. “비교 유지”를 가법 호스트 정체성으로 한정. `bias_j` 레인별·축별 + §7 군집. 예비 = 같은 계열 재호출.
- **호스트 미정**: 공유 호스트의 *어느 모델인지*는 §9 실행 전. 암별 다른 호스트는 지금 닫을 규칙.
- **연 것**: 없음. 개정 아키텍처(회피 삭제)는 수용, 본문 동결은 C1–C6 후.
- **닫은 것**: T3-3, `RUBRIC_FROZEN_SHA`.
- **다음**: C1–C6 본문 패치 후 재승인. 회피/4번째 계열/`INSUFFICIENT_RATERS` 부활은 조건이 아님.
...
- **판정 기록**: `docs/reviews/rubric-2026-08-22-rebuttal-3.md`.
- **2항**: N1–N5 재분류·단일 버킷 삭제, 원문 절·문장 순서 보존, 허용 변환=표지·경로 삭제, Core v2 SHA 패킷 미첨부, 파일럿=본실험 패킷. 추측=레인 산출물 1회, `B_raw` 축별 삭제, `COMPROMISED`=`형식 단서` 부분집합, §8 조건 6 PASS 킬 삭제. 모두 본문.
- **범위 초과**: 없음. §9에서 Core v2 SHA 기록 항목 삭제는 패킷 미첨부 정렬.
- **연 것**: 루브릭 본문 규칙 동결. 더 이상 반박 라운드 없음.
- **닫은 것**: T3-3. `RUBRIC_FROZEN_SHA`는 아직 쓰지 않음.
- **다음**: 배너 `FROZEN` + §9 첫 체크. 코드북 9값 등 나머지 게이트가 채워진 커밋에서 `git rev-parse HEAD`를 배너와 이 파일에 `RUBRIC_FROZEN_SHA=<SHA>`로 기록한 뒤에만 T3-3.

### 2026-08-22 (grok-4.6) 📋 3트랙 계획 개정본 — APPROVE_WITH_CONDITIONS

- **대상**: `docs/OMD_3TRACK_PLAN.md` (ad5f61f1, 검토 A/B 반영 개정).
- **판정 기록**: `docs/reviews/3track-plan-2026-08-22-grok-approval.md`.
- **연 것**: T3-0 측정기 코드, 기존 PNG → 불변 저장소 입고, T1-1 440 실측.
- **닫은 것**: 계획 「다음 행동」의 T3-1→왕복, T3-3 파일럿, T3-4 이후, T1-2 이후, T2 전부.
- **막은 이유 (요약)**: 단계표는 T3-2=루브릭 동결인데 다음 행동은 T3-2=무신사 왕복. T3-1 템플릿이 T3-0이 금지한 "엣지투엣지 크롭"을 다시 근거로 쓴다. README §6은 여전히 "다시 캡처하면 된다".
- **다음**: 조건 C1–C7을 계획/README에 패치한 뒤에만 T3-1을 연다. 코드 착수는 T3-0부터.
...
- **배포**: PR #55(체크 4종 통과) → main 머지 `0ed6c476`, llms-full 재생성 동기 커밋
  `5c21bab9`. Vercel 프로덕션 반영 확인 — `oh-my-design.kr/cli`의 `#derivation` 실렌더,
  앵커가 sticky nav 아래로 정확히 착지(heading 136 / nav 57), 1440·390 가로 스크롤 0.
- **npm**: 패키지 동작 변경이 없어 버전 범프 없음. npmjs 페이지의 README는 다음 릴리스
  전까지 2.0.0 본문 유지. 서사를 npm 표면까지 올리려면 2.0.1 패치 릴리스가 필요.
- **정리**: 로컬 `main`을 붙들고 있던 사라진 tmp 워크트리 등록 다수 prune(디렉터리
  부재 항목만).
