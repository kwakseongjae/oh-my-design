...
- 갱신: 2026-07-29 · 1.9.79 versioned skill control ACCEPTED
...
- 다음 유효 실행은 `run-prepared-matrix.mjs --root /tmp/u1980 --max-new-cells 1`의 cell 1이다. provider failure가 나면 root를 freeze하고 같은 root resume/Luna substitution을 금지한다.
