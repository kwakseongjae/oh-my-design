...
- 다음 benchmark queue는 **1.9.1의 남은 OmD operations 2회 보존 실행 → fresh 0.3.0 paired matrix**다. 1.9.2 semantic calibration은 완료됐으며, 이후 12개 task fixture·1.9.3의 12×5 patch candidate로 확장한다.
