...
- 갱신: 2026-07-30 · 1.9.96 adaptive data-surface live replacement preregistered
...
- 다음은 preregistration commit 뒤 `/tmp/u1996` 6-cell fresh preparation과 exact input/source attestation을 잠그는 것이다.
