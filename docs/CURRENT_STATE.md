...
**이름 단위 결론: 발행된 컴포넌트 이름 1,111개 중 레퍼런스가 부르는 것 308개 = 27.7%.**
...
검증: 9-18에 손으로 42개를 적은 **pega가 45개 중 42개(93%)**, 손으로 "완전"이라 본
**yeogiotte가 6개 중 4개(67%)**. 최악: velog 7% · wise 9% · google 11% · alipay 15% ·
