...
- **다음 exact action:** locked order5 `neighborhood-library-landing-luna-max-r1-taste-eligible-scope-only`을 Luna/max 한 번만 실행한다. 새 hidden-image gate가 asset-generation side effect를 정확히 fail-close하는지 포함해 terminal을 봉인한다.
