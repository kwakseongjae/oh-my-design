   ...
   reflow_work_packet:
     ...
     row_groups:
       - id: "stable row group id"
         ...
         typography_contract: { font_size_px: "pre-edit computed px", line_height_px: "pre-edit computed px", font_weight: "pre-edit computed weight" }
