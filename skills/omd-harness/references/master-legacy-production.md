...
3. Founder fast-exit may propose a reversible plan with `[FILL IN]` facts, but
...
6. Visual sections may combine the verified base with approved deltas. Voice,
   ...
   user-specific facts absent from evidence use `[FILL IN]`.
7. Record base reference, applied deltas, preserved sections, placeholders,
