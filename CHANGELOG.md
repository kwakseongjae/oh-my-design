...
- The new `omd:update` skill lets users ask their coding agent to perform that same fail-closed refresh. The shipped bundle is now 22 product skills for Claude Code, Codex, and OpenCode, and 21 compatible Agent Skills for Cursor.
