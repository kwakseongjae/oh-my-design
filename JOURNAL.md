...
- **다음**: **오너 결정 — 아이덴티티 전용 레퍼런스를 넣나**(700의 의미를 정한다) · 웨이브 1(Serendie 본문) · 죽은 인용 8건(1월)(skyscanner·smarthr·govuk·uswds·hashicorp·ibm·sanity…) · `ds:` 오표기 3건(velog·banksalad·zigzag) 처리 · adobe는 Spectrum 1/2 세대 구분 필요.
