...
- **다음**: 웨이브 1(Serendie 본문 조사) · 죽은 인용 8건(1월 마감) · 셀렉터가 새 depth 필드를 어떻게 쓸지(UI 선택)(skyscanner·smarthr·govuk·uswds·hashicorp·ibm·sanity…) · `ds:` 오표기 3건(velog·banksalad·zigzag) 처리 · adobe는 Spectrum 1/2 세대 구분 필요.
