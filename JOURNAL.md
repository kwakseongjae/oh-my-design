...
- **다음**: 웨이브 1(Serendie 본문 조사) · 재검증 패스(대체 URL 3건 준비됨) · 셀렉터 depth UI(오너 선택)(skyscanner·smarthr·govuk·uswds·hashicorp·ibm·sanity…) · `ds:` 오표기 3건(velog·banksalad·zigzag) 처리 · adobe는 Spectrum 1/2 세대 구분 필요.
