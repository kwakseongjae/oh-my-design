...
- **다음**: `docs/NEXT_2026-09-21.md` — ①표면 발견 스윕(264건, 가장 정보량 큼) → ②도달 가능한 것부터 깊이 → ③CN 확충. **183건 일괄 구조화는 등급 0 상승이라 권장 안 함**(상태 게이트에 전부 막힘).(skyscanner·smarthr·govuk·uswds·hashicorp·ibm·sanity…) · `ds:` 오표기 3건(velog·banksalad·zigzag) 처리 · adobe는 Spectrum 1/2 세대 구분 필요.
