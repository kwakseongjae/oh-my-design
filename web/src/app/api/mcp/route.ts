 ...
 *
 * Exposes the oh-my-design catalog (400 brand DESIGN.md references) as 3 read-only
  ...
  (server) => {
    ...
    server.registerTool(
      "search_by_vibe",
      {
        ...
        description:
          "Search the oh-my-design catalog of 400 brand design references for brands matching a mood/vibe. Examples: 'calm B2B fintech', 'playful kids app', 'editorial newspaper', 'developer-first dark CLI'. Use when the user describes what they want without naming a brand. Returns top matches, each with a permalink to cite.",
        inputSchema: {
