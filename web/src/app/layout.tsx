...
export const metadata: Metadata = {
  ...
  description:
    "One DESIGN.md spec. 452 quality-graded brand references: 158 verified_v2, 181 partial, and 113 legacy snapshots. The bundle ships 28 skills and 20 specialist definitions; Cursor 2.4+ receives 27 native Agent Skills. MIT open source.",
  keywords: [
    "design system",
    "DESIGN.md",
  ...
  openGraph: {
    ...
    title: "oh-my-design — DESIGN.md for AI coding agents",
    description:
      "452 quality-graded references: 158 verified_v2, 181 partial, 113 legacy snapshots. Channel-compatible skills and roles for Claude Code, Codex, and OpenCode; a project rule and catalog for Cursor.",
  ...
  twitter: {
    ...
    title: "oh-my-design — DESIGN.md for AI coding agents",
    description:
      "452 quality-graded references: 158 verified_v2, 181 partial, 113 legacy. 23 shipped skills · 19 specialist definitions · channel-aware install.",
            ...
            __html: JSON.stringify({
              ...
              "@graph": [
                ...
                },
                {
                  ...
                  url: siteUrl,
                  description:
                    "DESIGN.md as ground truth for AI coding agents. 452 quality-graded references: 158 verified_v2, 181 partial, and 113 legacy snapshots.",
                  potentialAction: {
                    "@type": "SearchAction",
                ...
                },
                {
                  ...
                  description:
                    "Skill-driven design workflows for Claude Code, Codex, OpenCode, and Cursor. One npx command installs compatible skills, specialist roles, and an offline catalog of 452 quality-graded DESIGN.md references.",
                  offers: {
                    "@type": "Offer",
                    price: "0",
                    priceCurrency: "USD",
                  ...
                  featureList: [
                    ...
                    "452 quality-graded references: 158 verified_v2, 181 partial, and 113 legacy snapshots",
