...
export const metadata: Metadata = {
  ...
  description:
    "One DESIGN.md spec. 246 real brands extracted. Make Claude Code, Codex, OpenCode, and Cursor ship UI that actually looks like Stripe, Toss, or Linear — not slop. 17 skills · 16 sub-agents · zero AI calls during install. MIT open source.",
  keywords: [
    "design system",
    "DESIGN.md",
  ...
  openGraph: {
    ...
    title: "oh-my-design — DESIGN.md for AI coding agents",
    description:
      "246 real brands extracted into one DESIGN.md spec your AI coding agent reads as ground truth before it codes. 17 skills, 16 sub-agents, zero AI calls during install.",
  ...
  twitter: {
    ...
    title: "oh-my-design — DESIGN.md for AI coding agents",
    description:
      "246 real brands extracted. 17 skills · 16 sub-agents · zero AI calls during install. Talk to Claude Code, Codex, OpenCode, or Cursor in your brand.",
            ...
            __html: JSON.stringify({
              ...
              "@graph": [
                ...
                },
                {
                  ...
                  url: siteUrl,
                  description:
                    "DESIGN.md as ground truth for AI coding agents. 246 real brand references, 17 skills, 16 sub-agents — installed in one npx command.",
                  potentialAction: {
                    "@type": "SearchAction",
                ...
                },
                {
                  ...
                  description:
                    "Skill-driven design harness for AI coding agents (Claude Code, Codex, OpenCode, Cursor). One npx command bundles 17 skills + 16 sub-agents + 246 reference DESIGN.md files. Install once, then talk to your agent in natural language.",
                  offers: {
                    "@type": "Offer",
                    price: "0",
                    priceCurrency: "USD",
                  ...
                  featureList: [
                    ...
                    "246 reference DESIGN.md files (Stripe, Toss, Linear, Vercel, Anthropic, Notion, etc.)",
                ...
                },
                {
                  ...
                  step: [
                    ...
                    },
                    {
                      ...
                      text: 'Open Claude Code / Codex / OpenCode / Cursor and say: "Set up the design system for [your project description]." The agent picks one of 246 references, proposes a hybrid DESIGN.md, asks for confirmation, writes the file plus shims (CLAUDE.md / AGENTS.md / .cursor/rules).',
                    },
                    {
                      "@type": "HowToStep",
                      position: 3,
