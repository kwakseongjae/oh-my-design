...
export const metadata: Metadata = {
  ...
  description:
    "One DESIGN.md spec. 448 quality-graded brand references: 152 verified_v2, 184 partial, and 113 legacy snapshots. The bundle ships 28 skills and 20 specialist definitions; Cursor 2.4+ receives 27 native Agent Skills. MIT open source.",
  keywords: [
    "design system",
    "DESIGN.md",
  ...
  openGraph: {
    ...
    title: "oh-my-design — DESIGN.md for AI coding agents",
    description:
      "448 quality-graded references: 152 verified_v2, 184 partial, 113 legacy snapshots. Channel-compatible skills and roles for Claude Code, Codex, and OpenCode; a project rule and catalog for Cursor.",
  ...
  twitter: {
    ...
    title: "oh-my-design — DESIGN.md for AI coding agents",
    description:
      "448 quality-graded references: 152 verified_v2, 184 partial, 113 legacy. 23 shipped skills · 19 specialist definitions · channel-aware install.",
            ...
            __html: JSON.stringify({
              ...
              "@graph": [
                ...
                },
                {
                  ...
                  url: siteUrl,
                  description:
                    "DESIGN.md as ground truth for AI coding agents. 448 quality-graded references: 152 verified_v2, 184 partial, and 113 legacy snapshots.",
                  potentialAction: {
                    "@type": "SearchAction",
                ...
                },
                {
                  ...
                  featureList: [
                    ...
                    "448 quality-graded references: 152 verified_v2, 184 partial, and 113 legacy snapshots",
