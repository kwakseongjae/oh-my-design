...
export const metadata: Metadata = {
  ...
  description:
    "Add the oh-my-design Claude connector to search, browse, and fetch 326 real brand design systems in chat. Read-only, no account, no auth.",
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <article className="mx-auto max-w-3xl px-4 sm:px-6 pt-12 pb-24">
        ...
        <p className="mt-4 text-base leading-relaxed text-muted-foreground">
          A read-only Claude connector (MCP) over the oh-my-design catalog of 326
