...
export const FAQ_EN: FaqEntry[] = [
  ...
  },
  {
    ...
    a: "Claude Code, Codex, OpenCode, and Cursor — Cursor 2.4+ gets 26 compatible Agent Skills in .cursor/skills, a small DESIGN.md bootstrap rule, and the shared reference catalog. OmD sub-agent definitions are not installed in Cursor; hooks ship for Claude Code specifically.",
    jsonLd: true,
  },
  {
