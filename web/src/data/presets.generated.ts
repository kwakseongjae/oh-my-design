...
export const PRESETS: OmdPreset[] = [
  ...
  },
  {
    ...
    "accessibility": "마크는 `aria-hidden`, 접근 이름은 워드마크 텍스트가 제공.",
    "gates": [
      "G30",
      "G31",
      "G42",
  ...
  },
  {
    ...
    "accessibility": "APG Button Pattern. Space·Enter 활성화. 토글이면",
    "tokenSlots": "primary 면/글자, destructive 면/글자(악센트 재사용 금지),",
    "verified": "미검증 — 리서치 유도",
    "gates": [
      "C1",
      "C10",
  ...
  },
  {
    ...
    "group": "form",
    "source": "skills/omd-autopilot/references/presets/primitives/form.md",
    "summary": "한 줄 텍스트·숫자·이메일·암호·검색. / **언제 아닌가** — 여러 줄은",
    "base": "shadcn Input (`Input`). 네이티브 `<input>`. Radix 인풋",
    "accessibility": "네이티브 텍스트 필드(APG는 위젯 대신 native input을 권장).",
    "tokenSlots": "--size-control-{sm,md,lg}(버튼과 공유), --radius-control,",
    "verified": "미검증 — 리서치 유도",
    "gates": [
      "C11",
      "C12",
  ...
  },
  {
    ...
    "group": "form",
    "source": "skills/omd-autopilot/references/presets/primitives/form.md",
    "summary": "후기·문의·주소처럼 여러 줄·불확정 길이 텍스트. / **언제 아닌가**",
    "base": "shadcn Textarea (`Textarea`). 네이티브 `<textarea>`. Radix",
    "accessibility": "네이티브 multiline textbox. Tab 진입·이탈, Enter는 줄바꿈이지",
    "tokenSlots": "--size-textarea-min-h, --radius-control, 면/보더/placeholder,",
    "verified": "미검증 — 리서치 유도",
    "gates": [
      "C11",
      "C12",
  ...
  },
  {
    ...
    "group": "form",
    "source": "skills/omd-autopilot/references/presets/primitives/form.md",
    "summary": "약관 동의·복수 선택처럼 항목마다 독립 on/off. / **언제 아닌가**",
    "base": "shadcn Checkbox (`Checkbox`). Radix Checkbox (`Checkbox.Root` +",
    "accessibility": "APG Checkbox Pattern(dual-state 또는 tri-state). 역할",
    "tokenSlots": "박스 시각 크기 vs 히트(≥44), --radius-checkbox, 보더/면/",
    "verified": "미검증 — 리서치 유도",
    "gates": [
      "C11",
      "C16",
  ...
  },
  {
    ...
    "accessibility": "APG Radio Group Pattern(툴바 밖). 컨테이너 `radiogroup`, 항목",
    "tokenSlots": "라디오 시각 크기 vs 히트, 인디케이터 색, 항목 갭, 초이스",
    "verified": "미검증 — 리서치 유도. 온집 v2 상품 갤러리 썸네일 행이",
    "gates": [
      "C16",
      "C17",
      "C2",
  ...
  },
  {
    ...
    "group": "form",
    "source": "skills/omd-autopilot/references/presets/primitives/form.md",
    "summary": "알림·비행기 모드처럼 즉시 적용되는 설정 on/off. / **언제 아닌가**",
    "base": "shadcn Switch (`Switch`, `size`: sm | default). Radix Switch",
    "accessibility": "APG Switch Pattern. 역할 `switch`. Space 토글, Enter는 선택",
    "tokenSlots": "트랙 크기(sm/default) vs 히트, on 면/off 면(서로 다른 색,",
    "verified": "미검증 — 리서치 유도",
    "gates": [
      "C1",
      "C11",
  ...
  },
  {
    ...
    "group": "form",
    "source": "skills/omd-autopilot/references/presets/primitives/form.md",
    "summary": "가격 범위·볼륨처럼 연속/스텝 숫자 구간. / **언제 아닌가** — 이산",
    "base": "shadcn Slider (`Slider`). Radix Slider (`Slider.Root` / `Track` /",
    "accessibility": "단일: APG Slider Pattern. 멀티: APG Slider (Multi-Thumb)",
    "tokenSlots": "트랙 두께·면, Range 채움, 썸 크기 vs 히트, --focus-ring(썸),",
    "verified": "미검증 — 리서치 유도",
    "gates": [
      "C13",
      "C16",
  ...
  },
  {
    ...
    "group": "form",
    "source": "skills/omd-autopilot/references/presets/primitives/form.md",
    "summary": "라벨·컨트롤·설명·에러를 한 단위로 조립할 때. / **언제 아닌가** —",
    "base": "shadcn Field 패밀리: `Field`(`role=\"group\"`, `orientation`",
    "accessibility": "네이티브 label/for + group. FieldSet/FieldLegend가 라디오·체크",
    "tokenSlots": "라벨 타이포·색, 설명 muted(에러·라벨은 본문 4.5:1 C45/G40),",
    "verified": "미검증 — 리서치 유도",
    "gates": [
      "C11",
      "C12",
  ...
  },
  {
    ...
    "accessibility": "필드 에러: APG Alert Pattern(`role=\"alert\"`) + 컨트롤",
    "tokenSlots": "error 색·텍스트, 성공 피드백 면(토스트를 쓸 때 G16 해당",
    "verified": "미검증 — 리서치 유도",
    "gates": [
      "C12",
      "C13",
  ...
  },
  {
    ...
    "summary": "뒤 화면을 인어트로 두고 한 과업(짧은 폼, 설정, 편집)을",
    "base": "shadcn `Dialog` (`DialogTrigger`, `DialogPortal`,",
    "accessibility": "APG **Dialog (Modal)**. `role=\"dialog\"` +",
    "tokenSlots": "`--color-scrim`(어두운 딤, 예: 흑 40% — 흰 반투명",
    "verified": "미검증 — 리서치 유도",
    "gates": [
      "C3",
      "C31",
  ...
  },
  {
    ...
    "group": "overlay",
    "source": "skills/omd-autopilot/references/presets/primitives/overlay.md",
    "summary": "되돌리기 어려운 행동(삭제, 권한 회수, 결제 확정) 직전에",
    "base": "shadcn `AlertDialog` (`AlertDialogTrigger`,",
    "accessibility": "APG **Alert and Message Dialogs**(키보드는 **Dialog",
    "tokenSlots": "`--color-scrim`, `--color-surface-overlay`,",
    "verified": "미검증 — 리서치 유도",
    "gates": [
      "C1",
      "C3",
  ...
  },
  {
    ...
    "group": "overlay",
    "source": "skills/omd-autopilot/references/presets/primitives/overlay.md",
    "summary": "본문을 완전히 대체하지 않는 보조 패널. 필터(C30 접힘),",
    "base": "shadcn `Sheet` (`SheetTrigger`, `SheetPortal`,",
    "accessibility": "시트·드로어 모두 APG **Dialog (Modal)** — Radix",
    "tokenSlots": "`--color-scrim`, `--color-surface-overlay`,",
    "verified": "미검증 — 리서치 유도",
    "gates": [
      "C2",
  ...
  },
  {
    ...
    "group": "overlay",
    "source": "skills/omd-autopilot/references/presets/primitives/overlay.md",
    "summary": "트리거에 앵커된 리치 콘텐츠(작은 폼, 날짜 조각, 추가",
    "base": "shadcn `Popover` (`PopoverTrigger`, `PopoverAnchor`,",
    "accessibility": "Radix가 인용하는 APG **Dialog (Modal)**의 **비모달**",
    "tokenSlots": "`--color-surface-overlay`, `--radius-popover`,",
    "verified": "미검증 — 리서치 유도",
    "gates": [
      "C25",
      "C44",
  ...
  },
  {
    ...
    "group": "overlay",
    "source": "skills/omd-autopilot/references/presets/primitives/overlay.md",
    "summary": "이미 이름이 있는 컨트롤의 **부가** 설명, 아이콘의 짧은",
    "base": "shadcn `Tooltip` (`TooltipProvider`, `Tooltip`,",
    "accessibility": "APG **Tooltip**(초안, 태스크포스 합의 전 — 계약은 이",
    "tokenSlots": "`--color-surface-inverse`/`--color-on-inverse`(또는",
    "verified": "미검증 — 리서치 유도",
    "gates": [
      "C12",
      "C2",
  ...
  },
  {
    ...
    "group": "overlay",
    "source": "skills/omd-autopilot/references/presets/primitives/overlay.md",
    "summary": "트리거 버튼에 매달린 **행동 목록**(편집/복제/삭제, 보기",
    "base": "shadcn `DropdownMenu` (`DropdownMenuTrigger`,",
    "accessibility": "APG **Menu Button** + **Menu and Menubar**. 트리거",
    "tokenSlots": "`--color-surface-overlay`, `--color-menu-highlight`,",
    "verified": "미검증 — 리서치 유도",
    "gates": [
      "C2",
      "C20",
  ...
  },
  {
    ...
    "group": "overlay",
    "source": "skills/omd-autopilot/references/presets/primitives/overlay.md",
    "summary": "전역 점프·명령 실행. 항목이 많아 검색이 전제. 키보드가",
    "base": "shadcn `Command` (`CommandDialog`, `CommandInput`,",
    "accessibility": "외곽 APG **Dialog (Modal)** + 내부 APG **Combobox**",
    "tokenSlots": "`--color-scrim`, `--color-surface-overlay`,",
    "verified": "미검증 — 리서치 유도",
    "gates": [
      "C15",
  ...
  },
  {
    ...
    "group": "overlay",
    "source": "skills/omd-autopilot/references/presets/primitives/overlay.md",
    "summary": "결과가 **화면에 아직 없는** 짧은 피드백. 뷰포트 밖",
    "base": "shadcn **`Sonner`** (`<Toaster />` + `toast()`) —",
    "accessibility": "APG **Alert**(urgent/error) 또는 WAI-ARIA",
    "tokenSlots": "`--color-toast-surface`, `--color-toast-success`/",
    "verified": "미검증 — 리서치 유도",
    "gates": [
      "C16",
      "C3",
  ...
  },
  {
    ...
    "accessibility": "APG **Breadcrumb**. 랜드마크 `nav`에 이름(`aria-label=\"breadcrumb\"` 또는 페이지 언어로 \"위치\"). 페이지에 nav가 여러 개면 이름이 서로 달라야 한다(APG Landmark Regions). 현재 페이지에 `aria-current=\"page\"`. 키보드 계약 없음 — 링크는 문서 탭 순서. 구분자는 읽히지 않는다.",
  ...
  },
  {
    ...
    "accessibility": "APG **Navigation Landmark** + **Link**. 페이지에 nav가 이미 있으면 라벨이 달라야 한다. 키보드=링크 탭 순서. 클릭/Enter 후 해당 헤딩으로 포커스를 옮긴다(`tabindex=\"-1\"`, 시각 링 억제 — P-FN-02와 페어). 스무스 스크롤은 `prefers-reduced-motion`에서 끈다(G27). 레이아웃 속성 애니로 스파이 인디케이터를 밀지 않는다(G14).",
  ...
  },
  {
    ...
    "summary": "한 단위의 관련 콘텐츠(상품·글·요약)를 표면으로 묶어 그리드/목록에",
    "base": "shadcn/ui `Card` + `CardHeader`/`CardTitle`/`CardDescription`/",
    "accessibility": "카드는 APG 위젯이 아니다. 정적 카드는 `article`(반복 항목)",
    "tokenSlots": "`--radius-card`, `--space-card-pad`(`--card-spacing` 대응,",
    "verified": "미검증 — 리서치 유도. 온집 P-CM-01 상품 카드에서 변형 단일·",
    "gates": [
      "C24",
      "C25",
      "C26",
  ...
  },
  {
    ...
    "group": "display",
    "source": "skills/omd-autopilot/references/presets/primitives/display.md",
    "summary": "상태·분류·수량을 짧은 라벨로 붙일 때(재고, 결제 상태, 카운트).",
    "base": "shadcn/ui `Badge`. Radix 배지 프리미티브 없음(hand-rolled).",
    "accessibility": "APG 전용 배지 패턴 없음. 정적은 `span`. 라이브 상태 변화만",
    "tokenSlots": "면/보더/텍스트 쌍(variant별, 다크는 on-color C39),",
    "verified": "미검증 — 리서치 유도. 온집 P-CM-01 재고 enum→토큰(판매중/",
    "gates": [
      "C27",
      "C28",
      "C3",
  ...
  },
  {
    ...
    "group": "display",
    "source": "skills/omd-autopilot/references/presets/primitives/display.md",
    "summary": "사람·계정·브랜드를 식별하는 얼굴/이니셜. 목록 행·헤더·코멘트",
    "base": "shadcn/ui `Avatar`/`AvatarImage`/`AvatarFallback` + `AvatarBadge`/",
    "accessibility": "APG 전용 아바타 패턴 없음. `AvatarImage`에 실명 `alt`",
    "tokenSlots": "크기 스케일(sm/default/lg, 예: 24/32/40), `--radius-avatar`",
    "verified": "미검증 — 리서치 유도.",
    "gates": [
      "C2",
      "C39",
  ...
  },
  {
    ...
    "group": "display",
    "source": "skills/omd-autopilot/references/presets/primitives/display.md",
    "summary": "행·열이 의미 있는 표 데이터에 정렬·행 선택·0건 상태가 필요할",
    "base": "shadcn/ui `Table`/`TableHeader`/`TableBody`/`TableRow`/`TableHead`/",
    "accessibility": "APG **Table Pattern** + **Sortable Table Example** +",
    "tokenSlots": "행 최소 높이(밀도 페어 C9), 셀 패딩, 헤더 웨이트·면,",
    "verified": "미검증 — 리서치 유도. 빈 문장 계약은 온집·이웃장터·스타일몰",
    "gates": [
      "C2",
      "C27",
      "C41",
  ...
  },
  {
    ...
    "group": "display",
    "source": "skills/omd-autopilot/references/presets/primitives/display.md",
    "summary": "같은 위계의 섹션을 헤딩 스택으로 접어 스크롤을 줄일 때(FAQ,",
    "base": "shadcn/ui `Accordion`/`AccordionItem`/`AccordionTrigger`/",
    "accessibility": "APG **Accordion Pattern (Sections With Show/Hide",
    "tokenSlots": "헤더 높이·패딩, 제목 웨이트(열림/닫힘 차이는 웨이트 또는",
    "verified": "미검증 — 리서치 유도.",
    "gates": [
      "C1",
      "C8",
  ...
  },
  {
    ...
    "group": "display",
    "source": "skills/omd-autopilot/references/presets/primitives/display.md",
    "summary": "최초 페인트 전에 이미 자리 잡은 레이아웃을 유지한 채 데이터가",
    "base": "shadcn/ui `Skeleton`(hand-rolled `div`, Radix 없음) + `Spinner`.",
    "accessibility": "APG 스켈레톤 패턴 없음. 교체 영역에 `aria-busy=\"true\"`,",
    "tokenSlots": "스켈레톤 면(다크에서 녹아 사라지지 않을 대비 C42),",
    "verified": "미검증 — 리서치 유도.",
    "gates": [
      "C4",
      "C42",
  ...
  },
  {
    ...
    "group": "display",
    "source": "skills/omd-autopilot/references/presets/primitives/display.md",
    "summary": "같은 표면 안에서 그룹을 시각·의미로 나눌 때(리스트 항목,",
    "base": "shadcn/ui `Separator`. 기반 `radix-ui` `Separator.Root`:",
    "accessibility": "WAI-ARIA **separator** 롤 요구(Radix가 준수). `decorative`이면",
    "tokenSlots": "`--color-rule`(라이트/다크 쌍), 두께, 수직 높이, 인셋",
    "verified": "미검증 — 리서치 유도. 이웃장터 P-FN-07에서 디바이더 콘텐츠 폭",
    "gates": [
      "C39",
      "C41",
      "G22",
  ...
  },
  {
    ...
    "group": "display",
    "source": "skills/omd-autopilot/references/presets/primitives/display.md",
    "summary": "작업의 완료율(업로드, 단계, 처리)을 트랙으로 보여줄 때. 값이",
    "base": "shadcn/ui `Progress`. 기반 `radix-ui` `Progress.Root`/",
    "accessibility": "`role=\"progressbar\"`(WAI-ARIA). **Meter Pattern을 진행에",
    "tokenSlots": "트랙 높이·라운드·면, 인디케이터 색(위 텍스트와 분리 —",
    "verified": "미검증 — 리서치 유도. 온집·스타일몰 P-CM-04 평점 바는 분모",
    "gates": [
      "C39",
      "C4",
      "C40",
  ...
  },
  {
    ...
    "group": "display",
    "source": "skills/omd-autopilot/references/presets/primitives/display.md",
    "summary": "KPI·건수·평균처럼 숫자가 읽기의 앵커인 요약. 대시보드 스트립,",
    "base": "hand-rolled. shadcn 통계 프리미티브 없음. 표면이 필요하면",
    "accessibility": "기본은 `dl`/`div` + 텍스트(위젯 롤 남용 금지). 수치가",
    "tokenSlots": "디스플레이 숫자 크기·웨이트·`font-variant-numeric`",
    "verified": "미검증 — 리서치 유도. 온집 P-CM-04 평점 분포 정의 라인·분모",
    "gates": [
      "C24",
      "C45",
      "G11",
  ...
  },
  {
    ...
    "group": "display",
    "source": "skills/omd-autopilot/references/presets/primitives/display.md",
    "summary": "항목에 붙은 정적 분류(카테고리, 해시태그, 속성)를 한 줄/여러",
    "base": "shadcn/ui `Badge`를 `ul`/`li`로 반복. 태그 전용 Radix 프리미티브",
    "accessibility": "APG 전용 태그 패턴 없음. 목록은 `ul`. 정적 태그는 텍스트.",
    "tokenSlots": "배지와 공유하되 태그 면은 secondary/outline 쪽으로 고정",
    "verified": "미검증 — 리서치 유도. 온집·이웃장터·스타일몰 P-FN-04는 필터",
    "gates": [
      "C27",
      "C28",
      "C29",
