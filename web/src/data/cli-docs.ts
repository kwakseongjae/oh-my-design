...
const en: CliDocsDictionary = {
  ...
  ui: {
    ...
    pipelineNote: "175 verified_v2 · 181 partial · 113 legacy. Use verified_v2 for demos.",
  ...
  overview: {
    ...
    truthBody: "The bundle contains 28 skills, 20 agent definitions, and 469 quality-graded DESIGN.md references: 175 verified_v2, 181 partial, and 113 legacy snapshots. Use verified_v2 references for public demos. Cursor 2.4+ receives 27 compatible Agent Skills plus a small project rule; separately generated specialist roles remain available on channels that support them.",
    proof: "28 product skills · 20 specialist agents · 175 verified_v2 / 181 partial / 113 legacy · zero AI calls during install",
...
const ko: CliDocsDictionary = {
  ...
  ui: { product: "oh-my-design CLI", docs: "문서", language: "언어", copy: "복사", copied: "복사됨", openBuilder: "Builder 열기", github: "GitHub", onThisPage: "이 페이지에서", previous: "이전", next: "다음", actualOutput: "실제 프로젝트 결과", prompt: "프롬프트", result: "결과", files: "변경 파일", verified: "검증", homeAria: "oh-my-design 홈", pagination: "문서 페이지 이동", skillsLabel: "스킬", pipeline: "품질 등급 레퍼런스 → DESIGN.md → 구현 → 검증", pipelineNote: "verified_v2 175개 · partial 181개 · legacy 113개. 공개 데모는 verified_v2를 사용하세요.", skipContent: "문서 본문으로 건너뛰기", copyFailed: "복사 실패", copyPage: "페이지 복사", pageCopied: "페이지 복사됨", pageTools: "페이지 도구", morePageActions: "페이지 작업 더 보기", viewMarkdown: "Markdown으로 보기", copyForAgent: "AI 에이전트용으로 복사", ready: "준비 완료" },
  ...
  overview: {
    ...
    truthBody: "번들은 제품 스킬 28개, 에이전트 정의 20개, 품질 등급이 표시된 DESIGN.md 레퍼런스 469개를 담습니다. 현재 verified_v2 175개, partial 181개, legacy snapshot 113개이며 공개 데모에는 verified_v2를 사용합니다. Cursor 2.4+에는 호환 Agent Skills 27개와 작은 프로젝트 규칙이 들어가며, 별도 전문 역할은 이를 지원하는 채널에만 설치됩니다.",
    proof: "제품 스킬 28개 · 전문 에이전트 20개 · verified_v2 175 / partial 181 / legacy 113 · 설치 중 AI 호출 0회",
...
const zhCn = translatedLocale(
  ...
  {
    ui: { product: "oh-my-design CLI", docs: "文档", language: "语言", copy: "复制", copied: "已复制", openBuilder: "打开 Builder", github: "GitHub", onThisPage: "本页内容", previous: "上一页", next: "下一页", actualOutput: "实际项目产出", prompt: "提示词", result: "结果", files: "变更文件", verified: "验证", homeAria: "oh-my-design 首页", pagination: "文档翻页", skillsLabel: "技能", pipeline: "质量分级参考 → DESIGN.md → 实现 → 验证", pipelineNote: "verified_v2 175 个 · partial 181 个 · legacy 113 个。公开演示请使用 verified_v2。", skipContent: "跳到文档正文", copyFailed: "复制失败", copyPage: "复制本页", pageCopied: "已复制本页", pageTools: "页面工具", morePageActions: "更多页面操作", viewMarkdown: "以 Markdown 查看", copyForAgent: "复制给 AI 编程助手", ready: "准备就绪" },
    overview: { ...en.overview, eyebrow: "给 AI 编程助手的设计上下文", title: "让会写代码的助手，也能读懂设计依据", lead: "oh-my-design 会把带质量等级的参考库和可复用设计工作流装进你正在使用的编程工具。支持的工具还会获得专业智能体角色。安装后，直接描述要改的产品界面即可。", truthTitle: "CLI 为 AI 编程助手准备工作环境", truthBody: "套件包含 28 个产品技能、20 个智能体定义和 469 份带质量等级的 DESIGN.md：verified_v2 175 份、partial 181 份、legacy snapshot 113 份。公开演示请使用 verified_v2。Cursor 2.4+ 会获得 27 个兼容 Agent Skills 和精简的项目规则；独立专业角色仅安装到支持它们的渠道。", proof: "28 个产品技能 · 20 个专业智能体 · verified_v2 175 / partial 181 / legacy 113 · 安装过程 0 次 AI 调用", outcomesTitle: "从你要的结果开始", outcomesLead: "无需记住技能名。说明要改的界面和不能动的内容，系统会选择合适的工作流。", outcomes: [
...
const zhTw = translatedLocale(
  ...
  {
    ui: { product: "oh-my-design CLI", docs: "文件", language: "語言", copy: "複製", copied: "已複製", openBuilder: "開啟 Builder", github: "GitHub", onThisPage: "本頁內容", previous: "上一頁", next: "下一頁", actualOutput: "實際專案產出", prompt: "提示詞", result: "結果", files: "變更檔案", verified: "驗證", homeAria: "oh-my-design 首頁", pagination: "文件換頁", skillsLabel: "技能", pipeline: "品質分級參考 → DESIGN.md → 實作 → 驗證", pipelineNote: "verified_v2 175 份 · partial 181 份 · legacy 113 份。公開示範請使用 verified_v2。", skipContent: "跳到文件正文", copyFailed: "複製失敗", copyPage: "複製本頁", pageCopied: "已複製本頁", pageTools: "頁面工具", morePageActions: "更多頁面操作", viewMarkdown: "以 Markdown 檢視", copyForAgent: "複製給 AI 程式助理", ready: "準備完成" },
    overview: { ...zhCn.overview, eyebrow: "給 AI 程式助理的設計脈絡", title: "讓會寫程式的助理，也能讀懂設計依據", lead: "oh-my-design 會把有品質分級的參考庫與可重複使用的設計工作流程，安裝到你正在用的程式工具。支援的工具還會加入專業角色。安裝完成後，直接說明要調整的產品介面即可。", truthTitle: "CLI 先把 AI 程式助理需要的環境準備好", truthBody: "套件包含 28 個產品技能、20 個代理定義與 469 份有品質分級的 DESIGN.md：verified_v2 175 份、partial 181 份、legacy snapshot 113 份。公開示範請使用 verified_v2。Cursor 2.4+ 會取得 27 個相容 Agent Skills 與精簡的專案規則；獨立專業角色只安裝到支援它們的通道。", proof: "28 個產品技能 · 20 個專業代理 · verified_v2 175 / partial 181 / legacy 113 · 安裝期間 0 次 AI 呼叫", outcomesTitle: "從想完成的成果開始", outcomesLead: "不用記技能名稱。說明要調整的介面與不能更動的內容，系統會選擇適合的工作流程。", outcomes: [
