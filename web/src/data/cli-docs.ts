...
const en: CliDocsDictionary = {
  ...
  overview: {
    ...
    truthBody: "The bundle contains 22 skills, 19 agent definitions, and 440 quality-graded DESIGN.md references: 141 verified_v2, 159 partial, and 140 legacy snapshots. Use verified_v2 references for public demos. Cursor 2.4+ receives 21 compatible Agent Skills plus a small project rule; separately generated specialist roles remain available on channels that support them.",
    proof: "22 product skills · 19 specialist agents · 141 verified_v2 / 159 partial / 140 legacy · zero AI calls during install",
...
const ko: CliDocsDictionary = {
  ...
  overview: {
    ...
    truthBody: "번들은 제품 스킬 22개, 에이전트 정의 19개, 품질 등급이 표시된 DESIGN.md 레퍼런스 440개를 담습니다. 현재 verified_v2 141개, partial 159개, legacy snapshot 140개이며 공개 데모에는 verified_v2를 사용합니다. Cursor 2.4+에는 호환 Agent Skills 21개와 작은 프로젝트 규칙이 들어가며, 별도 전문 역할은 이를 지원하는 채널에만 설치됩니다.",
    proof: "제품 스킬 22개 · 전문 에이전트 19개 · verified_v2 141 / partial 159 / legacy 140 · 설치 중 AI 호출 0회",
...
const zhTw = translatedLocale(
  ...
  { overview: "總覽", "getting-started": "快速開始", demo: "現場示範", workflows: "工作流程", skills: "技能", "anti-slop": "AI slop 判定", showcase: "案例", troubleshooting: "問題排解", ai: "給 AI 的文件" },
  {
    ...
    overview: { ...zhCn.overview, eyebrow: "給 AI 程式助理的設計脈絡", title: "讓會寫程式的助理，也能讀懂設計依據", lead: "oh-my-design 會把有品質分級的參考庫與可重複使用的設計工作流程，安裝到你正在用的程式工具。支援的工具還會加入專業角色。安裝完成後，直接說明要調整的產品介面即可。", truthTitle: "CLI 先把 AI 程式助理需要的環境準備好", truthBody: "套件包含 22 個產品技能、19 個代理定義與 440 份有品質分級的 DESIGN.md：verified_v2 141 份、partial 159 份、legacy snapshot 140 份。公開示範請使用 verified_v2。Cursor 2.4+ 會取得 21 個相容 Agent Skills 與精簡的專案規則；獨立專業角色只安裝到支援它們的通道。", proof: "22 個產品技能 · 19 個專業代理 · verified_v2 141 / partial 159 / legacy 140 · 安裝期間 0 次 AI 呼叫", outcomesTitle: "從想完成的成果開始", outcomesLead: "不用記技能名稱。說明要調整的介面與不能更動的內容，系統會選擇適合的工作流程。", outcomes: [
