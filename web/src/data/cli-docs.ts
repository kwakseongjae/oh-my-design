...
const en: CliDocsDictionary = {
  ...
  ui: {
    ...
    pipelineNote: "155 verified_v2 · 181 partial · 113 legacy. Use verified_v2 for demos.",
  ...
  overview: {
    ...
    truthBody: "The bundle contains 28 skills, 20 agent definitions, and 449 quality-graded DESIGN.md references: 155 verified_v2, 181 partial, and 113 legacy snapshots. Use verified_v2 references for public demos. Cursor 2.4+ receives 27 compatible Agent Skills plus a small project rule; separately generated specialist roles remain available on channels that support them.",
    proof: "28 product skills · 20 specialist agents · 155 verified_v2 / 181 partial / 113 legacy · zero AI calls during install",
...
const ko: CliDocsDictionary = {
  ...
  ui: { product: "oh-my-design CLI", docs: "문서", language: "언어", copy: "복사", copied: "복사됨", openBuilder: "Builder 열기", github: "GitHub", onThisPage: "이 페이지에서", previous: "이전", next: "다음", actualOutput: "실제 프로젝트 결과", prompt: "프롬프트", result: "결과", files: "변경 파일", verified: "검증", homeAria: "oh-my-design 홈", pagination: "문서 페이지 이동", skillsLabel: "스킬", pipeline: "품질 등급 레퍼런스 → DESIGN.md → 구현 → 검증", pipelineNote: "verified_v2 155개 · partial 181개 · legacy 113개. 공개 데모는 verified_v2를 사용하세요.", skipContent: "문서 본문으로 건너뛰기", copyFailed: "복사 실패", copyPage: "페이지 복사", pageCopied: "페이지 복사됨", pageTools: "페이지 도구", morePageActions: "페이지 작업 더 보기", viewMarkdown: "Markdown으로 보기", copyForAgent: "AI 에이전트용으로 복사", ready: "준비 완료" },
  ...
  overview: {
    ...
    truthBody: "번들은 제품 스킬 28개, 에이전트 정의 20개, 품질 등급이 표시된 DESIGN.md 레퍼런스 449개를 담습니다. 현재 verified_v2 155개, partial 181개, legacy snapshot 113개이며 공개 데모에는 verified_v2를 사용합니다. Cursor 2.4+에는 호환 Agent Skills 27개와 작은 프로젝트 규칙이 들어가며, 별도 전문 역할은 이를 지원하는 채널에만 설치됩니다.",
    proof: "제품 스킬 28개 · 전문 에이전트 20개 · verified_v2 155 / partial 181 / legacy 113 · 설치 중 AI 호출 0회",
