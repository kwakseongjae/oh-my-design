...
const FONT_REGISTRY: Record<string, FontInfo> = {
  ...
  "Tossface": { name: "Tossface", license: "OFL", installable: true, source: { name: "Toss Tech", url: "https://toss.tech/article/tossface" }, notes: "Toss's open-source emoji font." },
  ...
  "Roobert PRO": { name: "Roobert PRO", license: "Proprietary", installable: false, source: { name: "Displaay Type", url: "https://displaay.net/typeface/roobert-pro/" }, notes: "Used by Miro." },
  ...
  "Berkeley Mono": { name: "Berkeley Mono", license: "Proprietary", installable: false, source: { name: "Berkeley Graphics", url: "https://berkeleygraphics.com/typefaces/berkeley-mono/" }, notes: "Used by Linear, OpenCode." },
  ...
  "Aeonik Pro": { name: "Aeonik Pro", license: "Proprietary", installable: false, source: { name: "CoType Foundry", url: "https://www.cotypefoundry.com/fonts/aeonik" }, notes: "Used by Revolut." },
  ...
  "Universal Sans": { name: "Universal Sans", license: "Proprietary", installable: false, source: { name: "Universal Thirst", url: "https://universalthirst.com/typefaces/universal-sans" }, notes: "Variable typeface system. Used by Tesla, x.ai." },
  ...
  "PP Neue Montreal Mono": { name: "PP Neue Montreal Mono", license: "Proprietary", installable: false, source: { name: "Pangram Pangram", url: "https://pangrampangram.com/products/neue-montreal" }, notes: "Used by Together AI." },
  ...
  "Basier": { name: "Basier", license: "Proprietary", installable: false, source: { name: "Atipo Foundry", url: "https://www.atipofoundry.com/fonts/basier" }, notes: "Used by ClickHouse." },
  "Basier Square": { name: "Basier Square", license: "Proprietary", installable: false, source: { name: "Atipo Foundry", url: "https://www.atipofoundry.com/fonts/basier" } },
  "Freigeist Neue": { name: "Freigeist Neue", license: "Proprietary", installable: false, source: { name: "TypeMates", url: "https://typemates.com/fonts/freigeist" }, notes: "Used by Replicate." },
  ...
  "Messina Sans": { name: "Messina Sans", license: "Proprietary", installable: false, source: { name: "Luzi Type", url: "https://luzi-type.ch/typefaces/messina-sans" }, notes: "Used by Superhuman." },
  "Messina Serif": { name: "Messina Serif", license: "Proprietary", installable: false, source: { name: "Luzi Type", url: "https://luzi-type.ch/typefaces/messina-serif" } },
  "Messina Mono": { name: "Messina Mono", license: "Proprietary", installable: false, source: { name: "Luzi Type", url: "https://luzi-type.ch/typefaces/messina-modern" } },
  "JJannon": { name: "JJannon", license: "Proprietary", installable: false, source: { name: "Production Type", url: "https://productiontype.com/family/jjannon" }, notes: "Used by Cursor as a serif accent." },
  ...
  "Toss Product Sans": { name: "Toss Product Sans", license: "Brand-proprietary", installable: false, source: { name: "Toss Brand Guidelines", url: "https://toss.im/face" }, notes: "Toss's brand typeface. Restricted use — see Toss brand guidelines for permitted usage." },
