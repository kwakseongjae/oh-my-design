...
export const SEARCH_ALIASES: Record<string, string[]> = {
  ...
  sansan: ["サンサン", "산산"],
  ubie: ["ユビー", "유비"],
  uniqlo: ["ユニクロ", "유니클로", "유니크로"],
  zozotown: ["ゾゾタウン", "조조타운", "ZOZO", "조조"],
  // ── TW ──────────────────────────────────────────────
  dcard: ["狄卡", "디카드"],
  pinkoi: ["핀코이"],
  gogoro: ["고고로"],
  ...
  dji: ["大疆", "디제이아이", "디지아이"],
  // ── Global brands (KR transliteration + well-known alt names) ──
  apple: ["애플"],
  netflix: ["넷플릭스", "넷플"],
  spotify: ["스포티파이"],
  github: ["깃허브", "깃헙"],
  ...
  pinterest: ["핀터레스트"],
  spacex: ["스페이스X", "스페이스엑스"],
  openai: ["오픈에이아이", "오픈AI", "챗GPT", "ChatGPT", "챗지피티"],
  claude: ["클로드", "앤트로픽", "Anthropic"],
  "x.ai": ["그록", "Grok", "엑스에이아이"],
  perplexity: ["퍼플렉시티"],
  cursor: ["커서"],
  vercel: ["버셀", "버샐"],
  ...
  mastercard: ["마스터카드"],
  revolut: ["레볼루트", "레볼룻"],
  wise: ["와이즈", "트랜스퍼와이즈", "TransferWise"],
  nvidia: ["엔비디아"],
  bmw: ["비엠더블유", "비엠"],
  ferrari: ["페라리"],
  lamborghini: ["람보르기니", "람보"],
  renault: ["르노"],
  "mistral.ai": ["미스트랄"],
};
