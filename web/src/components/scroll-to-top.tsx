...
export function ScrollToTop({ threshold = 480 }: { threshold?: number }) {
  ...
  return (
    <button
      ...
      className={`fixed bottom-5 right-5 z-50 flex h-11 w-11 items-center justify-center rounded-full border border-border/60 bg-background/85 text-foreground shadow-lg backdrop-blur transition-all duration-200 hover:bg-muted hover:scale-105 ${
