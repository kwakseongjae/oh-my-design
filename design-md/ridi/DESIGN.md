...
**Tier 1 sources:** https://ridibooks.com (consumer storefront — Deep Charcoal `#3D3D3D` 8px / 36px Pretendard Std primary CTA; BookCard 12px radius with two-layer shadow `0 2px 16px rgba(0,0,0,0.03)` resting / `0 4px 16px rgba(0,0,0,0.12), 0 0 1px rgba(0,0,0,0.08)` hover; tooltip 1px `#D0D0D0` border; Tailwind token classes `Neutral-Colors-Background-Card` / `Neutral-Colors-Foreground-Primary` / `Neutral-Colors-Stroke-Inactive`).
