# 재채점 세션 — 레인 A · 평가자 grok-4.6 · 예비 청크(축 1만)
...
- 슬롯 A: `rows/apple-rep3/slot-A/` — desktop-1440.png · mobile-390.png
...
- 슬롯 A: `rows/baemin-rep2/slot-A/` — desktop-1440.png · mobile-390.png

### 행 baemin · rep 3 — 슬롯 A

- 슬롯 A: `rows/baemin-rep3/slot-A/` — desktop-1440.png · mobile-390.png
...
### 행 coupang · rep 2 — 슬롯 A

- 슬롯 A: `rows/coupang-rep2/slot-A/` — desktop-1440.png · mobile-390.png

### 행 coupang · rep 4 — 슬롯 C

- 슬롯 C: `rows/coupang-rep4/slot-C/` — desktop-1440.png · mobile-390.png
...
### 행 musinsa · rep 3 — 슬롯 A

- 슬롯 A: `rows/musinsa-rep3/slot-A/` — desktop-1440.png · mobile-390.png
...
- 슬롯 A: `rows/toss-rep2/slot-A/` — desktop-1440.png · mobile-390.png
